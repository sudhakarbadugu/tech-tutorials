// Module 17: Search & Location Systems (shifted from module16)
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Horizontal sharding + replicas",
                "Operational complexity and JVM tuning"
              ],
              [
                "Solr",
                "Enterprise search, faceted search",
                "ZooKeeper-coordinated clusters",
                "Slower feature release cycle than Elasticsearch"
              ],
              [
                "OpenSearch",
                "AWS-compatible search and observability",
                "Fork of Elasticsearch",
                "Smaller ecosystem than Elasticsearch"
              ],
              [
                "MySQL Full-Text",
                "Small tables with simple search",
                "Single-node or read replicas",
                "Does not scale to web-scale relevance or sharding"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Trie",
                "Fast prefix lookup, easy top-k",
                "High memory for huge dictionaries",
                "General autocomplete"
              ],
              [
                "Ternary Search Tree",
                "Compact, cache-friendly",
                "Slightly slower than trie",
                "Memory-constrained dictionaries"
              ],
              [
                "N-gram index",
                "Handles typos and substrings",
                "More storage and noise",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Geohash",
                "Base32 string from interleaved bits",
                "Radius search on sorted sets",
                "Rectangle distortion near poles"
              ],
              [
                "Quadtree",
                "Recursive four-way subdivision",
                "Dense or uneven point distributions",
                "Rebalancing cost on updates"
              ],
              [
                "R-tree",
                "Balanced tree of bounding boxes",
                "Arbitrary geometries and polygons",
