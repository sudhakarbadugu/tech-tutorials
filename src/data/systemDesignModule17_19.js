// Modules 18-20: Capstone Systems (shifted from module17_19)
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Fan-out on write",
                "High for celebrities",
                "Low",
                "Users with few followers and low read latency"
              ],
              [
                "Fan-out on read",
                "Low",
                "High",
                "Users with many followers and write-heavy workloads"
              ],
              [
                "Hybrid",
                "Moderate",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Harder to scale writes beyond a single node"
              ],
              [
                "Wide-column store",
                "Posts and feed caches",
                "Partition by user or post ID",
              ...
              [
                ...
                "Graph partitioning",
                "Higher overhead for simple feeds"
              ],
              [
                "Object store + CDN",
                "Images and videos",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Fresh content",
                "Low",
                "May bury high-quality older posts"
              ],
              [
                "Engagement count",
                "Popularity",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Breadth-first",
                "All links at current depth",
                "Broad discovery",
                "Can waste resources on low-value pages"
              ],
              [
                "Priority",
                "Importance or change frequency",
                "Search engines",
                "Requires good page scoring signals"
              ],
              [
                "Focused",
                "Topical relevance",
                "Vertical search",
                "May miss related but off-topic pages"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              [
                ...
                "First-in first-out",
                "None by default",
                "Easy but can overload hosts"
              ],
              [
                "Priority queue",
                "By score",
                "Hard to enforce per-host",
                "Good for focused crawling"
              ],
              [
                "Front + back queues",
                "Priority then politeness",
                "Built-in per-host delay",
                "Best for large-scale crawlers"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                "Probable duplicates",
                "Fixed size",
                "May cause extra fetches on false positives"
              ],
              [
                "SimHash",
                "Near-duplicate content",
                "Moderate",
                "Compares page fingerprints with Hamming distance"
              ],
              [
                "Content hash",
                "Exact content duplicates",
                "Moderate",
                "Cannot detect modified duplicates"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Geo-distributed fetchers",
                "Lower latency to regional sites",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Apple devices and broad compatibility",
                "Higher latency than some modern protocols"
              ],
              [
                "DASH",
                "MPEG-DASH",
                "Android, web, standards-based",
              ...
              [
                ...
                "Single MP4 file",
                "Simple embeds",
                "No adaptive quality, less efficient"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Full",
                "Manual scaling",
                "Custom pipelines and startups"
              ],
              [
                "AWS Elemental",
                "Managed",
                "Elastic",
                "AWS-native video workloads"
              ],
              [
                "Zencoder",
                "API-driven",
                "Cloud",
                "Quick integration without ops"
              ],
              [
                "Google Transcoder API",
                "Managed",
                "Elastic",
                "Google Cloud video workflows"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Latency",
                "Typically higher",
                "Can be lower with low-latency DASH"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Pull CDN",
                "Fetches content on first request",
                "Long-tail content",
                "First viewer pays origin cost"
              ],
              [
                "Push CDN",
                "Preloads content to edges",
                "Blockbusters and live events",
                "Storage and complexity"
              ],
              [
                "P2P delivery",
                "Viewers share segments",
                "Large live streams",
