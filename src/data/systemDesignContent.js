...
// 13 modules, 80+ topics with mermaid diagrams, code examples, and interview prep

import { restApiDesignModule2 } from './restApiDesignModule2.js';
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Use Case",
                "Task distribution, RPC",
                "Event streaming, logs",
                "AWS-native decoupling"
              ],
              [
                "Retention",
                "Until consumed",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Scaling",
                "Add consumers for throughput",
                "Add subscribers for new features"
              ],
              [
                "Example",
                "SQS, RabbitMQ queues",
              ...
              [
                "Message Life",
                "Consumed once, then deleted",
                "Delivered to all, then deleted"
              ]
            ]
          }
        },
...
t.start()`,
    ...
    Note over C,S: Total latency = network + processing + DB`,
        ...
        {
          heading: "REST in Brief",
          text: "REST (Representational State Transfer) is the most common request-response style. It treats server resources as URLs and uses standard HTTP verbs. REST is stateless, cacheable, and human-readable. See the dedicated REST API Design module for a deep dive."
        },
        {
          heading: "Alternatives: gRPC and GraphQL",
          text: "REST is not the only option. gRPC uses Protobuf over HTTP/2 for high-performance internal calls, with native streaming. GraphQL lets clients request exactly the fields they need in a single POST query. Many systems use a hybrid: gRPC between services, REST for public APIs, and GraphQL for flexible clients."
        },
        {
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Control",
                "Decentralized — each service knows what to do",
                "Centralized — orchestrator directs the flow"
              ],
              [
                "Coupling",
                "Low — services only know events",
                "Medium — orchestrator knows all services"
              ],
              [
                "Visibility",
              ...
              [
                ...
                "Orchestrator manages compensation (Saga)"
              ],
              [
                "Example",
                "Event bus + independent reactors",
                "Camunda, Temporal, AWS Step Functions"
              ],
              [
                "Best For",
                "Simple flows, high autonomy",
                "Complex workflows, strict ordering"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Synchronous",
                "Higher (wait for replica)",
                "No data loss on failover",
                "Financial systems, critical data"
              ],
              [
                "Asynchronous",
                "Lower (ack immediately)",
              ...
              [
                ...
                "Global apps, offline-first"
              ],
              [
                "Logical replication",
                "Medium",
                "Flexible (filter/transform)",
                "Upgrades, partial sync"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Range-based",
                "Easy range queries, natural ordering",
                "Hotspots (new users cluster)",
                "Time-series data by date"
              ],
              [
                "Hash-based",
                "Uniform distribution, no hotspots",
                "No range queries, resharding is hard",
                "User data by user_id hash"
              ],
              [
                "Directory-based",
                "Flexible, easy to move shards",
                "Extra lookup hop, SPOF risk",
                "Large-scale dynamic systems"
              ],
              [
                "Geo-based",
                "Low latency for local users",
                "Uneven load, complex failover",
                "CDNs, regional compliance"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Key movement on add",
                "~100% of keys remapped",
                "~K/N keys remapped"
              ],
              [
                "Distribution",
                "Perfectly uniform",
                "Near-uniform (with virtual nodes)"
              ],
              [
                "Complexity",
                "Simple: key % N",
                "Moderate: hash ring + binary search"
              ],
              [
                "Node removal",
                "All keys remapped",
                `Only neighbor's keys remapped`
              ],
              [
                "Memory",
                "O(1)",
                "O(N log N) for ring lookup"
              ],
              [
                "Best for",
                "Static clusters",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Debugging",
                "Need to reproduce state",
                "Replay events to any point"
              ],
              [
                "Performance",
                "Fast reads, simple writes",
                "Snapshot + replay for reads"
              ],
              [
                "Complexity",
                "Simple",
                "Higher (CQRS, snapshots, event versioning)"
              ],
              [
                "Use Case",
                "Simple CRUD apps",
                "Banking, auditing, collaborative editing"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Complexity",
                "Simple, single model",
                "Two models, sync mechanism"
              ],
              [
                "Consistency",
                "Strong (same DB)",
                "Eventual (read model lags)"
              ],
              [
                "Query Flexibility",
                "Limited by write schema",
                "Any denormalized view possible"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                "Durability, replication, consumer replay"
              ],
              [
                "RocksDB",
                "WAL + MemTable → SST files",
                "Crash recovery for LSM-tree"
              ],
              [
                "etcd/Raft",
                "Raft log (WAL)",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Write-Around",
                "DB only, invalidate cache",
                "Strong (after invalidation)",
                "Low",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "LRU",
                "Temporal locality (recent = relevant)",
                "Medium (track order)",
                "Scanning large datasets flushes cache"
              ],
              [
                "LFU",
                "Popularity-based (hot items stay)",
                "High (counters)",
                "New items struggle to enter cache"
              ],
              [
                "TTL",
                "Time-sensitive data (sessions, tokens)",
                "Low (timestamp)",
                "May evict hot items too early"
              ],
              [
                "FIFO",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "How long browser/CDN can cache",
                "max-age=3600 (1 hour)"
              ],
              [
                "Cache-Control: s-maxage",
                "CDN-specific max-age (overrides max-age)",
                "s-maxage=86400 (24h for CDN)"
              ],
              [
...
class TumblingWindow(StreamProcessor):
    ...
    def process(self, key, value, timestamp=None):
        ...
        if key not in self.current_window_start or            self.current_window_start[key] != window_start:
