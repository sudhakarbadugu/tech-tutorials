export const aiModule4Structure = {
  module4: {
    ...
    topics: [
      { id: 'planning', title: 'Planning in AI' },
      { id: 'probabilistic-reasoning', title: 'Probabilistic Reasoning' },
      { id: 'bayesian-networks', title: 'Bayesian Networks' },
      { id: 'markov-models', title: 'Markov Models' },
      { id: 'decision-theory', title: 'Decision Theory' },
      { id: 'utility-theory', title: 'Utility Theory' },
      { id: 'game-theory-ai', title: 'Game Theory in AI' },
      { id: 'nash-equilibrium', title: 'Nash Equilibrium' },
      { id: 'mechanism-design', title: 'Mechanism Design' },
      { id: 'social-choice', title: 'Social Choice Theory' },
    ]
  }
};
    ...
    'planning': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Approach', 'Representation', 'Search Space', 'Strength', 'Example'],
            rows: [
              ['State-space', 'World states', 'States → actions → states', 'Simple, general', 'Forward/backward search'],
              ['Plan-space (POP)', 'Partial plans', 'Plans with ordering constraints', 'Handles subgoal interactions', 'Partial-order planning'],
              ['HTN', 'Task decompositions', 'Abstract tasks → primitive actions', 'Captures expert knowledge', 'SHOP, SHOP2 planners'],
              ['GraphPlan', 'Planning graph layers', 'Mutex relations prune space', 'Polynomial graph, exponential extraction', 'GraphPlan algorithm'],
              ['SATPlan', 'Propositional logic', 'Boolean satisfiability', 'Leverages SAT solvers', 'Blackbox planner']
            ]
          }
        },
        {
    ...
    'probabilistic-reasoning': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Framework', 'Uncertainty Model', 'Update Rule', 'Output', 'Best For'],
            rows: [
              ['Logical (Classical)', 'None — true/false/unknown', 'Resolution, modus ponens', 'Proof or failure', 'Certain knowledge domains'],
              ['Probabilistic', 'Numeric probabilities', 'Bayes theorem', 'Posterior distribution', 'Noisy, uncertain data'],
              ['Fuzzy Logic', 'Degree of membership', 'Fuzzy operators', 'Fuzzy set', 'Vague linguistic concepts'],
              ['Dempster-Shafer', 'Belief and plausibility', 'Dempster combination', 'Interval [Bel, Pl]', 'Explicit ignorance modeling'],
              ['Possibility Theory', 'Possibility/necessity', 'Min/max rules', 'Possibility distribution', 'Qualitative uncertainty']
            ]
          }
        },
        {
    ...
    'bayesian-networks': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Model', 'Graph Type', 'Edges Mean', 'Independence', 'Best For'],
            rows: [
              ['Bayesian Network', 'Directed acyclic', 'Causal/direct influence', 'd-separation', 'Causal reasoning, diagnosis'],
              ['Markov Network', 'Undirected', 'Symmetric correlation', 'Graph separation', 'Spatial, relational data'],
              ['Factor Graph', 'Bipartite', 'Factor dependencies', 'Variable elimination', 'Message passing algorithms'],
              ['Neural Network', 'Directed (often cyclic)', 'Weighted computation', 'None explicit', 'Function approximation'],
              ['Decision Network', 'DAG + utility nodes', 'Influence + value', 'd-separation', 'Decision making under uncertainty']
            ]
          }
        },
        {
    ...
    'markov-models': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Model', 'States', 'Observations', 'Actions', 'Reward', 'Used For'],
            rows: [
              ['Markov Chain', 'Observable', 'Same as state', 'None', 'None', 'Sequence modeling, PageRank'],
              ['HMM', 'Hidden', 'Observable emissions', 'None', 'None', 'Speech, bioinformatics, NLP tagging'],
              ['MDP', 'Observable', 'Same as state', 'Yes', 'Yes', 'Reinforcement learning, control'],
              ['POMDP', 'Hidden', 'Observable emissions', 'Yes', 'Yes', 'Robotics, dialogue systems'],
              ['Markov Random Field', 'Observable', 'Same as state', 'None', 'None', 'Image segmentation, spatial modeling']
            ]
          }
        },
        {
    ...
    'decision-theory': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Framework', 'Uncertainty', 'Preferences', 'Criterion', 'Use Case'],
            rows: [
              ['Decision Theory', 'Probabilities', 'Utilities', 'Maximize EU', 'Rational individual choice'],
              ['Game Theory', 'Strategic (other agents)', 'Utilities', 'Equilibrium strategies', 'Multi-agent competition'],
              ['Robust Optimization', 'Worst-case sets', 'Cost functions', 'Minimize worst-case', 'Safety-critical systems'],
              ['Risk Analysis', 'Probabilities + scenarios', 'Multiple objectives', 'Tradeoff curves', 'Engineering design'],
              ['Behavioral Economics', 'Biased probabilities', 'Non-EU preferences', 'Descriptive models', 'Understanding human choice']
            ]
          }
        },
        {
    ...
    'utility-theory': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Concept', 'Definition', 'Measurement', 'Agent Type', 'Example'],
            rows: [
              ['Utility', 'Preference strength over outcomes', 'Ordinal or cardinal', 'Rational agent', 'U(health) > U(wealth)'],
              ['Value', 'Worth without uncertainty', 'Direct assessment', 'Deterministic choice', 'Value of a meal'],
              ['Reward', 'Feedback signal for learning', 'Scalar from environment', 'RL agent', '+1 for success'],
              ['Q-Value', 'Expected return from state-action', 'Learned from experience', 'RL agent', 'Q(s,a) = 5.3'],
              ['Happiness (Psychology)', 'Subjective well-being', 'Self-report', 'Human', 'Life satisfaction score']
            ]
          }
        },
        {
    ...
    'game-theory-ai': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Game Type', 'Moves', 'Information', 'Payoff Structure', 'Example'],
            rows: [
              ['Normal-form', 'Simultaneous', 'Complete or incomplete', 'Any', 'Rock-paper-scissors'],
              ['Extensive-form', 'Sequential', 'Perfect or imperfect', 'Any', 'Chess, negotiations'],
              ['Zero-sum', 'Any', 'Any', 'Sum of payoffs = 0', 'Chess, poker (approx)'],
              ['Cooperative', 'Any', 'Any', 'Transferable utility', 'Bargaining, coalition formation'],
              ['Repeated', 'Multiple rounds', 'Any', 'Any', 'Iterated Prisoner\'s Dilemma'],
              ['Stochastic game', 'Sequential', 'Any', 'State-dependent', 'Multi-agent reinforcement learning']
            ]
          }
        },
        {
    ...
    'nash-equilibrium': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Solution Concept', 'Definition', 'Existence', 'Refinement', 'Best For'],
            rows: [
              ['Nash Equilibrium', 'No unilateral profitable deviation', 'Always (mixed)', 'None', 'General games'],
              ['Dominant Strategy Equilibrium', 'Strategy optimal regardless of others', 'Not always', 'Stronger than Nash', 'Simple games'],
              ['Pareto Optimality', 'No one can improve without hurting another', 'Always exists', 'Not a strategy concept', 'Efficiency benchmarking'],
              ['Subgame Perfect Equilibrium', 'Nash in every subgame', 'Always (finite)', 'Eliminates non-credible threats', 'Sequential games'],
              ['Correlated Equilibrium', 'Joint distribution over strategy profiles', 'Always', 'Weaker than Nash', 'Mediated games'],
              ['Bayesian Nash Equilibrium', 'Nash under incomplete information', 'Always', 'Harsanyi transformation', 'Games with private types']
            ]
          }
        },
        {
    ...
    'mechanism-design': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Property', 'Definition', 'Tradeoff', 'Achieved By'],
            rows: [
              ['Truthfulness', 'Dominant strategy to report truth', 'May conflict with budget balance', 'VCG, second-price auction'],
              ['Efficiency', 'Maximizes total welfare', 'May conflict with revenue', 'VCG, competitive equilibrium'],
              ['Budget Balance', 'Payments sum to zero or cost', 'May conflict with truthfulness', 'Impossible with efficiency + truthfulness (Green-Laffont)'],
              ['Individual Rationality', 'Agents benefit from participating', 'May limit feasible outcomes', 'VCG satisfies this'],
              ['Fairness', 'Equitable treatment of agents', 'May conflict with efficiency', 'Equal division, envy-free mechanisms']
            ]
          }
        },
        {
    ...
    'social-choice': {
      ...
      sections: [
        ...
        },
        {
          ...
          table: {
            headers: ['Voting Rule', 'How It Works', 'Strategic Incentive', 'Spoiler Effect', 'Best For'],
            rows: [
              ['Plurality', 'Most first-place votes wins', 'Strong', 'Severe', 'Simple elections'],
              ['Borda Count', 'Rank-based points', 'Moderate', 'Moderate', 'Ranking systems'],
              ['Instant Runoff (IRV)', 'Eliminate last, redistribute', 'Moderate', 'Reduced', 'Political elections'],
              ['Approval Voting', 'Vote for any subset', 'Low', 'None', 'Consensus building'],
              ['Condorcet Methods', 'Pairwise comparisons', 'Low', 'None', 'When majority cycles rare'],
              ['Score Voting', 'Rate each candidate', 'Moderate', 'Low', 'Expressive preferences']
            ]
          }
        },
        {
