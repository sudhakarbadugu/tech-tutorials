...
→ HIGH RISK: Requires immediate mitigation before deployment`,
        ...
        },
        {
          ...
          table: {
            headers: ['Concept', 'Definition', 'NLP Example'],
            rows: [
              ['Deontology', 'Duty-based ethics; rules are absolute', 'Never generate hate speech, regardless of context'],
              ['Consequentialism', 'Outcome-based ethics; results matter most', 'Allow synthetic data generation if net benefit is positive'],
              ['Virtue Ethics', 'Character-based; what would a good developer do?', 'Build transparency into models because it is the right thing to do'],
              ['Fairness', 'Equal treatment across groups', 'Ensure equal sentiment accuracy across demographic groups'],
              ['Justice', 'Equitable distribution of benefits and burdens', 'Do not deploy systems that only work well for majority languages']
            ]
          }
        },
        {
...
Analysis:
  ...
  → Minority dialect speakers more likely to be falsely flagged`,
        ...
        },
        {
          ...
          table: {
            headers: ['Bias Type', 'Source', 'Example in NLP'],
            rows: [
              ['Selection Bias', 'Non-representative training data', 'Corpus dominated by news and Wikipedia underrepresents informal speech'],
              ['Historical Bias', 'Past inequalities encoded in data', 'Word embeddings associate "doctor" with "he" and "nurse" with "she"'],
              ['Measurement Bias', 'Flawed feature or label construction', 'Sentiment labels assigned by majority-culture annotators misread minority expressions'],
              ['Aggregation Bias', 'One-size-fits-all model for distinct groups', 'A single sentiment model for all English dialects performs poorly on AAVE'],
              ['Evaluation Bias', 'Benchmarks that do not represent all users', 'GLUE benchmark dominated by standard American English text']
            ]
          }
        },
        {
  ...
  → Strong privacy: output nearly identical
    whether any single person is included or not`,
        ...
        },
        {
          ...
          table: {
            headers: ['Technique', 'How It Works', 'Strength', 'Limitation'],
            rows: [
              ['Anonymization', 'Remove direct identifiers (names, IDs)', 'Simple to implement', 'Re-identification possible via linkage attacks'],
              ['Pseudonymization', 'Replace identifiers with tokens', 'Preserves data structure', 'Token mapping table is a vulnerability point'],
              ['Differential Privacy', 'Add noise to training/inference', 'Mathematical privacy guarantee', 'Reduces model utility; complex tuning'],
              ['Federated Learning', 'Train on local data; share only updates', 'Data never leaves device', 'Communication overhead; still vulnerable to inference attacks'],
              ['Homomorphic Encryption', 'Compute on encrypted text', 'Strong security guarantee', 'Extremely slow; impractical for large models'],
              ['Synthetic Data', 'Generate artificial text statistically similar to real', 'No real individuals exposed', 'May not capture rare but important patterns']
            ]
          }
        },
        {
...
Future challenge:
  ...
  and continuous learning from interaction.`,
        ...
        },
        {
          ...
          table: {
            headers: ['Dimension', 'Current NLP (2020s)', 'Future NLP (2030s+)'],
            rows: [
              ['Scale', 'Billions of parameters, trillions of tokens', 'Efficient small models; quality over quantity'],
              ['Languages', '~100 high-resource languages dominate', 'Thousands of languages, dialects, and endangered languages supported'],
              ['Modality', 'Primarily text', 'Seamless text, speech, vision, gesture, and structured data integration'],
              ['Reasoning', 'Pattern matching and statistical association', 'Explicit logical reasoning, causal inference, and verifiable claims'],
              ['Deployment', 'Cloud-based centralized APIs', 'On-device, federated, and edge computing with privacy guarantees'],
              ['Evaluation', 'Static benchmarks (GLUE, SuperGLUE)', 'Dynamic, real-world, and human-centered evaluation protocols'],
              ['Alignment', 'RLHF with small annotator pools', 'Constitutional AI, democratic deliberation, and diverse value alignment']
            ]
          }
        },
        {
...
export default nlpModule5Content;
