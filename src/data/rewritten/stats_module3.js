...
// Regenerate: node scripts/upgrade-modules.js stats_module3.js
    ...
    'hypothesis-testing': {
      ...
      sections: [
        ...
        },
        {
          ...
          content: [
            '<p>Hypothesis testing is a formal procedure for evaluating claims about population parameters using sample data. It helps you decide whether an observed effect is genuine or just due to random chance. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, Hypothesis testing is a formal procedure for evaluating claims about population parameters using sample data. It helps you decide whether an observed effect is genuine or just due to random chance. Null Hypothesis (H₀): the default claim — usually "no effect," "no difference," or "no relationship" Alternative Hypothesis (H₁): the claim you seek evidence for — a difference, effect, or relationship exists Significance Level (α): the threshold for rejecting H₀, typically 0.05 (5% chance of false rejection) Test Statistic: a standardized score computed from sample data p-value: the probability of seeing your result (or more extreme) if H₀ were true</p>',
            '<p>You use hypothesis testing when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — Hypothesis Testing

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: Hypothesis Testing sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                'Power',
                'Higher for same α if direction is correct',
                'Lower, but detects both directions'
              ],
              [
                'When to use',
                'Strong prior theory about direction',
                'No prior directional expectation'
              ]
            ]
          }
        },
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        },
        {
          ...
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>Hypothesis Testing</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
...
plt.title("Bill by day — Hypothesis Testing")
plt.suptitle("")
plt.show()`,
    ...
    'z-test': {
      ...
      sections: [
        ...
        },
        {
          heading: 'Concept Explanation',
          content: [
            '<p>A Z-test evaluates whether a sample statistic differs from a hypothesized population value when the population standard deviation is known and the sample is sufficiently large. It relies on the normal distribution. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, A Z-test evaluates whether a sample statistic differs from a hypothesized population value when the population standard deviation is known and the sample is sufficiently large. It relies on the normal distribution. One-Sample Z-Test: compares a sample mean to a known population mean Two-Sample Z-Test: compares means from two independent populations Z-Test for Proportions: compares a sample proportion to a hypothesized value Requirement: population σ known, or n ≥ 30 (CLT justifies normality) The test statistic follows the standard normal distribution: Z ~ N(0, 1)</p>',
            '<p>You use z-test when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — Z-Test

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: Z-Test sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
          heading: 'Key Formula / Rule',
          ...
          table: {
            ...
            rows: [
              [
                'Population SD (σ)',
                'Must be known',
                'Unknown; uses sample SD (s)'
              ],
              [
                'Sample size',
                'Any size if σ known; large if σ estimated',
                'Any size, but especially small (n < 30)'
              ],
              [
                'Distribution',
                'Standard normal (Z)',
              ...
              [
                'When to use',
                'Known σ or very large n',
                'Unknown σ, especially small samples'
              ]
            ]
          }
        },
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        {
          heading: 'Try It Yourself',
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>Z-Test</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
            title: 'Solution (collapsed)',
            code: `import seaborn as sns
import matplotlib.pyplot as plt
    ...
    't-test': {
      ...
      sections: [
        ...
        },
        {
          heading: 'Concept Explanation',
          content: [
            '<p>A t-test evaluates whether a sample mean (or difference between means) is statistically significant when the population standard deviation is unknown. It uses the sample standard deviation and the t-distribution, which has heavier tails than the normal distribution to account for extra uncertainty. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, A t-test evaluates whether a sample mean (or difference between means) is statistically significant when the population standard deviation is unknown. It uses the sample standard deviation and the t-distribution, which has heavier tails than the normal distribution to account for extra uncertainty. One-Sample T-Test: compares a sample mean to a known or hypothesized value Independent Samples T-Test: compares means from two unrelated groups Paired Samples T-Test: compares means from the same subjects under two conditions Requirement: data approximately normally distributed, especially for small samples Uses degrees of freedom (df), which adjusts the shape of the t-distribution</p>',
            '<p>You use t-test when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — T-Test

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: T-Test sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
          heading: 'Key Formula / Rule',
...
print(f"Welch t-test: t={t:.3f}, p={p:.4f}")`,
        ...
        },
        {
          ...
          table: {
            headers: [
              'Aspect',
              'Pooled Variance (Equal SD)',
              `Welch's T-Test (Unequal SD)`
            ],
            rows: [
              [
                'Assumption',
              ...
              [
                'Formula',
                'Uses combined s²p',
                'Uses separate SDs with adjusted df'
              ],
              [
                'df',
                'n₁ + n₂ - 2',
                'Approximate, usually smaller'
              ],
              [
                'Robustness',
                'Less robust if variances differ',
                'More robust, slightly less powerful'
              ],
              [
                'Recommendation',
                'Use only after variance homogeneity test',
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        {
          heading: 'Try It Yourself',
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>T-Test</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
            title: 'Solution (collapsed)',
            code: `import seaborn as sns
import matplotlib.pyplot as plt
    ...
    'chi-square': {
      ...
      sections: [
        ...
        },
        {
          heading: 'Concept Explanation',
          content: [
            '<p>The chi-square (χ²) test is a non-parametric test used with categorical data to evaluate whether observed frequencies differ from expected frequencies. It is the categorical equivalent of the t-test and ANOVA. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, The chi-square (χ²) test is a non-parametric test used with categorical data to evaluate whether observed frequencies differ from expected frequencies. It is the categorical equivalent of the t-test and ANOVA. Chi-Square Test of Independence: tests whether two categorical variables are related Chi-Square Goodness of Fit: tests whether observed frequencies match a theoretical distribution Test Statistic: χ² = Σ (O - E)² / E, where O = observed and E = expected Requirement: expected frequency in each cell should be ≥ 5 (or ≥ 1 with few cells) Degrees of freedom: (rows - 1) × (columns - 1) for independence; (categories - 1) for goodness of fit</p>',
            '<p>You use chi-square test when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — Chi-Square Test

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: Chi-Square Test sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
          heading: 'Key Formula / Rule',
...
1.01 < 3.84 → Fail to reject H₀`,
        ...
        },
        {
          heading: 'Python Code Example',
          example: {
            title: 'Chi-Square Test with Python',
            code: `import numpy as np
import seaborn as sns
from scipy import stats
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                'Die rolls vs fair die expectation'
              ],
              [
                'Homogeneity',
                'Do groups have same distribution?',
                'Row × Column / Total',
                'Do three cities prefer the same brands?'
              ]
            ]
          }
        },
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        {
          heading: 'Try It Yourself',
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>Chi-Square Test</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
            title: 'Solution (collapsed)',
            code: `import seaborn as sns
import matplotlib.pyplot as plt
...
print("Categories:", tips["day"].unique())
tips.boxplot(column="total_bill", by="day")
plt.title("Bill by day — Chi-Square Test")
plt.suptitle("")
plt.show()`,
            output: 'You should see summary stats and a boxplot by day; compare medians and spread before choosing a test.',
            language: 'python',
    ...
    anova: {
      ...
      sections: [
        ...
        },
        {
          heading: 'Concept Explanation',
          content: [
            '<p>Analysis of Variance (ANOVA) tests whether the means of three or more groups are significantly different. Instead of running multiple t-tests (which inflates Type I error), ANOVA uses a single F-test to compare between-group variation to within-group variation. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, Analysis of Variance (ANOVA) tests whether the means of three or more groups are significantly different. Instead of running multiple t-tests (which inflates Type I error), ANOVA uses a single F-test to compare between-group variation to within-group variation. One-Way ANOVA: one independent variable with three or more levels Two-Way ANOVA: two independent variables, also tests interaction effects F-statistic: ratio of between-group variance to within-group variance Assumptions: normality within each group, homogeneity of variances (equal SDs), independent observations If ANOVA is significant, post-hoc tests (Tukey, Bonferroni) identify which specific groups differ</p>',
            '<p>You use anova when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — ANOVA

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: ANOVA sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
          heading: 'Key Formula / Rule',
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        {
          heading: 'Try It Yourself',
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>ANOVA</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
            title: 'Solution (collapsed)',
            code: `import seaborn as sns
import matplotlib.pyplot as plt
    ...
    'non-parametric': {
      ...
      sections: [
        ...
        },
        {
          heading: 'Concept Explanation',
          content: [
            '<p>Non-parametric tests are statistical methods that do not assume the data follows a specific distribution (like normal). They use ranks, signs, or counts instead of means and variances, making them robust to outliers and suitable for ordinal or heavily skewed data. Start with intuition: ask what question this concept answers before memorizing formulas.</p>',
            '<p>Technically, Non-parametric tests are statistical methods that do not assume the data follows a specific distribution (like normal). They use ranks, signs, or counts instead of means and variances, making them robust to outliers and suitable for ordinal or heavily skewed data. Mann-Whitney U Test: compares two independent groups (non-parametric alternative to independent t-test) Wilcoxon Signed-Rank Test: compares paired measurements (alternative to paired t-test) Kruskal-Wallis Test: compares three or more independent groups (alternative to one-way ANOVA) Spearman Rank Correlation: measures monotonic association between two variables (alternative to Pearson correlation) No normality or equal variance assumptions required — only that observations are independent</p>',
            '<p>You use non-parametric tests when you need reproducible, evidence-based decisions rather than gut feeling — A/B tests, clinical trials, forecasting, and model evaluation all depend on it.</p>'
          ],
          note: 'References: Casella & Berger (2002), <em>Statistical Inference</em>; Wasserman (2004), <em>All of Statistics</em>.'
        },
        {
          heading: 'Visual Representation',
          code: `Concept map — Non-Parametric Tests

  Raw data  →  Summarize / model  →  Inference  →  Decision
     |              |                    |              |
  sample n      estimate θ̂          CI / p-value    deploy / report

  Key idea: Non-Parametric Tests sits in the inference layer — turning noisy samples into actionable ranges.`,
          language: 'text'
        },
        {
          heading: 'Key Formula / Rule',
...
Step 4 — Compare to critical value:
  ...
  12 > 2 → Fail to reject H₀`,
        ...
        },
        {
          heading: 'Python Code Example',
          example: {
            title: 'Non-Parametric Tests with Python',
            code: `import numpy as np
import seaborn as sns
from scipy import stats
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                'Assumptions',
                'Normality, equal variance, interval/ratio data',
                'No distribution assumption; works with ordinal/ranked data'
              ],
              [
                'Power',
              ...
              [
                'Outliers',
                'Sensitive (mean is affected)',
                'Robust (ranks are less affected)'
              ],
              [
                'Data type',
                'Interval or ratio',
                'Ordinal, ranked, or heavily skewed continuous'
              ],
              [
                'Examples',
                't-test, ANOVA, Pearson r',
                'Mann-Whitney, Kruskal-Wallis, Spearman ρ'
              ]
            ]
          }
        },
...
Ans: Statistical significance ≠ practical importance — report the CI and effect size; the result may be significant only because n is huge.`
        ...
        {
          heading: 'Try It Yourself',
          text: '<strong>Task:</strong> Load the seaborn <code>tips</code> dataset, compute a group summary statistic relevant to <em>Non-Parametric Tests</em>, and visualize the distribution. Interpret one number from the output.',
          example: {
            title: 'Solution (collapsed)',
            code: `import seaborn as sns
import matplotlib.pyplot as plt
...
print("Categories:", tips["day"].unique())
tips.boxplot(column="total_bill", by="day")
plt.title("Bill by day — Non-Parametric Tests")
plt.suptitle("")
plt.show()`,
            output: 'You should see summary stats and a boxplot by day; compare medians and spread before choosing a test.',
            language: 'python',
