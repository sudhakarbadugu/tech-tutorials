// Deep dives for modules 16-20 (shifted after REST insertion)
        ...
        table: {
          ...
          rows: [
            [
              ...
              "20–100 ms",
              "1–10 ms",
              "Cached recursive resolver: <1 ms; cold lookup: 50–200 ms"
            ],
            [
              "TTL (Time to Live)",
              "300 s–24 h",
              "60 s–5 min",
              "Short TTL for failover; long TTL for cache efficiency"
            ],
            [
              "DNS Query QPS per Resolver",
              "1K–10K",
              "1M–10M",
              "Cloudflare handles 1.1M+ queries per second globally"
            ],
            [
              "Authoritative DNS Latency",
              "1–10 ms",
              "<1 ms",
              "Route 53 authoritative response: <1 ms"
            ],
            [
              "DNS Record Types in Use",
              "A/AAAA/CNAME/TXT/NS",
              "Same + ALIAS/SVCB/HTTPS",
              "ALIAS records for apex flattening"
            ],
            [
              "Recursive Resolver Cache Hit Rate",
              "80–95%",
              "95–99%",
              "Higher TTL and popular domains increase hit rate"
            ],
            [
            ...
            [
              ...
              "10–50",
              "100–300+",
              "Cloudflare: 300+ cities; faster edge resolution"
            ],
            [
              "DDoS Mitigation Capacity",
              "10M–100M qps",
              "100M+ qps",
              "Cloudflare blocked 71M rps DDoS in 2023"
            ],
            [
              "DNS Propagation Delay",
              "TTL-bound (minutes–hours)",
              "Near-instant with API",
              "Cloudflare/Route 53 push changes in <1 min"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–20 ms",
              "Recursive cache hit; resolver healthy",
              "Normal user browsing experience"
            ],
            [
              "2× Load",
              "20–50 ms",
              "Some cache eviction; fresh lookups rise",
              "Monitor resolver CPU and cache efficiency"
            ],
            [
              "5× Load",
              "50–100 ms",
              "Resolver queues grow; TTL truncation begins",
              "Rate limiting or capacity expansion needed"
            ],
            [
              "10× Load",
              "100 ms–1 s",
              "Recursive resolver CPU saturated",
              "Anycast steering and more resolvers required"
            ],
            [
              "DDoS / Attack",
              "Timeout or NXDOMAIN",
              "Authoritative servers rate-limit",
              "DDoS absorption at edge; origin protected"
            ],
            [
              "Cache Poisoning Attempt",
              "Normal or filtered",
              "DNSSEC validation rejects bogus records",
              "DNSSEC + DNS-over-HTTPS mitigates"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "GeoDNS + weighted records",
              "30–60 s",
              "Steer traffic across clouds",
              "Netflix, Uber"
            ]
          ]
        }
    ...
    "consensus-raft-paxos": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "150–300 ms",
              "100–200 ms",
              "etcd default heartbeat: 100 ms; election: 1 s"
            ],
            [
              "Paxos/Raft Write Latency",
              "1–10 ms (LAN)",
              "10–50 ms (WAN)",
              "Majority quorum: 2 of 3 or 3 of 5"
            ],
            [
              "etcd Write Throughput",
              "1K–10K writes/s",
              "10K+ writes/s",
              "Limited by fsync latency and leader CPU"
            ],
            [
              "etcd Read Throughput",
              "10K–50K reads/s",
              "100K+ reads/s",
              "Reads can be served from follower"
            ],
            [
              "Leader Election Time",
              "100 ms–1 s",
              "50–200 ms",
              "Network partition triggers election"
            ],
            [
              "Log Replication Lag",
              "1–10 ms",
              "<1 ms",
              "Followers lag behind leader slightly"
            ],
            [
              "Cluster Size",
              "3–5 nodes",
              "5–9 nodes",
              "Odd numbers avoid split votes; etcd max 7–9"
            ],
            [
              "Max Recommended Data Size",
              "1–8 GB",
              "100 MB–1 GB",
              "etcd practical limit: ~8 GB; recommended <1 GB"
            ],
            [
              "Snapshot Interval",
              "10K–100K entries",
              "1K–10K entries",
              "Frequent snapshots limit log replay"
            ],
            [
              "Consensus Messages per Write",
              "2N–4N",
              "N+1 (optimized)",
              "N = cluster size; leader → followers → acks"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Write Load",
              "5–15 ms",
              "Leader CPU/disk busier; latency rises",
              "Still within SLA"
            ],
            [
              "5× Write Load",
              "15–50 ms",
              "Replication lag grows; followers catch up",
              "Consider larger leader instance"
            ],
            [
              "10× Write Load",
              "50 ms–1 s",
              "Leader saturated; election risk",
              "Scale by partitioning data or add followers"
            ],
            [
              "Network Partition (minority leader)",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Kubernetes config/metadata",
              "Raft (etcd)",
              "3–5 nodes",
              "Cluster state, secrets, config",
              "Kubernetes etcd"
            ],
            [
              "Service discovery",
              "Raft (Consul) / Gossip hybrid",
              "3–5 servers",
              "Healthy instance registry",
              "Consul service mesh"
            ],
            [
              "Distributed locks",
              "Raft / Paxos-based lock service",
              "3–5 nodes",
              "Leader election, mutual exclusion",
              "etcd leases, ZooKeeper"
            ],
            [
              "Globally distributed SQL",
              "Multi-Paxos / Raft per range",
    ...
    "distributed-id-generation": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Snowflake IDs per ms per worker",
              "1–4,096",
              "4,096",
              "Twitter Snowflake: 12-bit sequence = 4,096/ms"
            ],
            [
              "Snowflake ID Throughput",
              "1K–100K IDs/s",
              "1M–10M IDs/s",
              "Scale by adding worker/datacenter IDs"
            ],
            [
              "UUID v4 Generation Rate",
              "100K–1M/s",
              "1M–10M/s",
              "Random; no coordination; 128 bits"
            ],
            [
              "UUID v7 Generation Rate",
              "100K–1M/s",
              "1M+ /s",
              "Sortable by time; improves DB insert locality"
            ],
            [
              "Database Auto-Increment",
              "1K–10K/s",
              "Bottleneck",
              "Single-node write; not scalable"
            ],
            [
              "Hi/Lo Allocation Range",
              "1–1,000 per batch",
              "1K–10K per batch",
              "Hibernate optimist; reduces DB round trips"
            ],
            [
              "Flake ID Latency",
              "<1 ms",
              "<0.1 ms",
              "Local generation; no network call"
            ],
            [
              "ID Size",
              "8 bytes (Snowflake)",
              "16 bytes (UUID)",
              "Smaller IDs = better index density"
            ],
            [
              "Clock Dependency",
              "Yes (Snowflake)",
              "No (UUID v4)",
              "Snowflake needs NTP; clock backslide breaks ordering"
            ],
            [
              "Sortability",
              "Time-ordered (Snowflake)",
              "Random (UUID v4)",
              "Time-ordered IDs improve B-tree insert performance"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "10× Load",
              "<1 ms",
              "Sequence counter increments rapidly",
              "Snowflake still within 4,096/ms per worker"
            ],
            [
              "100× Load",
              "1–5 ms",
              "Need more workers/datacenters",
              "Scale horizontally by partitioning ID space"
            ],
            [
              "1,000× Load",
              "5–20 ms",
              "Coordinator / database allocation under pressure",
              "Switch to fully local algorithms"
            ],
            [
              "Clock Skew (Snowflake)",
              "Generation pauses",
            ...
            [
              ...
              "Rollover to next ms",
              "Brief 1 ms wait",
              "12-bit sequence limits burst per worker"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Snowflake / Sonyflake",
              "Time-ordered",
              "None with unique worker IDs",
              "Twitter tweets"
            ],
            [
              "Database-friendly inserts",
              "UUID v7 / Snowflake",
              "Time-ordered",
              "Negligible",
              "New OLTP systems"
            ...
            [
              "Global multi-region",
              "Snowflake with datacenter bits",
              "Roughly time-ordered",
              "None",
              "Discord messages"
            ],
            [
              "Embedded/mobile offline",
              "UUID v4 / ULID",
              "Random / time-ordered",
              "Negligible",
              "Mobile photo sync"
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–10 ms",
              "<1 ms",
              "etcd: ~1–3 ms; Redis: <1 ms local"
            ],
            [
              "Lock Hold Timeout",
              "5–30 s",
              "1–5 s",
              "Must exceed expected work duration"
            ],
            [
              "Lease Renewal Interval",
              "1/3 of TTL",
              "100 ms–1 s",
              "Keep-alive prevents expiration during work"
            ],
            [
              "Redlock Quorum",
              "N/2 + 1",
              "N/2 + 1",
              "Acquire majority of N Redis instances"
            ],
            [
              "ZooKeeper Lock Latency",
              "5–20 ms",
              "1–5 ms",
              "Sequential ephemeral nodes"
            ],
            [
              "etcd Lock Throughput",
              "1K–5K locks/s",
              "10K+ locks/s",
              "Limited by leader write throughput"
            ],
            [
              "False-Unlock Probability",
              "<0.01%",
              "<0.001%",
              "Fencing tokens prevent stale client unlock"
            ],
            [
              "Lock Contention Rate",
              "1–10%",
              "10–50%",
              "High contention suggests coarse lock or split"
            ],
            [
              "Fencing Token Size",
              "64-bit",
              "64-bit",
              "Monotonically increasing token per lock"
            ],
            [
              "DynamoDB Lock Lease Duration",
              "10–60 s",
              "1–10 s",
              "AWS DynamoDB Lock Client defaults"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "5–20 ms",
              "Some waiting; queue forms",
              "Monitor lock hold time"
            ],
            [
              "5× Load",
              "20–100 ms",
              "Frequent retries; lease renewal pressure",
              "Consider finer-grained locks"
            ],
            [
              "10× Load",
              "100 ms–1 s",
              "Lock contention dominates latency",
              "Redesign to avoid lock or use optimistic concurrency"
            ],
            [
              "Network Partition",
              "Stale lock risk",
              "Fencing token required",
              "Without token, split-brain writes possible"
            ],
            [
              "Client Crash While Holding Lock",
              "Lock expires after TTL",
              "Other clients acquire after timeout",
              "TTL must bound worst-case stale access"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Short-lived resource lock",
              "Redis SET NX EX",
              "TTL lock",
              "Best-effort (Redlock debates)",
              "Rate-limit resource"
            ],
            [
            ...
            [
              ...
              "Paxos-backed lock",
              "Strong",
              "Global seat reservation"
            ],
            [
              "Per-user action dedup",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–10 ms",
              "<1 ms",
              "In-memory client cache: <1 ms"
            ],
            [
              "Eureka Registry Size",
              "100–1,000 services",
              "5,000–10,000+",
              "Netflix Eureka: 10K+ service registrations"
            ],
            [
              "Consul Query Latency",
              "1–5 ms",
              "<1 ms (cached)",
              "Consul agent cache on each node"
            ],
            [
              "Kubernetes DNS Resolution",
              "1–5 ms",
              "<1 ms (CoreDNS cache)",
              "CoreDNS cache TTL default 30 s"
            ],
            [
              "Health Check Interval",
              "5–30 s",
              "1–5 s",
              "Faster checks = faster failover but more load"
            ],
            [
              "Service Registration Propagation",
              "1–10 s",
              "100 ms–1 s",
              "Gossip/consensus propagation delay"
            ],
            [
              "Client Cache TTL",
              "30 s–5 min",
              "10–30 s",
              "Balance freshness vs lookup load"
            ],
            [
              "Max Endpoints per Service",
              "10–100",
              "1,000–10,000",
              "Kubernetes service can front thousands of pods"
            ],
            [
              "DNS TTL for Service Names",
              "5 s–5 min",
              "1–30 s",
              "Short for dynamic environments"
            ],
            [
              "Service Mesh Discovery Latency",
              "1–5 ms",
              "<1 ms",
              "Envoy SDS (Service Discovery Service) push"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–5 ms",
              "Cached lookups; registry stable",
              "Healthy"
            ],
            [
              "2× Load",
              "5–10 ms",
              "Some cache misses; registry QPS rises",
              "Monitor registry CPU"
            ],
            [
              "5× Load",
              "10–50 ms",
              "Frequent re-registrations during churn",
              "Scale registry or increase cache TTL"
            ],
            [
              "10× Load",
              "50 ms–1 s",
              "Registry approaching limits",
              "Add registry nodes; shard by service"
            ],
            [
              "Thundering Herd (cache miss)",
              "Spike then recover",
              "Many simultaneous lookups",
              "Use jitter and longer TTL"
            ],
            [
              "Registry Failure",
              "Client cache degrades gracefully",
              "Stale endpoints possible",
              "Client-side caching essential for availability"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "DNS round-robin",
              "1–50 ms",
              "Static or slow-changing backends",
              "Early web app"
            ],
            [
              ...
              "Legacy Netflix stack"
            ],
            [
              "Multi-cloud / VM",
              "Consul",
              "1–5 ms",
              "Service mesh-ready registry",
              "Nomad, VM fleet"
            ],
            [
              "Kubernetes-native",
              "CoreDNS + Endpoints API",
              "<1 ms (cached)",
    ...
    "vector-clocks": [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Replicas (N) in Practice",
              "3",
              "3–7",
              "More replicas = larger clock"
            ],
            [
              "Concurrent Update Rate",
              "0.01–1%",
              "1–10% during partitions",
              "Higher during network splits"
            ],
            [
              "Conflict Resolution Time",
              "1–10 ms",
              "1–100 ms",
              "Last-write-wins: fast; CRDT merge: varies"
            ],
            [
              "Divergent Version Count",
              "1–2",
              "2–10+",
              "Unreconciled siblings after partition"
            ],
            [
              "Siblings per Key (Riak)",
              "1–2",
              "2–5",
              "Riak warns when siblings exceed limit"
            ],
            [
              "Vector Clock Pruning Interval",
              "1K–10K updates",
              "100–1K updates",
              "Remove stale entries to bound size"
            ],
            [
              "Clock Comparison Latency",
              "1 µs–1 ms",
              "<1 µs",
              "Compare N counters; CPU-bound"
            ],
            [
              "Storage Overhead",
              "0.1–1%",
              "1–5%",
              "Depends on value size and replica count"
            ],
            [
              "Application-Resolved Conflicts",
              "1–10%",
              "10–50%",
              "Business logic needed for semantic reconciliation"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "+0.1–1 ms",
              "Clock appended; no conflicts",
              "Minimal overhead"
            ],
            [
              "2× Load",
              "+1–5 ms",
              "Sibling comparisons increase",
              "Still manageable"
            ],
            [
              "5× Load",
              "+5–20 ms",
              "More concurrent writes per key",
              "Conflict resolution dominates"
            ],
            [
              "10× Load",
              "+20–100 ms",
              "Many siblings; app reconciliation needed",
              "Consider reducing partition count or using CRDTs"
            ],
            [
              "Network Partition",
              "Versions diverge",
              "Siblings accumulate",
              "Return multiple versions to client"
            ],
            [
              "Partition Heal",
              "Merge latency spikes",
              "Anti-entropy reconciles clocks",
              "Read repair or background repair needed"
            ]
          ]
        }
      },
    ...
    "inverted-index": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Index Size vs Raw Text",
              "30–50% of raw",
              "20–30% with compression",
              "Google: index ~10–20% of web text"
            ],
            [
              "Documents per Shard",
              "1M–50M",
              "10M–100M",
              "Elasticsearch recommends 20–40 GB per shard"
            ],
            [
              "Query Latency (p99)",
              "10–100 ms",
              "1–10 ms",
              "Cached term lookups and filter bitsets"
            ],
            [
              "Indexing Throughput",
              "1K–10K docs/s",
              "100K+ docs/s",
              "Bulk indexing with segment merges"
            ],
            [
              "Term Dictionary Size",
              "10K–1M terms",
              "1B+ terms",
              "Web search: billions of unique tokens"
            ],
            [
              "Posting List Length",
              "10–1,000 docs",
              "1M+ docs",
              "Stop words have huge posting lists"
            ],
            [
              "Segment Merge Latency",
              "100 ms–1 s",
              "1–10 s",
              "Lucene background merges segments"
            ],
            [
              "Memory per Query",
              "1–10 MB",
              "100 MB–1 GB",
              "Aggregations and sorting consume heap"
            ],
            [
              "Replica Count",
              "1",
              "1–3",
              "Replicas improve read throughput and HA"
            ],
            [
              "Search Cluster Nodes",
              "3–10",
              "100–1,000+",
              "Elasticsearch clusters with 1,000+ nodes exist"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "10–50 ms",
              "Simple term queries hit cache",
              "Healthy"
            ],
            [
              "2× Load",
              "50–100 ms",
              "Filter cache pressure; some disk reads",
              "Monitor heap and cache hit rate"
            ],
            [
              "5× Load",
              "100 ms–1 s",
              "Aggregations and sorts consume CPU",
              "Add replicas or optimize queries"
            ],
            [
              "10× Load",
              "1–5 s",
              "GC pressure; node hotspotting",
              "Shard allocation and query routing need tuning"
            ],
            [
              "Indexing Spike",
              "Query latency rises",
              "Merge throttling activates",
              "Separate indexing and search clusters"
            ],
            [
              "Large Fanout Query",
              "100 ms–1 s",
              "Many posting lists intersected",
              "Use skip lists and pruning"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "E-commerce search",
              "Elasticsearch",
              "By category or shard count",
              "Facets, synonyms, boosting",
            ...
            [
              ...
              "By time",
              "Hot/warm/cold tiers, ILM",
              "ELK stack"
            ],
            [
              "Web search",
              "Custom (Lucene-based)",
              "By term + document range",
              "Crawling, PageRank, pruning",
              "Google, Bing"
            ],
            [
              "Mobile app search",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–50 ms",
              "<10 ms",
              "Must feel instantaneous; 100 ms is perceptible"
            ],
            [
              "Prefix Length Processed",
              "1–3 chars",
              "1 char",
              "Google starts suggesting after 1 character"
            ],
            [
            ...
            [
              ...
              "1K–1M events/s",
              "10M+ events/s",
              "Every keystroke can be logged for ranking"
            ],
            [
              "Prefix Index Size",
              "1M–10M prefixes",
              "100M–1B+",
              "Google: billions of prefixes"
            ],
            [
              "Index Update Frequency",
              "Minutes–hours",
              "Seconds–minutes",
              "Trending queries updated faster"
            ],
            [
              "Cache Hit Rate",
              "80–95%",
            ...
            [
              "Personalized Suggestions Ratio",
              "10–30%",
              "30–50%",
              "Netflix/Amazon personalize heavily"
            ],
            [
              "Mobile Typo Correction Rate",
              "5–15%",
              "20–30%",
              "Mobile keyboards generate more errors"
            ],
            [
              "Ranking Signals",
              "Popularity, recency",
              "+ user history, location, context",
              "ML models rank suggestions"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "20–50 ms",
              "Some cache misses; origin lookups",
              "Still acceptable"
            ],
            [
              "5× Load",
              "50–100 ms",
              "Origin CPU rises; may drop suggestions",
              "Add edge cache or replicas"
            ],
            [
              "10× Load",
              "100 ms–1 s",
              "Degraded experience; suggestions stale",
              "Scale serving tier; precompute hot prefixes"
            ],
            [
              "Trending Event Spike",
              "Spike then cached",
              "Trending queries precomputed",
              "Twitter pre-builds trending suggestions"
            ],
            [
              "Cold Prefix (long tail)",
              "50–200 ms",
              "Database lookup or fallback",
              "Acceptable for rare queries"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–12 chars",
              "6–9 chars",
              "Higher precision = smaller cell"
            ],
            [
              "Cell Size at Precision 6",
              "~1.2 km × 0.6 km",
              "Same",
              "Useful for city-level queries"
            ],
            [
              "Cell Size at Precision 9",
              "~4.8 m × 4.8 m",
              "Same",
              "Useful for exact location"
            ],
            [
              "Quadtree Depth",
              "10–20 levels",
              "20–30 levels",
              "Each level splits cell into 4"
            ],
            [
              "Points per Leaf Node",
              "10–100",
              "1–10",
              "Higher depth = fewer points per leaf"
            ],
            [
              "Radius Query Latency",
              "1–10 ms",
              "<1 ms",
              "Find cells overlapping radius, then filter"
            ],
            [
              "Index Size per Point",
              "8–32 bytes",
              "16–64 bytes",
              "Geohash + point + reference"
            ],
            [
              "Uber Driver Locations",
              "1M+",
              "10M+",
              "Updated every few seconds globally"
            ],
            [
              "Geospatial QPS",
              "1K–10K",
              "100K–1M+",
              "Uber dispatches use massive geo query volume"
            ],
            [
              "H3 Resolution Levels",
              "0–15",
              "8–10 typical",
              "Hexagonal grid; Uber H3 for analytics"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–10 ms",
              "Small radius; few candidate cells",
              "Healthy"
            ],
            [
              "2× Load",
              "10–20 ms",
              "More candidate points to filter",
              "Add replicas"
            ],
            [
              "5× Load",
              "20–50 ms",
              "Large query radius; many cells",
              "Tune geohash precision"
            ],
            [
              "10× Load",
              "50–200 ms",
              "Hotspot cells saturated",
            ...
            [
              ...
              "Use finer precision or quadtree"
            ],
            [
              "Sparse Rural Area",
              "Lower latency",
              "Few points; broader cells acceptable",
              "Coarser precision works"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Search by polygon",
              "PostGIS / Elasticsearch geo_shape",
              "Polygons",
              "High",
              "Real estate search"
            ]
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M–10M",
              "500M+",
              "Facebook: ~2B DAU; Twitter/X: ~250M"
            ],
            [
              "Posts Created per Day",
              "1M–10M",
              "500M+",
              "Includes original posts, replies, reshares"
            ],
            [
              "Feed Reads per Day",
              "100M–1B",
              "10B+",
              "Each user refreshes feed many times"
            ],
            [
              "Fanout per Post (median)",
              "100–1,000",
              "10–1,000",
            ...
            [
              ...
              "100 ms–1 s",
              "50–200 ms",
              "Pull-based fanout on read can be slower"
            ],
            [
              "Ranking Model Latency",
              "10–50 ms",
              "<10 ms",
              "ML scoring per candidate post"
            ],
            [
              "Cache Hit Rate for Feed",
              "80–95%",
              "95–99%",
              "Precomputed feeds cached in Redis/Memcached"
            ],
            [
              "Storage per User Feed",
              "1–10 KB",
              "10–100 KB",
              "Top N post IDs + metadata"
            ],
            [
              "Global Edge Cache Hit Rate",
              "60–80%",
              "80–90%",
              "CDN caches media; API caches metadata"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "50–200 ms",
              "Read precomputed feed from cache",
              "Healthy"
            ],
            [
              "2× Load",
              "200–500 ms",
              "Cache misses rise; DB reads increase",
              "Add feed cache replicas"
            ],
            [
              "5× Load",
              "500 ms–1 s",
              "Feed generation queues build",
              "Scale fanout workers and ranking"
            ],
            [
              "10× Load",
              "1–3 s",
              "Hot celebrities cause fanout storms",
              "Use pull model for mega-celebrities"
            ],
            [
              "Breaking News Spike",
              "Spike then cache",
              "Trending content preloaded",
              "Precompute popular feeds"
            ],
            [
              "Ranking Model Failure",
              "Fallback to chronological",
              "Simpler feed served quickly",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M–10M",
              "1B+",
              "Facebook: ~3B accounts"
            ],
            [
              "Posts Table Rows",
              "10M–100M",
              "100B+",
              "Includes all historical posts"
            ],
            [
              "Social Graph Edges",
              "10M–100M",
              "1T+",
              "Follows, friendships, subscriptions"
            ],
            [
              "Feed List Entries per User",
              "100–1,000",
              "1,000–10,000",
              "Only top N kept hot; rest cold"
            ],
            [
              "Post Metadata Size",
              "100 bytes–1 KB",
              "1–10 KB",
              "IDs, text, media refs, engagement counters"
            ],
            [
              "Media Object Size",
              "10 KB–10 MB",
              "Same",
              "Images compressed; videos much larger"
            ],
            [
              "Index Size (social graph)",
              "10–100 GB",
              "10–100 TB",
              "Graph databases or sharded relational"
            ],
            [
              "Write QPS (posts)",
              "10–100",
              "100K+",
              "Includes reactions and comments"
            ],
            [
              "Read QPS (feed + graph)",
              "1K–10K",
            ...
            [
              ...
              "10–30% active",
              "70–90% cold",
              "Old posts moved to cheaper storage"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–10 ms",
              "Hot user/post rows in cache",
              "Healthy"
            ],
            [
              "2× Load",
              "10–50 ms",
              "Some cache misses; DB reads",
              "Add cache capacity"
            ],
            [
              "5× Load",
              "50–200 ms",
              "Graph traversal queries slow",
              "Add graph cache (TAO)"
            ],
            [
              "10× Load",
              "200 ms–1 s",
              "DB hotspots on popular users",
              "Shard by user_id"
            ],
            [
              "Viral Post",
              "Read amplification",
              "Engagement counters spike",
              "Counter sharding or rate counting"
            ],
            [
              "Feed Backfill",
              "1–5 s",
              "Reconstruct feed from graph + posts",
              "Rare; cache miss path"
            ]
          ]
        }
      },
    ...
    "news-feed-fanout": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Followers per User (median)",
              "100–1,000",
              "500–2,000",
              "Median is low; celebrities are outliers"
            ],
            [
              "Followers per Celebrity",
              "1M–10M",
              "100M+",
              "Elon Musk: 180M+ followers on X"
            ],
            [
              "Fanout Latency (normal user)",
              "100 ms–1 s",
              "10–100 ms",
              `Push post ID to followers' feed lists`
            ],
            [
              "Fanout Latency (celebrity)",
              "Seconds–minutes",
              "Pull on read",
              "Twitter changed to pull for celebs"
            ],
            [
              "Fanout Messages/sec",
              "1K–10K",
              "1M+",
              "Kafka handles fanout events"
            ],
            [
              "Feed List Writes per Post",
              "100–1,000",
              "10M+ possible",
              "Determines push vs pull threshold"
            ],
            [
              "Batch Size for Fanout",
              "100–1,000 followers",
              "1,000–10,000",
            ...
            [
              "Pull Model Read Cost",
              "10–100 ms",
              "1–10 ms (cached)",
              `Fetch followers' recent posts on read`
            ],
            [
              "Hybrid Threshold",
              "1K–10K followers",
              "10K–100K followers",
              "Switch to pull above threshold"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Normal user)",
              "10–100 ms",
              `Push to all followers' lists`,
              "Healthy"
            ],
            [
              "2× Posting Rate",
              "100–500 ms",
              "Fanout queue backlog grows",
              "Add workers"
            ],
            [
              "5× Posting Rate",
            ...
            [
              "Follower Spike",
              "Fanout lag",
              "New followers receive backlog gradually",
              "Backfill jobs handle historical posts"
            ],
            [
              "Regional Outage",
              "Fanout paused/replayed",
              "Kafka retains events",
              "Replay fanout after recovery"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Most users (<1K followers)",
              "Push",
              "Low",
              "Very low",
              "Typical Facebook friends"
            ],
            [
              "Power users (1K–100K)",
              "Hybrid push/pull",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "100–1,000",
              "1,000–10,000",
              "Posts scored before final ranking"
            ],
            [
              "Final Feed Items",
              "10–20",
            ...
            [
              ...
              "10–50",
              "100–1,000+",
              "ML features: user, post, context, graph"
            ],
            [
              "Model Inference QPS",
              "1K–10K",
            ...
            [
              ...
              "10–100",
              "1,000+",
              "Continuous ranking experiments"
            ],
            [
              "Engagement Lift from Ranking",
              "5–20%",
              "20–50%",
              "ML ranking significantly improves engagement"
            ],
            [
              "Freshness Half-Life",
              "1–24 h",
              "Minutes–hours",
              "Recency is a strong signal"
            ],
            [
              "Re-ranking Frequency",
              "Every feed load",
              "Continuous background updates",
              "TikTok re-ranks in near real-time"
            ],
            [
              "Training Data Volume",
              "1M–100M events/day",
              "1B+ events/day",
              "Clicks, likes, dwell time, shares"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "50–100 ms",
              "Simple model; 100 candidates",
              "Healthy"
            ],
            [
              "2× Load",
              "100–200 ms",
              "CPU contention on scoring service",
              "Scale scoring replicas"
            ],
            [
              "5× Load",
              "200–500 ms",
              "Model batching queues grow",
              "Increase batch size or use GPU"
            ],
            [
              "10× Load",
              "500 ms–1 s",
              "Fallback to heuristic ranking",
              "ML timeout; use lightweight model"
            ],
            [
              "Candidate Flood",
              "Latency spike",
              "More posts than model can score",
              "Prune candidates first"
            ],
            [
              "Model Failure",
              "<50 ms fallback",
              "Chronological or popularity ranking",
              "Graceful degradation"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1K–10K",
              "10M+",
              "Twitter/X: hundreds of thousands feed QPS"
            ],
            [
              "Feed Write QPS (posts)",
              "10–100",
              "100K+",
            ...
            [
              ...
              "85–95%",
              "95–99.9%",
              "Hot feeds cached in memory"
            ],
            [
              "Feed Generation Latency (p99)",
              "200 ms–1 s",
              "50–100 ms",
              "Precomputed feeds lower latency"
            ],
            [
              "Global Regions",
              "1–3",
              "10–30+",
              "Multi-region active-active for latency"
            ],
            [
              "Fanout Workers",
              "10–100",
              "1,000–10,000",
              "Kafka consumers for fanout"
            ],
            [
              "Feed Shards",
              "10–100",
              "1,000+",
              "By user_id or geography"
            ],
            [
              "CDN Cache Hit Rate (media)",
              "70–85%",
              "85–95%",
              "Media served from edge"
            ],
            [
              "Database Read Replicas",
              "3–10",
              "100+",
              "Feed metadata reads scale horizontally"
            ],
            [
              "Cost per 1K Feed Reads",
              "$0.001–$0.01",
              "$0.0001–$0.001",
              "Cache-heavy architectures reduce cost"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "50–200 ms",
              "Cache serves most feeds",
              "Healthy"
            ],
            [
              "2× Load",
              "200–400 ms",
              "Cache misses increase; fanout queue grows",
              "Add cache replicas"
            ],
            [
              "5× Load",
              "400 ms–1 s",
              "Origin DB under pressure",
              "Scale DB replicas and fanout workers"
            ],
            [
              "10× Load",
              "1–2 s",
              "Feed service hotspots",
              "Shard feed lists by user_id"
            ],
            [
              "Viral Event",
              "Spike then recover",
              "Trending content cached globally",
              "Precompute + rate limit writes"
            ],
            [
              "Regional Failure",
              "Failover to other region",
              "Some staleness acceptable",
              "Multi-region feed replication"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Ranking cost",
              "Candidate pruning + batch inference",
              "Cost ↓",
              "Medium",
              "TikTok"
            ],
            ...
            [
              "Feed freshness",
              "Stream processing + partial updates",
              "Freshness ↑",
              "High",
              "LinkedIn feed"
            ]
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M–100M",
              "10B–100B+",
              "Google: hundreds of billions"
            ],
            [
              "Crawl Rate per Second",
              "100–1,000 pages/s",
              "100K+ pages/s",
            ...
            [
              ...
              "50–200 KB",
              "1–2 MB",
              "Modern pages heavy with JS/media"
            ],
            [
              "Crawl Queue Size",
              "1M–10M URLs",
              "1B+ URLs",
              "Frontier stores discovered URLs"
            ],
            [
              "Politeness Delay",
            ...
            [
              ...
              "30–60%",
              "60–80%",
              "Much of web is duplicate or near-duplicate"
            ],
            [
              "Crawl Freshness Half-Life",
              "Days–weeks",
              "Hours–days",
              "News sites crawled frequently"
            ],
            [
              "Robots.txt Check TTL",
              "1–24 h",
              "1 h",
            ...
            [
              "Indexable Pages Ratio",
              "30–70%",
              "10–30%",
              "Many crawled pages are low quality"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–3 s per page",
              "Politeness delay dominates",
              "Healthy"
            ],
            [
              "2× Target Load",
              "Some 429/503 responses",
              "Crawler throttles automatically",
              "Politeness kicks in"
            ],
            [
              "5× Target Load",
              "Higher error rates",
              "Site may block crawler",
              "Reduce rate per domain"
            ],
            [
              "Crawler Cluster Scale-out",
              "Throughput linearly increases",
              "More pages/sec",
              "Add crawler nodes"
            ],
            [
              "Frontier Saturation",
              "Queue growth",
              "Cannot keep up with discovery",
              "Scale storage and scheduling"
            ],
            [
              "Target Site Failure",
              "Retries with backoff",
              "Crawler moves to other domains",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M–10M URLs",
              "1B+ URLs",
              "Billion-URL frontier needs sharding"
            ],
            [
              "Enqueue Rate",
              "1K–10K URLs/s",
              "100K+ URLs/s",
              "Discovered links added continuously"
            ],
            [
              "Dequeue Rate",
              "1K–10K URLs/s",
              "100K+ URLs/s",
              "Matched by fetcher capacity"
            ],
            [
              "Priority Levels",
              "3–10",
              "10–100",
              "Page rank, freshness, site importance"
            ],
            [
              "Politeness Window per Host",
              "1–5 s",
              "0.5–1 s",
            ...
            [
              ...
              "100 MB–1 GB",
              "10–100 GB",
              "Bloom filter + on-disk set"
            ],
            [
              "Frontier Shards",
              "10–100",
              "1,000+",
              "By hostname hash or URL range"
            ],
            [
              "Retry Queue Size",
              "1–10% of frontier",
              "5–20%",
              "Transient failures re-enqueued"
            ],
            [
              "Recrawl Interval Range",
              "Hours–months",
              "Minutes–days",
              "High-priority pages recrawled often"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–5 ms per URL",
              "Priority queue healthy",
              "Healthy"
            ],
            [
              "2× Discovery Rate",
              "5–10 ms",
              "Enqueue backlog grows",
              "Scale frontier writers"
            ],
            [
              "5× Discovery Rate",
              "10–50 ms",
              "Frontier storage pressure",
              "Shard frontier by host"
            ],
            [
              "10× Discovery Rate",
              "50–200 ms",
              "Deduplication set saturated",
              "Add Bloom filter capacity"
            ],
            [
              "Hot Domain",
              "Politeness bottleneck",
              "URLs queued per host",
            ...
            [
              ...
              "Frontier bloat",
              "Old URLs accumulate",
              "Recrawl scheduling and cleanup"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Planet-scale crawler",
              "Custom distributed queue",
              "Multi-level Bloom + Bigtable",
              "ML priority",
              "Google crawler"
            ]
          ]
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1–5",
              "1",
              "Single connection common for politeness"
            ],
            [
            ...
            [
              "URL Deduplication Rate",
              "50–90%",
              "90–99%",
              "Most URLs seen before"
            ],
            [
              "Near-Duplicate Detection Rate",
              "30–60%",
              "60–80%",
              "SimHash / MinHash clustering"
            ],
            [
              "Bloom Filter Memory per 1B URLs",
              "1–2 GB",
              "500 MB–1 GB",
              "1% false positive at 10 bits/URL"
            ],
            [
            ...
            [
              "Content Fingerprinting Cost",
              "1–10 ms",
              "<1 ms",
              "Per page hash computation"
            ],
            [
              "Robots.txt Fetch Failure Rate",
              "<1%",
              "<0.1%",
              "Most sites serve robots.txt"
            ],
            [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Crawler Count",
              "Politeness bottleneck on small sites",
              "Throughput per host capped",
              "Scale by crawling more hosts"
            ],
            [
              "5× Crawler Count",
              "More hosts crawled in parallel",
              "Host diversity increases throughput",
              "Good horizontal scaling"
            ],
            [
              "Duplicate Flood",
              "<1 ms per URL",
              "Bloom filter rejects duplicates",
              "Memory-efficient dedup"
            ],
            [
              "Robots.txt Miss",
              "Extra fetch + delay",
              "Crawler falls back to conservative",
              "Cache robots.txt aggressively"
            ],
            [
              "Rate Limit Hit (429)",
              "Backoff 1 s → 5 s → 30 s",
              "Crawler respects site limits",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Hash set",
              "Low",
              "Corporate site indexing"
            ],
            [
              "Respectful web crawler",
              "Per-host delay + robots.txt",
              "Bloom filter",
              "Medium",
              "Search engine crawler"
            ],
            [
              "Aggressive focused crawler",
              "Adaptive rate",
              "Bloom + SimHash",
              "High",
    ...
    "crawler-scaling": [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Pages per Node per Second",
              "10–100",
              "100–1,000",
              "Depends on page complexity"
            ],
            [
              "Crawl Bandwidth per Node",
              "100 Mbps–1 Gbps",
              "1–10 Gbps",
              "Network-bound"
            ],
            [
              ...
              "10–100",
              "1,000+",
              "By host hash or geography"
            ],
            [
              "Storage per 1B Pages",
              "50–200 TB",
              "10–50 TB compressed",
              "Raw HTML + metadata"
            ],
            ...
            [
              ...
              "10–100 ms",
              "1–10 ms with session reuse",
              "TLS adds latency"
            ],
            [
              "Operational Cost per 1B Pages",
              "$10K–$100K",
              "$1K–$10K",
              "Efficiency improves at scale"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Normal throughput",
              "Fetcher utilization <50%",
              "Healthy"
            ],
            [
              "2× Fetcher Nodes",
              "Throughput ~2×",
              "Frontier and DNS scale too",
              "Good horizontal scaling"
            ],
            [
              "5× Fetcher Nodes",
              "Throughput ~4–5×",
              "Frontier may become bottleneck",
              "Scale frontier storage"
            ],
            [
              "10× Fetcher Nodes",
              "Throughput ~7–9×",
              "DNS and target sites bottleneck",
              "Distribute DNS, respect politeness"
            ],
            [
              "Storage Limit",
              "Crawl pauses",
            ...
            [
              "Target Site Saturation",
              "Rate limits trigger",
              "Throughput capped per host",
              "Host diversity essential"
            ]
          ]
        }
      },
    ...
    "video-overview": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Global Internet Bandwidth Share",
              "60–70%",
              "15% (Netflix alone at peak)",
              "Netflix ~15% of global downstream traffic"
            ],
            [
              "Concurrent Viewers",
              "10K–100K",
              "100M+",
              "YouTube: 1B+ hours watched daily"
            ],
            [
              "Video Catalog Size",
              "10K–1M videos",
            ...
            [
              ...
              "2–5 Mbps (HD)",
              "5–25 Mbps (4K)",
              "Adaptive bitrate selects per client"
            ],
            [
              "Storage per Hour of Video",
              "1–10 GB",
              "0.5–2 GB (compressed)",
              "Multiple resolutions/codecs multiply total"
            ],
            [
              "Transcoding Time per Hour",
              "2–10× real-time",
              "0.5–2× real-time",
              "Depends on codec and resolution ladder"
            ],
            [
              "CDN Cache Hit Rate",
              "80–90%",
            ...
            [
              "Rebuffering Rate Target",
              "<1%",
              "<0.5%",
              "Poor rebuffering causes churn"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Slight CDN warming",
              "Some origin fetches",
              "Origin bandwidth rises"
            ],
            [
              "5× Load",
              "Adaptive bitrate steps down",
              "Clients switch to lower resolution",
              "Maintains playback over quality"
            ],
            [
              "10× Load",
              "Rebuffering increases",
              "CDN hot spots; origin strain",
              "Add CDN capacity or pre-position content"
            ],
            [
              "Viral Video Spike",
              "Latency then smooth",
              "CDN absorbs surge",
              "Popular content cached quickly"
            ],
            [
              "Network Congestion",
              "Bitrate drops",
              "Player switches to lower bitrate",
              "ABR handles transient issues"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "2–10× real-time",
              "0.5–1× real-time",
              "Hardware encoders faster than software"
            ],
            [
              "Resolution Ladder",
              "3–5 versions",
            ...
            [
              ...
              "H.264",
              "H.264/HEVC/VP9/AV1",
              "AV1 ~50% smaller than H.264"
            ],
            [
              "Output Size vs Original",
              "10–50% of original",
              "5–20% with advanced codecs",
              "Per-title optimization reduces further"
            ],
            [
              "Transcoding Cost per Hour",
              "$1–$10",
              "$0.10–$1",
              "Spot instances and hardware encode lower cost"
            ],
            [
              "GPU Transcoding Throughput",
              "1–5× real-time",
              "10–50× real-time",
              "NVIDIA NVENC for H.264/HEVC"
            ],
            [
              "CPU Transcoding Throughput",
              "0.1–0.5× real-time",
              "0.5–2× real-time",
              "x264/x265 slower but higher quality"
            ],
            [
              "Thumbnails per Video",
              "1–10",
              "10–100",
              "Preview thumbnails, storyboards"
            ],
            [
            ...
            [
              ...
              "1–5",
              "10–50+",
              "Localized subtitles and captions"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "5× Upload Rate",
              "Latency 10–30× real-time",
              "Backlog; users wait longer",
              "Auto-scale farm"
            ],
            [
              "10× Upload Rate",
              "Hours delay",
              "Queue deep",
              "Use spot instances; prioritize popular uploads"
            ],
            [
              "Long Video Uploaded",
              "Proportional delay",
            ...
            [
              "Codec Failure",
              "Retry with fallback",
              "Some formats fail first attempt",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1–3 s",
              "<1 s",
              "First chunk fetch + player init"
            ],
            [
              "Live Latency (HLS/DASH)",
              "10–30 s",
              "3–10 s (low-latency)",
              "LL-HLS and CMAF reduce latency"
            ],
            [
              "Chunk Duration",
              "2–10 s",
              "2–4 s",
              "Shorter chunks = lower latency but more requests"
            ],
            [
              "Bitrate Ladder Steps",
              "4–6",
              "8–12",
              "Smoother ABR with more steps"
            ],
            [
              "Concurrent Bitrate Switches",
              "1–5 per minute",
              "5–20 per minute",
            ...
            [
              ...
              "50–100",
              "200–300+",
              "Cloudflare: 300+; Fastly: 100+"
            ],
            [
              "Peak Bandwidth per Video",
              "1–10 Gbps",
              "100+ Gbps",
              "Viral live events"
            ],
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "Origin fetches rise",
              "Slightly higher chunk latency",
              "CDN warming"
            ],
            [
              "5× Load",
              "Some bitrate drops",
              "Players adapt to maintain buffer",
              "Quality trade-off"
            ],
            [
              "10× Load",
              "Regional CDN hot spots",
              "Possible rebuffering",
              "Add CDN capacity or steering"
            ],
            [
              "Viral Video",
              "Cache miss storm then smooth",
              "CDN pulls from origin then fans out",
              "Origin must handle burst"
            ],
            [
              "Mobile Network Degradation",
              "Bitrate steps down",
              "Player preserves playback",
              "ABR working"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "<1 s",
              "SFU + edge",
              "Twitch, Live shopping"
            ],
            [
              "Premium DRM content",
              "CMAF + Widevine/PlayReady",
              "5–10 s",
              "Multi-CDN + token auth",
              "Disney+"
            ],
    ...
    "video-scaling": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Storage per Video (all formats)",
              "1–10 GB",
              "0.5–2 GB with advanced codecs",
              "Multiple resolutions multiply size"
            ],
            [
              "Total Storage",
              "100 TB–1 PB",
              "100+ PB",
              "YouTube: exabytes of storage"
            ],
            [
              "Daily Egress Bandwidth",
              "10–100 Gbps",
              "100+ Tbps",
              "Netflix peak ~600 Gbps per Open Connect appliance"
            ],
            [
              "Transcoding Farm Size",
              "10–100 workers",
              "10,000+ workers",
              "Auto-scaling GPU/CPU mix"
            ],
            [
              "CDN PoPs Used",
              "50–100",
              "200–1,000+",
              "Multi-CDN + ISP edge caches"
            ],
            [
              "Concurrent Streams",
              "10K–100K",
              "100M+",
              "Live events can spike rapidly"
            ],
            [
              "Upload QPS",
              "1–10/s",
              "1,000+/s",
              "UGC platforms see constant uploads"
            ],
            [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Adaptive bitrate steps down",
              "Maintains playback",
              "Scale delivery aggressively"
            ],
            [
              "10× Viewers",
              "Regional hot spots",
              "May need pre-positioning",
              "Major live event"
            ],
            [
              "Viral Upload Spike",
              "Transcoding queue grows",
              "Latency to publish increases",
              "Scale transcoding farm"
            ],
            [
              "Global Event",
              "Multi-region load",
              "Traffic shifts across continents",
              "Follow-the-sun + multi-CDN"
            ]
          ]
        }
      },
