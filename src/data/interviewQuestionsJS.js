...
curry(1)(2); // 3
              ...
              <li>
                <strong>What are web workers?</strong>
                <br>
                JavaScript that runs in the background, separate from the main thread, used for
              ...
              <li>
                <strong>Describe service workers and their use cases</strong>
                <br>
                Service workers run in the background, enabling features like push notifications,
                background sync, and offline caching using the Cache API.
              </li>

              <li>
                <strong>How does JavaScript handle asynchronous operations?</strong>
                <br>
                Through the event loop, using callbacks, promises, async/await, and microtask and
                macrotask queues.
              </li>
            </ol>`,
      difficulty: 'Advanced',
    ...
    },
    {
      ...
      answer: `<ol start="39">
              <li>
                ...
                <ul>
                  ...
                  <li>
                    ...
                    ,
                    <code>element.classList.add/remove</code>
                  </li>
                  <li>
                    Create elements:
              ...
              <li>
                ...
                Event flows from child to parent (bottom to top)
                <br>
                -
                <strong>Event Capturing:</strong>
                Event flows from parent to child (top to bottom)
                <br>
                - Use
                <code>addEventListener(event, handler, useCapture)</code>
                where
              ...
              <li>
                <strong>How do you handle cross-origin requests?</strong>
                <br>
                - Enable CORS on server using appropriate HTTP headers like:
                <pre ngnonbindable=""><code>
Access-Control-Allow-Origin: *
Access-Control-Allow-Methods: GET, POST, PUT, DELETE
      </code></pre>
                - Use JSONP (legacy), proxy servers, or server-side solutions to bypass browser
                restrictions.
              </li>
              ...
              <li>
                ...
                <ul>
                  ...
                  <li><strong>Canvas, Audio, Notifications, etc.</strong></li>
                </ul>
              </li>
            </ol>`,
      difficulty: 'Advanced',
