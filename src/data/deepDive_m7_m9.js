// Deep dives for modules 8, 9, 10 (shifted after REST insertion)
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10K–50K req/s",
              "100K–500K req/s",
              "Netflix Zuul handles ~50K req/s per instance"
            ],
            [
              "Latency (p50)",
              "1–5 ms",
              "< 1 ms",
              "Envoy at Lyft adds < 1 ms at p50"
            ],
            [
              "Latency (p99)",
              "20–50 ms",
              "5–20 ms",
              "Depends on auth and routing complexity"
            ],
            [
              "Concurrent Connections",
              "10K–50K",
              "100K+",
              "Kong Gateway tested to 100K+ conns"
            ],
            [
              "SSL Termination CPU",
              "10–20% overhead",
              "5–10% with hardware offloading",
              "AWS NLB offloads SSL at line rate"
            ],
            [
              "Cache Hit Rate",
              "60–80%",
              "85–95%",
              "With edge caching (Cloudflare)"
            ],
            [
            ...
            [
              ...
              "±1–5%",
              "±0.1% (distributed)",
              "Redis-based token bucket vs local counters"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "1–3 ms",
              "Stable, all features on",
              "Baseline healthy state"
            ],
            [
              "5x",
              "5–15 ms",
              "Slight queuing, connection pool active",
              "Thread pools saturate, need tuning"
            ],
            [
              "10x",
              "20–80 ms",
            ...
            [
              "20x",
              "100–500 ms",
              "Rate limiting kicks in, 429s rise",
              "Gateway protecting backend (intentional)"
            ],
            [
              "50x+",
              "Timeouts / 503s",
    ...
    "bff-pattern": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "BFFs per Client Type",
              "2–4",
              "10–20",
              "Netflix has BFFs for Web, iOS, Android, TV, each with variants"
            ],
            [
              "API Aggregation Calls",
              "3–7 per request",
              "10–30 per request",
              "Complex pages need many backend services"
            ],
            [
              "Payload Reduction",
              "30–50%",
              "60–80%",
              "BFF filters and shapes responses for specific client"
            ],
            [
              "Cache Hit Rate (BFF)",
              "40–60%",
              "70–85%",
              "Client-specific caching at BFF layer"
            ],
            [
              "Latency Saved vs Direct",
              "50–200 ms",
              "300–500 ms",
              "Fewer round trips, tailored payloads"
            ],
            [
              "BFF Deployment Frequency",
              "1–3/day",
              "10–50/day",
              "Independent deploys per client team"
            ],
            [
              "Team Ownership",
              "1 team",
              "1 team per BFF",
              "SoundCloud: separate teams per client platform"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "50–150 ms",
              "All backend calls parallel, cache warm",
              "Optimal BFF operation"
            ],
            [
              "3x",
              "150–400 ms",
              "Backend queues grow, some timeouts",
              "Need backend scaling or circuit breakers"
            ],
            [
              "5x",
              "300–800 ms",
              "Fallbacks activated, degraded responses",
              "BFF returns partial data gracefully"
            ],
            [
              "10x",
              "1–3 s",
              "Heavy caching, aggressive timeouts",
              "User experience degrades, but system stable"
            ],
            [
              "20x+",
              "Timeouts / 503s",
              "Bulkhead patterns isolate failures",
              "Non-critical features dropped entirely"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "✅ Tailored per client",
              "Bloated payloads, coupling"
            ],
            [
              "Rapid Client Iteration",
              "✅ Independent deploys",
              "Backend blocks frontend releases"
            ],
            [
              "Small Team (< 10 devs)",
              "Overhead",
            ...
            [
              ...
              "Client handles orchestration (bad)"
            ],
            [
              "Strict Latency Requirements",
              "✅ Parallel aggregation",
              "Sequential client calls add latency"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "2–3",
              "5–10",
              "Stripe supports 100+ historical versions but 3 active"
            ],
            [
              "Version Lifetime",
              "12–24 months",
              "6–12 months (agile)",
              "GitHub: 12-month deprecation notice"
            ],
            [
              "Traffic on Old Versions",
              "10–30%",
              "< 5%",
              "Goal is to drive migration to current"
            ],
            [
              "Breaking Changes per Year",
              "1–2",
              "5–10 (fast iteration)",
              "Internal APIs change faster than public"
            ],
            [
              "Migration Time (clients)",
              "3–6 months",
              "1–2 years",
              "Enterprise clients move slowly"
            ],
            [
              "Version Header Size",
              "10–20 bytes",
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "No added latency",
              "Version routing at edge",
              "Negligible overhead"
            ],
            [
              "5x",
              "+0.1–0.5 ms",
              "Header parsing, route matching",
              "Still negligible"
            ],
            [
              "10x",
              "+0.5–1 ms",
              "Version-specific caching layers",
              "Cache segmentation complexity"
            ],
            [
              "20x",
              "+1–2 ms",
              "Versioned rate limits apply",
              "Per-version quotas protect backends"
            ],
            [
              "50x+",
              "Stable (if designed well)",
              "Old versions may throttle more",
              "Intentional pressure to migrate"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Proliferates endpoints, caching issues",
              "Twitter API"
            ],
            [
              "Header",
              "RESTful purity",
              "Harder to debug, browser unfriendly",
              "GitHub API"
            ],
            [
              "Date-Based (Stripe)",
              "Rapid iteration, enterprise clients",
            ...
            [
              ...
              "Microservices, fast teams",
              "Needs Pact or similar tooling",
              "Spotify"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "100–1000 req/min",
              "10K–100K req/min",
              "GitHub: 5K/hour for unauthenticated"
            ],
            [
              "Burst Allowance",
              "2x–5x sustained rate",
              "10x+ with token bucket",
              "Slack allows bursts up to 10x"
            ],
            [
              "Rate Limit Latency",
              "< 1 ms (local)",
              "1–5 ms (distributed Redis)",
              "Redis single-node: < 1ms"
            ],
            [
              "Accuracy (local)",
              "100%",
            ...
            [
              ...
              "< 1%",
              "5–10% during attacks",
              "DDoS: 100% blocked at edge"
            ],
            [
              "Redis Memory per Key",
              "~100 bytes",
              "~100 bytes",
              "Minimal, millions of keys feasible"
            ],
            [
              "Penalty Window",
              "1–15 minutes",
              "1–24 hours",
              "AWS: exponential backoff on 429s"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "< 1 ms",
              "All requests pass, counters increment",
              "Baseline"
            ],
            [
              "3x",
              "< 1 ms (allowed), instant 429s",
              "Token bucket drains",
              "Burst capacity consumed"
            ],
            [
              "5x",
              "Instant 429s (majority)",
              "Queue or reject, depends on config",
            ...
            [
              ...
              "Backend protected, clients throttled"
            ],
            [
              "100x (Attack)",
              "Blocked at edge",
              "WAF + DDoS protection",
              "Cloudflare blocks before app layer"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Redis Cell / Sliding Log",
              "✅ Highest",
              "Fair",
              "✅ Yes",
              "High-accuracy distributed (Stripe)"
            ],
            [
              "Adaptive / ML",
              "Variable",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "80–90%",
              "95–99%",
              "Static assets: 99%, APIs: 60–80%"
            ],
            [
              "Edge Locations",
              "100–200",
              "250–400",
              "Cloudflare: 300+, Akamai: 4,000+ (incl. ISP)"
            ],
            [
              "TTFB Reduction",
              "50–200 ms",
            ...
            [
              ...
              "50–70%",
              "80–90%",
              "Origin offload for static content"
            ],
            [
              "Edge Compute Latency",
              "1–10 ms",
              "< 1 ms",
              "Cloudflare Workers: cold start < 1ms"
            ],
            [
              "Cache Invalidation Time",
              "30 s–5 min",
              "Instant (Fastly surrogate keys)",
              "Fastly: instant purge via API"
            ],
            [
              "SSL Termination at Edge",
              "0 ms (hardware)",
              "0 ms",
              "Dedicated TLS hardware at POPs"
            ],
            [
              "DDoS Mitigation Capacity",
              "10–100 Tbps",
              "100+ Tbps",
              "Cloudflare: 192 Tbps network capacity"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "10–50 ms (edge)",
              "Cache serves 80%+ traffic",
              "Optimal state"
            ],
            [
              "10x (Viral)",
              "10–50 ms (edge)",
              "Origin sees only cache misses",
              "CDN absorbs viral spike"
            ],
            [
              "100x (DDoS)",
              "10–50 ms (legit), blocked (attack)",
              "WAF rules, CAPTCHA challenges",
              "Malicious traffic filtered at edge"
            ],
            [
              "Origin Down",
              "Serves stale (if configured)",
            ...
            [
              ...
              "Origin spikes",
              "Thundering herd",
              "Need staggered TTL or origin shield"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–20",
              "50–200",
              "Netflix: 100+ subgraphs"
            ],
            [
              "Query Depth",
              "2–4 levels",
              "5–10 levels",
              "Deeper = more composition complexity"
            ],
            [
              "Query Latency (p99)",
              "100–300 ms",
              "500 ms–2 s",
              "Depends on subgraph fan-out"
            ],
            [
              "Subgraph Calls per Query",
              "2–5",
              "10–50",
              "Complex pages hit many services"
            ],
            [
              "Schema Composition Time",
              "< 1 s",
              "5–30 s",
              "At 100+ subgraphs, CI slows"
            ],
            [
              "Federation Gateway CPU",
              "1–2x REST gateway",
              "2–5x",
            ...
            [
              ...
              "30–50%",
              "60–70%",
              "@cacheControl directives needed"
            ],
            [
              "N+1 Detection",
              "Manual",
              "Automated (Apollo)",
              "DataLoader pattern essential"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Simple Query)",
              "50–100 ms",
              "1–2 subgraphs queried",
              "Baseline"
            ],
            [
              "3x (Complex Query)",
              "200–500 ms",
              "5–10 subgraphs, parallel fetch",
              "Query planner optimizes parallelism"
            ],
            [
              "5x (Deep Query)",
              "500 ms–2 s",
              "Depth 5+, serial dependencies",
              "Consider @defer and @stream"
            ],
            [
              "10x (Malicious Query)",
              "Timeout / 400",
            ...
            [
              "20x+ (Subgraph Down)",
              "Degraded / Error",
              "Partial responses with errors",
              "Federation resilience kicks in"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–5%",
              "0.1–1%",
              "Google: 1% to start, internal first"
            ],
            [
              "Canary Duration",
              "15–60 minutes",
              "1–24 hours",
              "Netflix: hours to days for critical services"
            ],
            [
            ...
            [
              ...
              "1.5x baseline",
              "1.2x baseline",
              "Stricter for user-facing APIs"
            ],
            [
              "Rollback Time",
              "30 s–2 min",
              "10–30 s",
              "Kubernetes: pod termination + startup"
            ],
            [
              "Canary Instance Count",
              "1–2",
              "5–10",
              "AWS CodeDeploy default: 1 canary"
            ],
            [
              "Traffic Shift Steps",
              "2–3",
            ...
            [
              ...
              "1–2",
              "0 (fully automated)",
              "Spotify: automated canary analysis"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1% Canary",
              "Baseline",
              "New version handles tiny slice",
              "Sentry error tracking watches"
            ],
            [
              "5% Canary",
              "±5% variance",
              "Enough traffic to detect issues",
              "Metrics comparison starts"
            ],
            [
              "25% Canary",
              "±10% variance",
              "Moderate confidence",
              "If issues, 25% of users affected"
            ],
            [
              "50% Canary",
              "Should match baseline",
              "A/B comparison valid",
            ...
            [
              ...
              "Monitoring continues for hours"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "✅ Yes",
              "✅ Yes",
              "Yes (if health checks pass)"
            ],
            [
              "Database Changes",
              "Tricky (both versions)",
              "Tricky (both versions)",
              "✅ Simpler (one version)"
            ]
          ]
    ...
    "blue-green": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Resource Overhead",
              "2x (duplicate environment)",
              "2x",
              "Always running two identical stacks"
            ],
            [
              "Switchover Time",
              "1–30 s",
            ...
            [
              ...
              "1–30 s",
              "< 1 s",
              "Instant: route back to blue"
            ],
            [
              "Pre-Deploy Testing",
              "Smoke tests: 1–5 min",
              "Full suite: 10–30 min",
              "Run against green before switch"
            ],
            [
              "Session Persistence",
              "Requires shared store",
              "Sticky sessions broken",
              "Redis/session DB needed"
            ],
            [
              "Cost Impact",
              "2x compute",
              "2x compute",
              "Can scale down blue after warmup"
            ],
            [
              "Database Compatibility",
              "Both versions must work",
              "Both versions must work",
              "Schema changes need expand/contract"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Synthetic traffic pre-warms caches"
            ],
            [
              "Switch Moment",
              "1–5 ms blip",
              "DNS or LB flips",
              "Connection drain on blue"
            ],
            [
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Session-Heavy Apps",
              "✅ Works with shared store",
              "Session split issues",
              "✅ Works"
            ],
            [
    ...
    "feature-flags": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Flags per Application",
              "10–50",
              "500–1000+",
              "Etsy: 1000+ flags across services"
            ],
            [
              "Flag Evaluation Latency",
              "< 1 ms (local)",
              "1–5 ms (remote)",
              "In-memory: negligible, SDK: < 1ms"
            ],
            [
              "Remote Flag Fetch Interval",
              "30–60 s",
              "5–30 s",
              "SSE (server-sent events) for instant"
            ],
            [
              "Flag Targeting Rules",
              "1–5",
              "50–100+",
              "User segments, geo, device, custom attrs"
            ],
            [
              "Stale Flag Cleanup",
              "6–12 months",
              "3–6 months",
              "Technical debt: remove old flags"
            ],
            [
              "A/B Test Duration",
              "1–2 weeks",
            ...
            [
              ...
              "5–30 s",
              "< 1 s (SSE)",
              "LaunchDarkly: real-time streaming"
            ],
            [
              "SDK Memory Overhead",
              "1–5 MB",
              "10–20 MB",
              "Depends on flag set size"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "< 1 ms",
              "Local evaluation, no remote call",
              "SDK cached all flags"
            ],
            [
              "Flag Update Storm",
              "Flags update in < 1s",
              "SSE pushes to all clients",
              "Rare, but handles gracefully"
            ],
            [
              "SDK Initialization",
              "100–500 ms",
              "1–2 s (large flag sets)",
              "First fetch from LaunchDarkly"
            ],
            [
              "Fallback Mode (LD down)",
              "< 1 ms",
              "Default values returned",
              "SDK must have local defaults"
            ],
            [
    ...
    observability: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1–5%",
              "0.01–1%",
              "Google: 0.1% for high-traffic, 100% for errors"
            ],
            [
              "APM Agent Overhead",
              "1–3% CPU",
            ...
            [
              ...
              "30 min–2 hours",
              "10–30 minutes",
              "Runbooks and automation help"
            ],
            [
              "Dashboard Load Time",
              "2–5 s",
              "< 1 s",
              "Pre-aggregated metrics vs raw logs"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "Normal Operations",
              "Baseline",
              "Steady ingestion, clean dashboards",
              "Optimal"
            ],
            [
              "2x Traffic Spike",
              "+20–50% lag",
              "Log buffers grow, some drop",
              "Need backpressure handling"
            ],
            [
              "10x Traffic Spike",
              "Significant lag",
              "Sampling kicks in aggressively",
              "Protect observability pipeline"
            ],
            [
              "Incident Investigation",
              "High query load",
              "Ad-hoc queries spike",
              "Separate read replicas for querying"
            ],
            [
              "Log Flood (Bug)",
              "Pipeline saturation",
              "Drop or sample oldest",
              "Circuit breaker on log volume"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          headers: [
            "Need",
            "Open Source (Prometheus/ELK)",
            "SaaS (Datadog/New Relic)",
            "Enterprise (Splunk/Dynatrace)"
          ],
          rows: [
            [
              "Cost",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "5–10 s",
              "2–5 s",
              "Faster for user-facing services"
            ],
            [
              "Startup Probe Timeout",
              "30–60 s",
              "1–3 min",
              "Slow-starting Java apps"
            ],
            [
            ...
            [
              "Recovery Time (pod restart)",
              "15–60 s",
              "1–3 min",
              "Image pull + startup"
            ],
            [
              "Deep Health Check Latency",
              "50–500 ms",
              "1–2 s",
              "DB + cache checks included"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "10–100 ms",
              "Liveness may fail",
              "K8s restarts pod (intended)"
            ],
            [
              "DB Connection Pool Exhausted",
              "Readiness fails",
              "Traffic stops routing",
              "Protects DB from more load"
            ],
            [
              "Memory Pressure",
              "OOMKill",
            ...
            [
              "Network Partition",
              "Timeout",
              "Both probes may fail",
              "Depends on which side of partition"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–2/week",
              "5–10/day",
              "Netflix: thousands of experiments/day"
            ],
            [
              "Blast Radius",
              "1–5% of traffic",
            ...
            [
              ...
              "5–30 minutes",
              "1–4 hours",
              "Longer for soak tests"
            ],
            [
              "MTTD During Experiment",
              "1–5 minutes",
              "10–30 seconds",
            ...
            [
              "Abort Rate (failed exps)",
              "10–20%",
              "5–10%",
              "High abort = immature resilience"
            ],
            [
              "Auto-Abort Latency",
              "30 s–2 min",
              "5–30 s",
              "Gremlin: automatic safety aborts"
            ],
            [
              "Cost of Downtime Prevented",
              "Hard to quantify",
              "$Millions/year",
              "Netflix credits Chaos Engineering for availability"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Cache warm-up, connection pool refill"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1K–10K events/s",
              "50K–100K events/s",
              "Kafka partition limit: ~10MB/s"
            ],
            [
              "End-to-End Latency",
              "100 ms–1 s",
              "10–100 ms",
              "Flink: < 100ms for complex windows"
            ],
            [
              "Window Size",
              "1–5 minutes",
              "1–24 hours",
              "Join windows: longer = more state"
            ],
            [
              "State Size (per job)",
              "100 MB–10 GB",
            ...
            [
              ...
              "1–5 min",
              "10–30 s",
              "Incremental checkpoints help"
            ],
            [
              "Parallelism",
              "5–20",
              "100–500",
              "LinkedIn: 1000+ parallelism for some jobs"
            ],
            [
              "Consumer Lag Threshold",
              "1K–10K messages",
              "100K+ messages",
              "Alert if lag grows beyond SLA"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "Sub-second",
              "Lag stable, checkpoints on time",
              "Healthy"
            ],
            [
              "3x Spike",
              ...
              "Flink slows upstream producers"
            ],
            [
              "5x Spike",
              "Minutes lag",
              "Autoscaler adds tasks (if configured)",
              "Kinesis auto-scales shards"
            ],
            [
              "10x Spike",
              "Significant lag",
              "May need partition expansion",
              "Kafka: add partitions (complex)"
            ],
            [
              "Sustained 10x",
              "Persistent lag",
              "Scale out or sample/drop",
              "Business decision: tolerate lag or drop?"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–100 ms",
              "1–10 ms",
              "Debezium: ~10ms for MySQL binlog"
            ],
            [
              "Throughput",
              "1K–10K events/s",
              "50K–100K events/s",
              "Depends on DB write rate"
            ],
            [
              "Binlog/ WAL Retention",
              "24–48 hours",
              "7+ days",
              "Longer = more recovery buffer"
            ],
            [
              "Schema Change Handling",
              "Manual",
              "Automated (Schema Registry)",
              "Debezium + Avro + Registry"
            ],
            [
              "Snapshot Time (initial)",
              "Minutes–hours",
              "Hours–days",
              "Large tables: parallel snapshot"
            ],
            [
              "Memory Overhead (DB)",
              "1–5%",
              "5–10%",
              "Binlog parsing adds load"
            ],
            [
              "Duplicate Events",
              "Rare",
              "Handled by idempotent consumers",
              "At-least-once delivery"
            ],
            [
              "Lag on Schema Change",
              "1–5 min",
              "Seconds (if automated)",
              "Pipeline pause for DDL parsing"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "3x Write Spike",
              "Lag grows to 1–5s",
              "Connector buffers events",
              "Temporary, recovers"
            ],
            [
              "Bulk Load (ETL)",
              "Minutes–hours lag",
              "Massive binlog generation",
              "Consider disabling CDC or snapshot"
            ],
            [
              "Schema Change (ALTER)",
              "1–5 min pause",
              "Parser must adapt",
              "Automated with Schema Registry"
            ],
            [
              "Connector Failure",
              "Lag grows until restart",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–20%",
              "10–30%",
              "Idempotent writes + transaction coordination"
            ],
            [
              "Throughput Penalty",
              "10–20%",
              "20–40%",
              "Two-phase commit or idempotent dedup"
            ],
            [
              "Checkpoint Interval",
              "30 s–5 min",
              "1–10 min",
              "Flink: shorter = faster recovery, more overhead"
            ],
            [
              "Deduplication Window",
              "1–7 days",
              "7–30 days",
              "Kafka transactional.id timeout: 7 days default"
            ],
            [
              "State Size (for dedup)",
              "10–100 MB",
              "1–10 GB",
              "Bloom filters or idempotent stores"
            ],
            [
              "Transaction Timeout",
              "10–15 min",
            ...
            [
              ...
              "100 ms–1 s",
              "10–100 ms",
              "Flink: < 100ms possible with exactly-once"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "3x",
              "+10–20% latency",
              "Transaction coordinator busy",
              "May need more coordinator resources"
            ],
            [
              "5x",
              "+20–40% latency",
              "More aborts and retries",
              "Contention on transactional IDs"
            ],
            [
              "10x",
              "Significant degradation",
              "Consider at-least-once + idempotent",
              "Exactly-once becomes bottleneck"
            ],
            [
              "Network Partition",
              "Transactions stall",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "10–50 nodes",
              "100–1000+ nodes",
              "AWS EMR, Databricks auto-scale"
            ],
            [
              "Shuffle Data",
              "10–50% of input",
              "100%+",
              "Network-heavy, impacts performance"
            ],
            [
              "Failed Task Retry Rate",
              "1–5%",
              "10–20% (spot instances)",
              "Preemptible VMs save cost"
            ],
            [
              "Checkpoint/Stage Count",
              "10–50",
              "100–500",
              "More stages = more scheduling overhead"
            ],
            [
              "Cost per TB Processed",
              "$1–$10",
              "$0.10–$1",
              "Spot instances, auto-termination"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Normal)",
              "Baseline",
              "All tasks fit in memory",
              "Optimal"
            ],
            [
              "2x Data",
              "2–3x time",
              "Spill to disk starts",
              "Spark: MEMORY_AND_DISK"
            ],
            [
              "5x Data",
              "5–10x time",
              "Heavy shuffle, GC pressure",
              "Need partitioning tuning"
            ],
            [
              "10x Data",
              "10–20x time",
              "OOM errors possible",
              "Increase executor memory or nodes"
            ],
            [
              "100x Data",
              "Requires re-architecture",
              "Consider streaming or incremental",
              "Daily batch → hourly or micro-batch"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Hours",
              "Minutes (Spark)",
              "Nightly recompute of full dataset"
            ],
            [
              "Speed Layer Latency",
              "Seconds–minutes",
              "Sub-second (Storm/Flink)",
              "Real-time view of recent data"
            ],
            [
              "Data Duplication",
              "2x (batch + speed)",
            ...
            [
              "Code Duplication",
              "50–100%",
              "30–50% (if shared libs)",
              "Batch and speed logic differ"
            ],
            [
              "Recomputation Frequency",
              "Daily",
              "Hourly",
              "Batch view refreshed on schedule"
            ],
            [
              "Query Complexity",
              "High (merge batch + speed)",
              "Moderate (with abstractions)",
              "Application merges two views"
            ],
            [
              "Storage Overhead",
              "2x",
              "2x",
              "HDFS + real-time store"
            ],
            [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Seconds–minutes lag",
              "Speed layer absorbs",
              "Recent data slightly delayed"
            ],
            [
              "Batch Delay",
              "Batch view stale",
              "Speed layer serves more",
              "Merge ratio shifts"
            ],
            [
              "Recompute Failure",
              "Batch view outdated",
              "Speed layer continues",
              "Serving layer may be inconsistent"
            ],
            [
              "Speed Layer Failure",
              "Real-time view gaps",
              "Batch view still valid (older)",
              "Eventual consistency extended"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "Stream Retention",
              "7–30 days",
              "Months–years (Tiered Storage)",
              "Kafka 3.0: infinite retention with tiered storage"
            ],
            [
              "Replay Throughput",
              "10–100 MB/s",
              "1 GB/s+",
              "Limited by consumer count and disk"
            ],
            [
              "Processing Latency",
              "10 ms–1 s",
              "1–10 ms",
              "Flink: sub-100ms possible"
            ],
            [
              "Reprocessing Time",
              "Hours (full replay)",
              "Minutes–hours",
              "Same code, just rewind offset"
            ],
            [
              "Storage Cost (stream)",
              "$0.02/GB (S3 tiered)",
              "$0.004/GB (cold)",
              "Kafka Tiered Storage to S3"
            ],
            [
              "Code Duplication",
              "0%",
            ...
            [
              ...
              "Medium",
              "Moderate–High",
              "One system, but streaming is complex"
            ],
            [
              "Event Ordering",
              "Per-partition",
              "Per-partition",
              "Global ordering requires single partition"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Brief pause",
              "Rebalance",
              "Kafka: consumers reassign"
            ],
            [
              "Schema Evolution",
              "Processing pause",
              "Old + new schema consumers",
