// Deep dives for modules 0, 11-15 (shifted after REST insertion)

export const deepDive_m21_m14 = {
  module21: {
    "what-is-system-design-interview": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "45–60 min",
              "60–90 min (staff+)",
              "Top companies allocate 60 min for design + 30 min for coding/behavioral"
            ],
            [
              "Requirements Clarification",
              "5–10 min",
              "5–10 min",
              "Should consume ~10% of total time"
            ],
            [
              "High-Level Design Time",
              "10–15 min",
              "15–20 min",
              "Must produce a clear block diagram"
            ],
            [
              "Deep Dive & Trade-offs",
              "15–25 min",
              "25–35 min",
              "Most important scoring area"
            ],
            [
              "Final Scaling & Failure Modes",
              "10–15 min",
              "10–15 min",
              "Demonstrates production awareness"
            ],
            [
              "Estimated System Scale Discussed",
              "10K–1M users",
              "10M–100M users",
              "Should cover 1–2 orders of magnitude beyond current requirement"
            ],
            [
              "Latency SLOs Mentioned",
              "p95/p99",
              "p99.9",
              "State concrete targets: e.g., p99 < 200 ms"
            ],
            [
              "Acceptable Designs Given",
              "1 solid design",
              "2+ alternatives",
              "Senior candidates compare 2–3 approaches"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Smooth 1-question flow",
              "Clear diagram, concrete numbers, good trade-offs",
              "Strong pass"
            ],
            [
              "2× Load",
              "Rushed but complete",
              "Covers core design; trade-offs shallow",
              "Marginal pass with feedback"
            ],
            [
              "5× Load",
              "Rambling",
              "Misses data sizing, ignores failure modes",
              "Likely no-hire"
            ],
            [
              "10× Load",
              "Question drifts",
              "Can not converge on a design",
              "Reject"
            ],
            [
              "Interviewer Hints",
              "Should recover",
              "Adjusts course based on feedback",
              "Strong signal"
            ]
          ]
        }
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Read-heavy product (feed, search)",
              "Caching, read replicas, CDN",
              "API design, sharding",
              "Over-engineering writes"
            ],
            [
              "Write-heavy product (logging, IoT)",
              "Message queues, partitioning, sharding",
              "Batching, retention, cost",
              "Complex joins"
            ],
            [
              "Real-time product (chat, game)",
              "WebSockets, presence, fan-out",
              "Delivery semantics, retries",
              "Polling-heavy design"
            ],
            [
              "Financial / payments product",
              "ACID, idempotency, audit logs",
              "Consistency model, retries",
              "Eventual consistency for core transactions"
            ],
            [
              "Global multi-region product",
              "Data locality, replication, conflict resolution",
              "Latency, compliance, failover",
              "Ignoring cross-region latency"
            ],
            [
              "AI / LLM product",
              "Latency, token budget, rate limiting, caching",
              "Routing, fallback, cost",
              "Ignoring model capacity limits"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "API endpoints, supported actions",
              "N/A — binary yes/no"
            ],
            [
              "Availability",
              "System is up 99.9% of the year",
              "Uptime percentage",
              "99.9% = 8.77 h downtime/year"
            ],
            [
              "Latency",
            ...
            [
              ...
              "11 nines (0.0000001% annual)"
            ],
            [
              "Scalability",
              "Support 10× growth",
              "User or data growth factor",
              "10M → 100M users"
            ],
            [
              "Consistency",
              "All users see the same order",
              "Consistency model",
              "Strong, eventual, or causal"
            ],
            [
              "Security",
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "p95 +10–20%",
              "Latency SLO still met",
              "Good design"
            ],
            [
              "5× Load",
              "p95 +50–100%",
              "Some NFRs borderline",
              "Need tuning"
            ],
            [
              "10× Load",
              "p95 > 2× SLO",
              "NFRs violated; degrade gracefully",
              "Scale or redesign required"
            ],
            [
              ">10× Load",
              "Timeouts or errors",
              "Availability SLO at risk",
              "Urgent mitigation"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Throughput, cost",
              "Latency (seconds OK)",
              "Batch computation over fast queries"
            ],
            [
              "Gaming / real-time",
              "Latency, throughput",
              "Strong consistency relaxed",
              "Sub-100 ms matters more than perfect state"
            ],
            [
              "AI chatbot",
              "Latency, cost",
              "Approximate answers",
              "Users want fast responses; tokens are expensive"
            ]
          ]
        }
      }
    ...
    "back-of-the-envelope-estimation": [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "User-generated content per day",
              "100 B–1 KB",
              "10 KB (rich post)",
              "Text vs image metadata"
            ],
            [
              "Daily active users (DAU) to MAU ratio",
              "20–50%",
              "60–70% (addictive apps)",
              "Used to estimate peak traffic"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Storage-heavy product",
              "Storage per user/day",
              "Read/write ratio, bandwidth",
              "Storage usually dictates architecture"
            ],
            [
              "Read-heavy product",
              "Read QPS, cache hit rate",
              "DB read replicas, CDN",
              "Cache design dominates"
            ],
            [
              "Write-heavy product",
              "Write throughput, message rate",
              "Sharding, queue partitioning",
              "Write path must not bottleneck"
            ],
            [
              "Real-time product",
              "Latency budget",
              "Per-hop latency, concurrency",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "3–5 functional, 3–5 non-functional requirements"
            ],
            [
              "S2: Sketch",
              "10–15 min",
              "High-level block diagram",
              "4–8 components, data flow arrows"
            ],
            [
              "S3: Scale",
              "15–25 min",
              "Deep dive on bottleneck",
              "Throughput, latency, storage estimates"
            ],
            [
              "S4: Solidify",
              "5–10 min",
              "Failure modes, monitoring, future evolution",
              "3–5 failure scenarios, 2–3 monitoring signals"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "Slightly compressed",
              "Skip some depth in S3 or S4",
              "Still good with focus"
            ],
            [
              "5× Load",
              "Rushed",
              "Jump to S3 without clear S2",
              "Needs structure"
            ],
            [
              "10× Load",
              "Lost",
              "No clear diagram, no estimates",
              "No framework; likely reject"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Large data volume",
              "S3 Scale (storage, sharding)",
              "S2 detail",
              "Bottleneck is data"
            ],
            [
              "Low latency required",
              "S3 Scale (latency budget)",
              "S4 breadth",
              "Prove latency is achievable"
            ],
            [
            ...
            [
              "Well-known problem (e.g., URL shortener)",
              "S3 Scale + S4 failure modes",
              "S2 sketch",
              "Interviewer expects depth, not basics"
            ],
            [
              "AI/LLM product",
              "S3 Scale (cost + tokens)",
              "S2 generic services",
              "Token economics dominate"
            ],
            [
              "Global/multi-region",
              "S3 Scale + S4 solidify",
              "S1 basic features",
              "Data locality and DR matter"
            ]
          ]
        }
      }
    ...
    "common-interview-mistakes": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Jumping to design before requirements",
              "S1 Scope: fail",
              "Very common",
              "Ask 3–5 clarifying questions first"
            ],
            [
              "No numbers or estimates",
              "S3 Scale: weak",
              "Very common",
              "Provide RPS, storage, latency, cost estimates"
            ],
            [
              "Single point of failure",
              "S4 Solidify: weak",
              "Common",
              "Mention redundancy, failover, replication"
            ],
            [
              "Ignoring database scaling",
              "S3 Scale: fail",
              "Common",
              "Discuss read replicas, sharding, indexing"
            ],
            [
            ...
            [
              "Not stating trade-offs",
              "S3 Scale: weak",
              "Very common",
              "Always say “Pros: X, Cons: Y”"
            ],
            [
              "No failure mode discussion",
              "S4 Solidify: fail",
              "Common",
              "List 2–3 failure scenarios and recovery"
            ],
            [
              "Ignoring monitoring",
              "S4 Solidify: weak",
              "Common",
              "Mention metrics, logs, alerts, SLOs"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Confident answers",
              "Clear rationale, numbers, alternatives",
              "Strong"
            ],
            [
              "2× Load",
              "Slight hesitation",
              "Still answers but less structured",
              "Acceptable"
            ],
            [
              "5× Load",
              "Defensive or vague",
              "Avoids numbers, says “it depends” too much",
              "Concerning"
            ],
            [
              "10× Load",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Shows lack of rigor",
              "Ask 3 questions before designing"
            ],
            [
              "Mid",
              "No numbers or scaling",
              "Suggests no production sense",
              "Estimate RPS, storage, latency"
            ],
            [
              "Senior",
              "No trade-offs or failure modes",
              "Fails to demonstrate depth",
              "Compare 2 approaches, list 3 failures"
            ],
            [
              "Staff+",
              "No multi-region or cost thinking",
              "Misses organizational impact",
              "Discuss regions, DR, and cost"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–1,000 req/s",
              "10K–100K req/s",
              "Cloudflare AI Gateway handles millions of cached req/day"
            ],
            [
              "Tokens per Second (per model)",
              "100–5,000 tok/s",
              "10K–50K tok/s",
              "GPT-4: ~5K tok/s; GPT-4o: ~20K+ tok/s"
            ],
            [
              "First Token Latency (TTFT)",
              "100 ms–1 s",
              "50–200 ms",
              "Streaming hides full generation latency"
            ],
            [
              "Inter-Token Latency",
              "10–100 ms",
              "1–10 ms",
              "Smaller models + batching reduce time between tokens"
            ],
            [
              "Cost per 1M Tokens",
              "$0.50–$30",
            ...
            [
              ...
              "10–30%",
              "40–60%",
              "Semantic caching can cut costs by 30–50%"
            ],
            [
              "Rate Limit per API Key",
              "100–10K req/min",
              "100K+ req/min",
              "Enterprise agreements increase limits"
            ],
            [
              "Fallback Detection Time",
              "1–5 s",
              "100 ms–1 s",
              "Health checks + p99 latency monitors trigger fallback"
            ],
            [
              "Prompt Injection Scan Latency",
              "1–10 ms",
              "< 1 ms",
              "Regex/heuristic at edge; LLM-based scan: 100 ms+"
            ],
            [
              "Cost Attribution Granularity",
              "Per request",
              "Per token / per user",
              "Tag every call with user_id, feature, model for chargeback"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Normal TTFT",
              "All requests routed to primary provider",
              "Healthy; token budget tracked per key"
            ],
            [
              "2× Load",
              "TTFT + 20–50%",
              "Rate limits begin to throttle; retries increase",
              "Need retry budget and fallback model"
            ],
            [
              "5× Load",
              "TTFT + 50–200%",
              "Provider quotas hit; queue builds",
              "Circuit breaker to fallback provider essential"
            ],
            [
              "10× Load",
              "10 s+ or 429s",
              "Primary provider rejects traffic",
              "Gateway must shed load to alternate region/model"
            ],
            [
              "Burst (viral feature)",
              "Timeouts then recovery",
              "Token spend spikes 10×",
              "Pre-warmed fallback + spend limits prevent bill shock"
            ],
            [
              "Provider Outage",
              "< 100 ms fallback",
              "Traffic auto-routes to backup",
              "Multi-provider resilience is core value of gateway"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Embedding cache",
              "Open-source model",
              "GitHub Copilot-style feature"
            ],
            [
              "Creative writing",
              "Quality-first model",
              "Low cacheability",
              "Different creative model",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–50 ms",
              "1–5 ms",
              "OpenAI text-embedding-3-small: fast; local models: sub-ms"
            ],
            [
              "Embedding Dimension",
              "384–1,536",
              "256–768",
              "OpenAI: 1,536; sentence-transformers/all-MiniLM: 384"
            ],
            [
              "Cache Lookup Latency",
              "5–20 ms",
              "1–5 ms",
              "Vector DB approximate nearest neighbor search"
            ],
            [
              "Similarity Threshold",
              "0.85–0.95 cosine",
              "0.90–0.98",
              "Higher threshold = fewer false cache hits"
            ],
            [
              "Cache Hit Rate",
              "20–40%",
              "50–70%",
              "Customer support FAQs often hit 60%+"
            ],
            [
              "Cost Savings",
              "10–30%",
              "40–60%",
              "Avoids repeated LLM calls for similar prompts"
            ],
            [
              "Storage per Cached Response",
              "1–10 KB",
              "100 bytes–1 KB",
              "Embedding vector + response metadata"
            ],
            [
              "Index Size (1M entries)",
              "1–5 GB",
              "500 MB–2 GB",
              "Depends on embedding dimension and quantization"
            ],
            [
              "False Positive Rate",
              "1–5%",
              "0.1–1%",
              "Tune threshold; add exact-match guard"
            ],
            [
              "TTL for Cache Entries",
              "1–24 hours",
              "5–60 minutes",
              "Short for dynamic content, long for static FAQs"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Cache hit: 10 ms; miss: 500 ms",
              "30% hit rate",
              "Embedding + vector search overhead is small"
            ],
            [
              "2× Load",
              "Hit: 10 ms; miss: 600 ms",
              "35% hit rate",
              "More diverse queries; hit rate stable"
            ],
            [
              "5× Load",
              "Hit: 15 ms; miss: 1 s",
              "40% hit rate",
              "Vector DB query latency rises; consider replicas"
            ],
            [
              "10× Load",
              "Hit: 20–50 ms; miss: 2 s+",
              "45% hit rate",
              "Vector DB becomes hotspot; shard or use approximate index"
            ],
            [
              "Repeated Prompt Attack",
              "All hits",
              "99% hit rate",
              "Potential cache pollution; rate limit identical prompts"
            ],
            [
              "Threshold Too Low",
              "Fast but wrong answers",
              "High hit rate, low accuracy",
              "Users get stale or irrelevant cached responses"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "0.92",
              "24 hours",
              "Chatbot answers repeated questions"
            ],
            [
              "Code generation",
              "Medium",
              "0.88",
              "1 hour",
              "Similar coding prompts share solutions"
            ],
            [
              "Creative writing",
              "Low",
              "0.95",
              "15 minutes",
              "Avoid stale or repetitive copy"
            ],
            [
              "Data extraction",
              "High",
              "0.90",
              "6 hours",
              "Extracting fields from similar documents"
            ],
            [
              ...
              "N/A",
              "N/A",
              "Stock prices, weather — do not cache"
            ],
            [
            ...
            [
              ...
              "0.95",
              "5 minutes",
              "User-specific outputs change quickly"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "256–1,000 tokens",
              "384–512 tokens",
              "Smaller chunks improve relevance; larger preserve context"
            ],
            [
              "Chunks per Document",
              "10–100",
              "100–1,000",
              "10K-token doc → ~20 chunks of 512 tokens"
            ],
            [
              "Embedding Latency (batch)",
              "50–500 ms",
              "10–50 ms",
              "Batched embedding reduces per-chunk latency"
            ],
            [
              "Vector Search Latency",
              "10–100 ms",
              "1–10 ms",
              "HNSW approximate search; exact search slower"
            ],
            [
            ...
            [
              ...
              "20–200 ms",
              "5–50 ms",
              "Cross-encoder rerankers improve relevance 10–20%"
            ],
            [
              "Generation Latency",
              "500 ms–5 s",
              "100 ms–1 s",
              "Depends on model and output token count"
            ],
            [
              "End-to-End RAG Latency",
              "1–6 s",
              "200 ms–1 s",
              "Optimization: cache embeddings + fast vector DB"
            ],
            [
              "Retrieval Accuracy (hit@5)",
              "60–80%",
              "85–95%",
              "Reranking + better chunking improves accuracy"
            ],
            [
              "Cost per Query",
              "$0.001–$0.05",
              "$0.0001–$0.01",
              "Embedding + LLM generation + storage"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "1–3 s",
              "Top-k retrieval + generation succeeds",
              "Vector DB and model capacity comfortable"
            ],
            [
              "2× Load",
              "2–5 s",
              "Embedding queue builds slightly",
              "Add embedding workers or batch larger"
            ],
            [
              "5× Load",
              "5–10 s",
              "Vector DB CPU high; retrieval slows",
              "Scale vector DB replicas; optimize HNSW params"
            ],
            [
              "10× Load",
              "10–30 s",
              "Retriever fails; LLM queue overflows",
              "Separate retrieval from generation; add queues"
            ],
            [
              "Document Ingestion Burst",
            ...
            [
              "Stale Index",
              "Fast retrieval, wrong answers",
              "Hallucination risk",
              "Refresh index on source doc changes; versioning"
            ]
          ]
        }
      },
    ...
    "vector-db-sharding": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Vectors per Node (RAM)",
              "1M–10M",
              "10M–100M",
              "Depends on dimension and quantization; 768-dim float32 ~3 KB/vector"
            ],
            [
              "Vector Dimension",
              "384–1,536",
              "256–2,048",
              "OpenAI: 1,536; CLIP: 512; custom models vary"
            ],
            [
              "Query Latency (single node)",
              "10–100 ms",
              "1–10 ms",
              "HNSW index; brute force is 10–100× slower"
            ],
            [
              "Query Latency (cluster)",
              "20–200 ms",
              "5–20 ms",
              "Fan-out to shards + aggregation adds overhead"
            ],
            [
              "Recall@10 (HNSW)",
              "85–95%",
              "95–99%",
              "Trade off recall vs latency via ef/efConstruction"
            ],
            [
              "Ingestion Rate",
              "1K–10K vectors/s",
              "100K+ vectors/s",
              "Milvus cluster: 100K+ vectors/sec"
            ],
            [
              "Shard Size Recommendation",
              "1–10 GB",
              "10–50 GB",
              "Smaller shards = faster recovery, more overhead"
            ],
            [
              "Replication Factor",
              "1–2",
              "3–5",
              "Higher for query-heavy; lower for cost-sensitive"
            ],
            [
              "Index Build Time",
              "Minutes–hours",
              "Seconds–minutes",
              "HNSW incremental; IVF requires full rebuild"
            ],
            [
              "Storage with Quantization",
              "1× (float32)",
              "0.25× (int8/binary)",
              "Binary vectors: 1/32 the size of float32"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "10–50 ms",
              "Single node handles queries",
              "High recall, low latency"
            ],
            [
              "2× Data Volume",
              "50–100 ms",
              "Node memory pressure; query slows",
              "Add shards or enable quantization"
            ],
            [
              "5× Query Load",
              "100–300 ms",
              "CPU saturated; queueing visible",
              "Scale query replicas; add load balancer"
            ],
            [
              "10× Mixed Load",
              "500 ms–2 s",
              "Ingestion starves queries",
            ...
            [
              ...
              "Shard by tenant/content domain to limit fan-out"
            ],
            [
              "Node Failure",
              "Degraded recall or timeout",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Massive billion-scale",
              "vector partition (LSH)",
              "IVF with PQ",
              "1–2×",
              "Faiss cluster, ScaNN"
            ],
        ...
        table: {
          ...
          rows: [
            [
              ...
              "16 GB (T4)",
              "80 GB (H100)",
              "A100: 40/80 GB; H100: 80 GB"
            ],
            [
              "FP16 Throughput (A100)",
              "312 TFLOPS",
              "989 TFLOPS (H100)",
              "H100 SXM: ~2× A100 for inference"
            ],
            [
              "Batch Size",
              "1–8",
            ...
            [
              "Requests per GPU/sec",
              "1–10 req/s",
              "50–200 req/s",
              "Depends on model size and sequence length"
            ],
            [
              "Tokens per GPU/sec",
              "500–5,000 tok/s",
              "10K–50K tok/s",
              "vLLM on H100: 20K+ tok/s for Llama 70B"
            ],
            [
              "VRAM per 1B Params (FP16)",
              "2 GB",
              "1 GB (quantized)",
              "INT8 quantization halves memory; 4-bit ~0.5 GB/B"
            ],
            [
              "KV Cache Memory",
              "10–100 MB",
              "1–10 GB",
              "Grows with batch size × sequence length"
            ],
            [
              "GPU Utilization Target",
              "50–70%",
              "80–95%",
              "Higher util = better ROI but latency risk"
            ],
            [
              "Cold Start Time",
              "30–120 s",
              "5–30 s",
              "Model loading from storage to GPU"
            ],
            [
              "Cost per GPU/hour",
              "$1–$3 (T4)",
              "$4–$8 (A100)",
              "Cloud spot/preemptible: 50–70% cheaper"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Fast, low batch",
              "GPU util 20–40%",
              "Efficient per-request but poor GPU ROI"
            ],
            [
              "2× Load",
              "Slightly higher",
              "GPU util 50–70%",
              "Batching begins to improve throughput"
            ],
            [
              "5× Load",
              "Latency doubles",
              "GPU util 80–90%",
              "Good throughput; monitor queue depth"
            ],
            [
              "10× Load",
              "Latency 3–5×",
              "GPU util 95–100%",
              "Queueing dominates; need more GPUs or bigger batch"
            ],
            [
              "Batch Too Large",
              "Timeout / OOM",
              "VRAM exhausted",
              "KV cache exceeds GPU memory; reduce batch or sequence length"
            ],
            [
              "Cold Start",
              "30–120 s",
              "First request slow",
              "Keep warm instances for latency-sensitive traffic"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–10 ms",
              "< 1 ms",
              "Simple rule routing is fast; ML routing adds 5–50 ms"
            ],
            [
              "Provider Count",
              "2–3",
              "10–20+",
              "OpenAI, Anthropic, Azure, Cohere, local models, open-source"
            ],
            [
              "Models Available",
              "5–10",
              "50–100+",
              "Includes fine-tuned variants and quantized versions"
            ],
            [
              "Cost Spread per 1M Tokens",
              "$0.10–$30",
              "$0.01–$50",
            ...
            [
              ...
              "100 ms–5 s",
              "50 ms–10 s",
              "Depends on model size and output length"
            ],
            [
              "Quality Spread (benchmark)",
              "40–90%",
              "30–95%",
              "GPT-4 vs small model on complex tasks"
            ],
            [
              "Fallback Trigger Time",
              "1–5 s",
              "100 ms–1 s",
              "Latency SLO breach or error rate threshold"
            ],
            [
              "Routing Accuracy Improvement",
              "5–15%",
              "20–30%",
              "Correct router improves quality at same cost"
            ],
            [
              "Cost Savings from Routing",
              "10–30%",
              "40–60%",
              "Route easy queries to cheap models"
            ],
            [
              "Multi-Region Latency Delta",
              "50–200 ms",
              "20–50 ms",
              "Route to nearest healthy provider region"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Quality and cost balanced"
            ],
            [
              "2× Load",
              "Slight increase",
              "Some providers throttle; router shifts traffic",
              "Distribute load across providers"
            ],
            [
              "5× Load",
              "Latency + 50–100%",
              "Fallbacks activate frequently",
              "Cost may rise; monitor spend per provider"
            ],
            [
              "10× Load",
              "Timeouts on primary",
              "Router drains unhealthy providers",
              "Pre-negotiated quota limits hit"
            ],
            [
              "Provider Outage",
              "< 100 ms failover",
              "Traffic black-holes failing provider",
              "Health checks + circuit breaker essential"
            ],
            [
              "Bad Router Decisions",
              "Low cost, wrong answers",
              "User complaints rise",
              "Continuous evaluation loop needed"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Minimize cost",
              "Price per token",
              "Cheapest passing quality gate",
              "Next cheapest",
              "May sacrifice quality"
            ],
            [
              "Maximize quality",
              "Benchmark score / evaluator",
              "Best model",
              "Second best",
            ...
            [
              ...
              "Healthy provider",
              "Any healthy",
              "Cost/quality fluctuate"
            ],
            [
              "Data privacy",
              "Residency / contract",
              "Approved provider/self-hosted",
              "On-prem",
    ...
    "url-shortener-overview": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Short Links Created / Day",
              "1M–10M",
              "100M+",
              "bit.ly has created 10B+ total links"
            ],
            [
              "Redirect Requests / Day",
              "100M–1B",
              "10B+",
              "Read-heavy; 100:1 read:write ratio common"
            ],
            [
              "Redirect Latency (p99)",
              "< 50 ms",
              "< 20 ms",
              "Cache hit path; origin lookup adds 5–20 ms"
            ],
            [
              "Short Code Length",
              "6–7 chars",
              "7–8 chars",
              "Base62: 6 chars = 57B keys; 7 chars = 3.5T keys"
            ],
            [
              "Active Users",
              "1M–10M DAU",
              "100M+ DAU",
              "Enterprise link managers serve large user bases"
            ],
            [
              "Links per User / Month",
              "10–100",
              "1,000+",
              "Marketing automation creates many links"
            ],
            [
              "Storage per Link Row",
              "100–500 bytes",
              "1–2 KB with metadata",
              "URL, short code, user_id, timestamps, analytics flags"
            ],
            [
              "Global Availability Target",
              "99.9%",
              "99.99%",
              "Downtime means broken marketing campaigns"
            ],
            [
              "Cache Hit Rate for Redirects",
              "80–95%",
              "95–99%",
              "Hot links dominate traffic"
            ],
            [
              "Monthly Click Analytics Events",
              "1B–10B",
              "100B+",
              "Every redirect generates analytics events"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "p99 < 50 ms",
              "Cache serves most redirects",
              "Healthy"
            ],
            [
              "2× Load",
              "p99 < 70 ms",
              "Cache hit rate stable; backend CPU rises slightly",
              "Add cache replicas"
            ],
            [
              "5× Load",
              "p99 100–200 ms",
              "Backend DB reads increase; some cache misses",
              "Scale read replicas"
            ],
            [
              "10× Load",
              "p99 500 ms+",
              "DB saturated; cache stampede risk",
              "Add cache capacity, pre-warm"
            ],
            [
              "Viral Link Burst",
              "Spike then recover",
              "Single short code gets millions of hits",
              "Rate limit or cache aggressively"
            ],
            [
              "Creation Surge",
              "Creation latency rises",
              "Unique short-code generation becomes bottleneck",
              "Pre-generate code pools"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Code generation",
              "DB auto-increment + base62",
              "Simple, guaranteed unique",
              "Centralized bottleneck",
              "TinyURL early design"
            ],
            [
              "Code generation",
              "Pre-generated random pools",
              "Scales writes; no contention",
              "Wasted keys; collision check needed",
              "bit.ly production"
            ],
            [
              "Custom short codes",
            ...
            [
              ...
              "CDN + Redis cache",
              "Sub-50 ms redirects",
              "Stale risk on URL update",
              "High-traffic campaigns"
            ],
            [
              "Analytics",
              "Async queue + data warehouse",
              "Does not slow redirects",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Base62 (A-Z, a-z, 0-9)",
              "Base64 or custom",
              "Base62 avoids ambiguous chars and is URL-safe"
            ],
            [
              "Keyspace (6 chars base62)",
              "56.8 billion",
              "N/A",
              "62^6 = ~57B unique codes"
            ],
            [
              "Keyspace (7 chars base62)",
              "3.5 trillion",
              "N/A",
              "62^7 = ~3.5T codes"
            ],
            [
              "Keyspace (8 chars base62)",
              "218 trillion",
              "N/A",
              "62^8 = ~218T codes"
            ],
            [
              ...
              "< 1 µs",
              "< 100 ns",
              "Integer-to-string conversion is trivial"
            ],
            [
              "Collision Probability (random 7-char)",
              "~1.4% at 100M keys",
              "< 0.01% with 8+ chars",
              "Birthday problem: collisions scale with sqrt(keyspace)"
            ],
            [
              "Custom Code Length",
              "4–10 chars",
              "Up to 32 chars",
              "User-defined branded codes can be longer"
            ],
            [
              "Sequential vs Random",
              "Sequential: dense",
              "Random: scattered",
              "Sequential reveals creation order; random is opaque"
            ],
            [
              "Uniqueness Check Latency",
              "1–5 ms",
              "< 1 ms (cache)",
              "DB lookup or bloom filter checks new code"
            ],
            [
              "Reserved Codes",
              "1–5% of keyspace",
              "10%+",
              "Block profanity, trademark, and common words"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "< 1 ms",
              "Single encoder serves requests",
              "Healthy"
            ],
            [
              "2× Load",
              "1–2 ms",
              "CPU usage rises; still fast",
              "Scale encoder service horizontally"
            ],
            [
              "5× Load",
              "2–5 ms",
              "Uniqueness checks become visible",
              "Add bloom filter for fast negative checks"
            ],
            [
              "10× Load",
              "5–20 ms",
              "DB contention on uniqueness checks",
              "Pre-generate and cache code pools"
            ],
            [
              "Collision Storm",
              "Retries increase",
              "Random generator produces duplicates",
              "Increase code length or use counters"
            ],
            [
              "Custom Code Rush",
              "10–100 ms",
              "High collision rate on short words",
              "Reserve dictionary; fallback to random"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "DB auto-increment + base62",
              "Unique, ordered, tiny",
              "Predictable, single-writer bottleneck",
              "Internal tool"
            ],
            [
              "Opaque codes",
            ...
            [
              "Very high volume",
              "Pre-generated pools",
              "No live encoding contention",
              "Wasted/unused codes",
              "bit.ly scale"
            ],
            [
              "Global uniqueness",
              "Snowflake-style embedded",
              "Distributed, ordered",
              "Longer codes",
              "Multi-region system"
            ],
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10M–100M",
              "1B+",
              "Shard by short-code hash or range"
            ],
            [
              "Storage per Row",
              "100–500 bytes",
              "1–2 KB with metadata",
              "Long URL dominates size; metadata adds overhead"
            ],
            [
              "Daily Write Volume",
              "1M–10M rows",
            ...
            [
              "DB Write Throughput per Node",
              "1K–5K writes/s",
              "10K+ writes/s",
              "SSD-backed relational or NoSQL"
            ],
            [
              "DB Read Throughput per Node",
              "10K–50K reads/s",
              "100K+ reads/s",
              "With proper indexes and replicas"
            ],
            [
              "Replication Lag",
              "< 1 s",
              "< 100 ms",
              "Sync critical; async acceptable for analytics"
            ],
            [
              "Backup Size Growth",
              "1–10 GB/day",
              "100 GB+/day",
              "Incremental backups; archive cold links"
            ],
            [
              "Index Size vs Data Size",
              "10–30%",
              "20–50%",
              "Primary key on short_code is compact"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Read: 1–5 ms; Write: 5–20 ms",
              "Single primary + replicas healthy",
              "Healthy"
            ],
            [
              "2× Read Load",
              "Read stable",
              "Replicas absorb traffic",
              "Add replicas"
            ],
            [
              "5× Read Load",
              "Read: 10–50 ms",
              "Replica CPU high; cache miss rate rises",
              "Scale cache and replicas"
            ],
            [
              "2× Write Load",
              "Write: +30–50%",
              "Primary DB pressure",
              "Consider code pool pre-generation"
            ],
            [
              "10× Write Load",
              "Write: 100 ms+",
              "Primary becomes bottleneck",
              "Shard writes or use NoSQL"
            ],
            [
              "Hot Shard",
              "Latency spike on shard",
              "Uneven short-code distribution",
              "Rehash or use consistent hashing"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "High read scale",
              "SQL + Redis cache",
              "Fast redirects, strong consistency",
            ...
            [
              "Edge redirects",
              "Cloudflare KV",
              "Sub-10 ms global reads",
              "Limited query ability",
              "Edge-first shortener"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "80–95%",
              "95–99.5%",
              "Pareto distribution: few links drive most traffic"
            ],
            [
              "Redirect Latency (cache hit)",
              "1–5 ms",
              "< 1 ms",
              "Redis/Memcached in same DC"
            ],
            [
              "Redirect Latency (cache miss)",
              "5–20 ms",
              "10–50 ms",
              "DB lookup + cache write"
            ],
            [
              "Cache Size per Node",
              "10–100 GB",
              "100 GB–1 TB",
              "Redis node capacity; cluster for larger"
            ],
            [
              "Hot Link TTL",
              "1–24 hours",
              "Days",
              "Popular campaign links stay hot"
            ],
            [
              "Cold Link TTL",
              "Minutes–hours",
              "None",
              "One-hit links do not need long cache"
            ],
            [
              "Eviction Policy",
              "LRU / LFU",
              "Adaptive",
              "LFU better for viral link bursts"
            ],
            [
              "Redis Ops/sec per Node",
              "100K+",
              "1M+",
              "Single Redis instance handles massive redirect load"
            ],
            [
            ...
            [
              "CDN Redirect Cache Hit Rate",
              "90–99%",
              "99%+",
              "Edge PoPs absorb global redirect traffic"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "p99 < 15 ms",
              "Hit rate stable; CPU rises",
              "Scale cache cluster"
            ],
            [
              "5× Load",
              "p99 20–50 ms",
              "Some eviction pressure",
              "Add nodes; tune TTL"
            ],
            [
              "10× Load",
              "p99 100 ms+",
              "Cache stampede risk",
              "Implement single-flight / circuit breaker"
            ],
            [
              "Viral Link",
              "Spike then plateau",
              "Single key becomes extremely hot",
              "Replicate hot key; CDN edge cache"
            ],
            [
              "Cache Failure",
              "DB read spike",
              "Redirects slow 10×",
              "Graceful degradation; failover replica"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Predictable hot links",
              "Pre-warm cache",
              "No cold start",
              "Wasted cache for misses",
            ...
            [
              "Cost-sensitive",
              "CDN-only caching",
              "Cheaper than Redis cluster",
              "Less control",
              "Small global shortener"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "100M–1B",
              "100B+",
              "One event per redirect plus metadata"
            ],
            [
              "Events per Second (peak)",
              "10K–100K",
              "10M+",
              "Viral links create huge spikes"
            ],
            [
              "Event Payload Size",
              "100–500 bytes",
              "1–2 KB",
              "URL, referrer, user-agent, geo, timestamp"
            ],
            [
            ...
            [
              ...
              "Hot data kept short-term"
            ],
            [
              "Distinct Links Queried",
              "1M–10M",
              "1B+",
              "Top-k and per-link drilldowns"
            ],
            [
              "Aggregation Query Latency",
              "100 ms–1 s",
              "< 100 ms",
              "Pre-aggregated counters vs ad-hoc scans"
            ],
            [
              "Click Fraud Detection Latency",
              "Minutes",
              "Seconds",
              "ML or heuristic bot filtering"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "5× Load",
              "Dashboard 2–5 s",
              "Aggregation lag grows",
              "Add Flink/Spark workers"
            ],
            [
              "10× Load",
              "Dashboard 5–30 s",
              "Queue backlog",
              "Scale horizontally; sample if needed"
            ],
            [
              "Viral Event Burst",
              "Lag spikes then recovers",
              "Single link drives millions of events",
              "Isolate hot link counters"
            ],
            [
              "Ad-hoc Query",
              "Seconds–minutes",
              "Full table scans",
              "Use pre-aggregates or data warehouse"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M–10M",
              "1B+ (WhatsApp 2B+)",
              "DAU drives connection and message load"
            ],
            [
              "Messages per Day",
              "10M–100M",
              "100B+ (WhatsApp)",
              "Peak hours often 2–3× average"
            ],
            [
              "Messages per Second (peak)",
              "10K–100K",
              "10M+",
              "Includes text, images, reactions, edits"
            ],
            [
              "One-to-One Chats",
              "70–80% of total",
              "60–70%",
              "Majority of conversations are private"
            ],
            [
              "Group Chat Members",
              "Up to 1,024",
              "Up to 200,000 (Telegram)",
              "Group size changes fan-out dramatically"
            ],
            [
              "Message Delivery Latency (p99)",
              "< 200 ms",
              "< 100 ms",
              "End-to-end within same region"
            ],
            [
              "Concurrent Connections per Server",
              "10K–100K",
              "1M+",
              "Depends on language/runtime and protocol"
            ],
            [
              "Media Message Ratio",
              "20–40%",
            ...
            [
              "Presence Status Updates / Sec",
              "100K–1M",
              "10M+",
              "Online/typing/last-seen fan-out"
            ],
            [
              "Global Regions",
              "2–5",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Add gateway capacity"
            ],
            [
              "5× Load",
              "p99 200–500 ms",
              "Presence fan-out pressure",
            ...
            [
              ...
              "Shard by conversation or region"
            ],
            [
              "Viral Group Message",
              "Latency spike in group",
              "One message fans out to 100K+ members",
              "Special large-group path needed"
            ],
            [
              "Connection Storm",
              "Reconnect spikes",
              "Millions reconnect after outage",
              "Backoff and staggered reconnect"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "Protocol",
              "WebSocket",
              "Proprietary over QUIC/TCP",
              "WebSocket is most common for web chat"
            ],
            [
              "Connection Uptime",
              "Hours–days",
              "Weeks",
              "Mobile networks cause frequent reconnects"
            ],
            [
              "Heartbeat Interval",
              "20–60 s",
              "5–30 s",
              "Keep connection alive; too frequent drains battery"
            ],
            [
              "Heartbeat Timeout",
              "60–120 s",
            ...
            [
              "Message Overhead",
              "2–10 bytes framing",
              "10–50 bytes metadata",
              "WebSocket frame + custom headers"
            ],
            [
              "Message Size Limit",
              "1–10 KB text",
              "Up to MB for media",
              "Large media uses separate upload"
            ],
            [
              "Reconnect Backoff",
              "1 s → 30 s exponential",
              "1 s → 5 min",
            ...
            [
              ...
              "10K–100K",
              "1M+",
              "Go/Erlang handle high concurrency well"
            ],
            [
              "Fallback Latency (HTTP poll)",
              "Seconds",
              "Seconds–minutes",
              "Long polling or periodic sync"
            ],
            [
              "Protocol Battery Drain",
              "Moderate",
              "Optimized via QUIC/0-RTT",
              "Mobile chat optimizes for battery"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Battery and server load increase",
              "Adaptive heartbeat / QUIC 0-RTT"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10M–100M",
              "10B+",
              "Text, reactions, edits, system messages"
            ],
            [
              "Storage per Text Message",
              "100 bytes–1 KB",
              "1–2 KB with metadata",
              "Message body + sender + timestamp + flags"
            ],
            [
              "Storage per Media Message",
              "10 KB–10 MB",
              "Up to GB (video)",
              "Media stored in object storage; DB holds metadata"
            ],
            [
              "Retention Period",
              "30 days–1 year",
              "Years or indefinite",
              "Depends on product and compliance"
            ],
            [
              "Recent Messages Read per Query",
              "20–50",
              "100–200",
              "Chat UI loads recent history first"
            ],
            [
              "Message Read Latency (recent)",
              "1–10 ms",
              "< 1 ms (cache)",
              "Indexed by conversation_id + timestamp"
            ],
            [
              "Message Read Latency (old)",
              "10–100 ms",
              "100 ms–1 s",
              "Cold storage or archive queries"
            ],
            [
              "Write Throughput per Shard",
              "1K–10K msg/s",
              "50K+ msg/s",
              "Group chat fan-out increases writes"
            ],
            [
              "Index Size vs Data",
              "20–40%",
              "30–50%",
              "Conversation + timestamp indexes"
            ],
            [
              "Global Storage Growth",
              "1–10 TB/day",
              "1 PB+/day",
              "Media dominates storage growth"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Load",
              "Reads stable",
              "Write throughput rises",
              "Add write replicas"
            ],
            [
              "5× Load",
              "Recent reads 10–50 ms",
              "Hot conversation shards",
              "Shard by conversation or time"
            ],
            [
              "10× Load",
              "Reads 100 ms+",
              "Storage saturated",
              "Scale horizontally; archive old data"
            ],
            [
              "History Sync",
              "Seconds–minutes",
              "Large sync on new device",
              "Paginated cursor-based sync"
            ],
            [
              "Media Upload Surge",
              "Upload latency spikes",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "3–5 s",
              "3–5 s",
              "User expects near-real-time typing state"
            ],
            [
              "Last-Seen Resolution",
              "Minutes",
              "Seconds–minutes",
              "WhatsApp shows last seen to minute"
            ],
            [
              "Presence Fan-Out per User",
              "10–100 contacts",
              "Up to 5,000 (large groups)",
              "Updates sent to all observers"
            ],
            [
              "Presence Storage per User",
              "100 bytes",
              "500 bytes",
              "User ID, status, timestamp, device list"
            ],
            [
              "Update Latency (p99)",
              "< 500 ms",
              "< 100 ms",
              "Contacts should see status quickly"
            ],
            [
              "Presence Cache Hit Rate",
              "90–99%",
              "99%+",
              "Hot presence data cached in Redis"
            ],
            [
              "Multi-Device Sync Latency",
              "< 1 s",
              "< 100 ms",
              "Status consistent across user devices"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "< 100 ms fan-out",
              "Updates propagate smoothly",
              "Healthy"
            ],
            [
              "2× Load",
              "< 200 ms",
              "CPU on presence service rises",
              "Scale presence workers"
            ],
            [
              "5× Load",
              "500 ms–1 s",
              "Some update batching needed",
            ...
            [
              "Celebrity User Online",
              "Huge fan-out spike",
              "Millions notified",
              "Special handling for high-degree users"
            ],
            [
              "Network Partition",
              "Stale presence",
              "Users appear offline incorrectly",
              "Eventually consistent presence acceptable"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Redis pub/sub",
              "Fast",
              "Does not scale to huge fan-out",
              "WhatsApp"
            ],
            [
              "Large groups",
              "Batch + scoped updates",
              "Scalable",
              "Less instant",
              "Slack channels"
            ],
            [
              "Celebrity accounts",
              "Separate high-fan-out path",
              "Protects normal users",
              "Complex",
              "Public figures"
            ],
            [
              "Battery-sensitive mobile",
              "Longer heartbeat",
              "Saves battery",
              "Stale presence",
              "Mobile messenger"
        ...
        table: {
          ...
          rows: [
            [
              ...
              "100K–1M",
              "100M+",
              "WebSocket/MQTT connections to gateways"
            ],
            [
              "Connections per Gateway Instance",
              "10K–100K",
              "500K–1M",
              "Depends on language and hardware"
            ],
            [
              "Messages per Second per Shard",
              "1K–10K",
              "100K+",
              "Shard by conversation or region"
            ],
            ...
            [
              ...
              "50–200 ms",
              "20–100 ms",
              "Replicate messages between regions"
            ],
            [
              "Fan-Out Factor (small groups)",
              "< 1,000",
              "N/A",
              "Write-time fan-out practical"
            ],
            [
              "Fan-Out Factor (large channels)",
              "1K–1M",
              "Up to 200M",
              "Read-time fan-out required"
            ],
            [
              "CPU per 1K Connections",
              "1–2 cores",
              "0.1–0.5 cores",
              "Highly optimized gateways use less"
            ],
            [
              "Memory per 1K Connections",
              "100 MB–1 GB",
              "10–100 MB",
              "Connection buffers dominate"
            ],
            [
              "Auto-Scale Reaction Time",
              "Seconds",
              "Seconds–minutes",
              "Kubernetes HPA or cloud autoscaling"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "5× Load",
              "200–500 ms",
              "Message queue depth grows",
              "Scale consumers and DB"
            ],
            [
              "10× Load",
              "500 ms–1 s",
              "Hot shards form",
              "Reshard by conversation"
            ],
            [
              "Connection Burst",
              "Reconnect latency spikes",
              "Auth and state restoration slow",
              "Pre-warm and rate-limit reconnects"
            ],
            [
              "Cross-Region Surge",
              "100–300 ms",
              "Inter-region replication lag",
              "Add regional capacity"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Connection scaling",
              "Horizontal gateway instances",
              "Linear scale",
              "Sticky routing needed",
              "Discord"
            ],
            [
              "Message fan-out (small)",
              "Write-time fan-out",
              "Fast reads",
              "Write amplification",
              "1:1 chats"
    ...
    proxies: [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–10 Gbps",
              "100+ Gbps",
              "Kernel-bypass proxies (DPDK) reach Tbps"
            ],
            [
              "Layer 7 Requests/sec",
              "10K–100K",
              "1M–10M+",
              "Envoy at Lyft: 2M+ req/s per cluster"
            ],
            [
              "Connection Count",
              "10K–100K",
              "1M–10M",
              "AWS NLB: millions of concurrent connections"
            ],
            [
              "Proxy Latency (L4)",
              "< 1 ms",
              "< 0.1 ms",
              "DPDK/kernel bypass sub-microsecond"
            ],
            [
              "Proxy Latency (L7)",
              "1–5 ms",
              "0.5–2 ms",
              "TLS termination + routing adds overhead"
            ],
            [
              "Cache Hit Rate (forward proxy)",
              "20–50%",
              "60–80%",
              "Squid/Cloudflare caching static content"
            ],
            [
              "SSL Handshakes/sec",
              "1K–10K",
              "100K+",
              "Hardware SSL offload: 200K+ handshakes/s"
            ],
            [
              "Health Check Interval",
              "5–30 s",
              "1–5 s",
              "Envoy defaults 5 s; faster = more control plane load"
            ],
            [
              "Backend Pool Size",
              "2–10",
              "10–1,000",
              "AWS ALB: up to 100 targets per target group"
            ],
            [
              "Request Size Limit (L7)",
              "1–10 MB",
              "100 MB+",
              "Large uploads need streaming or chunked"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1–5 ms overhead",
              "Even distribution",
              "Round-robin or least-connections optimal"
            ],
            [
              "2× Load",
              "2–10 ms overhead",
            ...
            [
              "5× Load",
              "5–20 ms overhead",
              "Backends near saturation",
              "Add backends or cache more"
            ],
            [
              "10× Load",
              "20–100 ms overhead",
              "Proxy queues requests",
              "Proxy itself may need scaling"
            ],
            [
              "Backend Failure",
              "< 100 ms failover",
            ...
            [
              "DDoS Traffic",
              "Edge rejection",
              "99%+ dropped at proxy/WAF",
              "Cloudflare proxies absorb 70M req/s attacks"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Static content + DDoS protection",
              "Reverse proxy / CDN",
              "Cloudflare, Fastly",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–30%",
              "50–100%+",
              "Multiple indexes can exceed table size"
            ],
            [
              "Query Speedup",
              "10×–100×",
              "1,000×+",
              "From full table scan to index lookup"
            ],
            [
            ...
            [
              ...
              "1–3 disk reads",
              "1–2 reads",
              "O(log N); ~4 levels for 1B rows"
            ],
            [
              "Hash Index Lookup",
              "1 read",
              "1 read",
              "O(1) for equality only"
            ],
            [
            ...
            [
              ...
              "1–10%",
              "< 1%",
              "Low selectivity indexes may not be used"
            ],
            [
              "Covering Index Hit",
              "1 read",
            ...
            [
              ...
              "Low",
              "High",
              "REINDEX, vacuum, analyze frequency grows"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Index lookup: 1–10 ms",
              "Queries use optimal index",
              "Healthy index usage"
            ],
            [
              "2× Read Load",
              ...
              "Index buffers warm",
              "Add memory or replicas"
            ],
            [
              "5× Read Load",
              "10–100 ms",
              "Index pages evicted from cache",
              "Increase shared_buffers or shard"
            ],
            [
              "10× Read Load",
              "100 ms–1 s",
              "Index lookups become disk-bound",
              "Scale reads or optimize queries"
            ],
            [
              "2× Write Load",
              "+10–30% write latency",
              "Index maintenance visible",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1%",
              "0.1–0.01%",
              "Tunable by size and hash functions"
            ],
            [
              "Bits per Element",
              "8–12",
            ...
            [
              ...
              "3–7",
              "5–10",
              "Optimal count depends on bits/element"
            ],
            [
              "Memory for 1B Items",
              "1 GB (8 bits/item)",
              "4 GB (32 bits/item)",
              "vs ~100 GB+ for exact set"
            ],
            [
              "Lookup Latency",
              "1–10 µs",
            ...
            [
              ...
              "2×",
              "Variable",
              "Add new filters as set grows"
            ],
            [
              "Counting Bloom Filter Overhead",
              "4× standard",
              "2–8×",
              "Supports deletion"
            ],
            [
              "Cassandra Bloom Filter FP Rate",
              "0.01–1%",
              "0.1%",
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Elements",
              "Same",
              "False positive rate doubles",
              "Filter becoming saturated"
            ],
            [
              "5× Elements",
              "Same",
              "High false positive rate",
              "Rebuild filter or add capacity"
            ],
            [
              "10× Elements",
              "Same",
              "Useless without scaling",
              "Scalable bloom filter adds layers"
            ],
            [
              "Disk-Based Filter",
              "1–10 ms",
              "One disk seek per lookup",
              "SSTable bloom filters avoid disk reads"
            ],
            [
              "Network Filter",
              "1–5 ms",
              "One RTT to RedisBloom",
              "Still faster than DB lookup"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Allowed",
              "Tiny",
              "Avoid DB lookup for missing keys"
            ],
            [
              "Deduplication (exact)",
              "Hash set",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–30 s",
              "100 ms–2 s",
              "Kubernetes liveness: default 10 s; etcd: 100 ms"
            ],
            [
              "Heartbeat Timeout",
              "2–5 × interval",
            ...
            [
              ...
              "10–60 s",
              "1–5 s",
              "Time to declare node/service dead"
            ],
            [
              "Gossip Protocol Fan-out",
              "3–5 peers",
              "5–10 peers",
              "Consul serf: 3–5 random peers"
            ],
            [
              "Gossip Interval",
              "200 ms–1 s",
              "100–500 ms",
              "Trade-off: convergence vs overhead"
            ],
            [
              "Convergence Time",
              "Seconds–minutes",
              "Milliseconds–seconds",
              "For cluster state to propagate"
            ],
            [
              "Heartbeat Payload Size",
              "100 bytes–1 KB",
              "10–100 bytes",
              "Usually node ID, timestamp, minimal status"
            ],
            [
              "Heartbeat Messages/sec (cluster)",
              "100–1,000",
              "10K–100K",
              "Large clusters generate significant gossip"
            ],
            [
              "False Positive Rate",
              "0.01–0.1%",
              "< 0.01%",
              "Tuned by timeout and network quality"
            ],
            [
              "Lease TTL",
              "10–60 s",
              "1–10 s",
              "etcd leases expire if not renewed"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Node Count",
              "Slight increase in gossip traffic",
              "Detection time stable",
              "Gossip scales logarithmically"
            ],
            [
              "5× Node Count",
              "Gossip traffic noticeable",
              "Some delayed heartbeats",
              "May need larger fan-out or sub-clusters"
            ],
            [
              "10× Node Count",
              "Heartbeat storms possible",
              "False positives rise",
              "Tune intervals; use hierarchical detection"
            ],
            [
              "Network Partition",
              "Timeout → suspect → dead",
              "Split-brain risk",
              "Quorum-based systems avoid false declaration"
            ],
            [
              "Node Overload",
              "Missed heartbeats despite alive",
              "Flapping",
              "Distinguish process health from network health"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Common Use",
              "Network packets, ZIP",
              "Legacy file checksum",
              "TLS, signatures, git",
              "Database checksums",
              "Modern hashing"
            ],
            [
              "False Positive Rate (corruption)",
              "1 / 2^32",
              "1 / 2^128",
              "1 / 2^256",
              "1 / 2^64 (64-bit)",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "< 1 ms",
              "Checksum negligible",
              "Use strong hash freely"
            ],
            [
              "2× Data Volume",
              "Linear increase",
              "CPU usage rises",
              "Still acceptable for SHA-256"
            ],
            [
              "5× Data Volume",
              "Noticeable CPU",
              "May become bottleneck",
              "Switch to xxHash/BLAKE3 for integrity"
            ],
            [
              "10× Data Volume",
              "Throughput capped",
              "Hashing limits pipeline",
              "Parallelize or use hardware acceleration"
            ],
            [
              "Streaming Large Objects",
              "Steady throughput",
              "One pass over data",
              "Incremental hash avoids loading all data"
            ],
            [
              "Verify on Every Read",
              "+1–5% latency",
              "Read path overhead",
              "Acceptable for critical data; cache checksums"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Very fast",
              "No",
              "Network packet, file transfer"
            ],
            [
              "Fast database integrity",
              "xxHash64",
              "Fastest",
              "No",
              "RocksDB checksums"
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1 ms–1 s",
              "< 10 ms",
              "Async: milliseconds to seconds; sync: <1 ms"
            ],
            [
              "Failover Time",
              "30 s–5 min",
              "1–30 s",
              "Manual failover slow; automated (Patroni/Redis Sentinel) fast"
            ],
            [
              "Replica Count",
              "1–3",
              "5–20",
              "More replicas = more read scale but overhead"
            ],
            [
              "Read Split Ratio",
              "80:20 to 95:5",
              "99:1",
              "Most traffic reads; write goes to leader"
            ],
            [
              "Write Throughput",
              "1K–10K TPS",
            ...
            [
              "Read Throughput (with replicas)",
              "10K–100K QPS",
              "1M+ QPS",
              "Replicas scale reads linearly"
            ],
            [
              "Semi-Sync Timeout",
              "10 s",
              "1–5 s",
              "How long to wait for replica ack"
            ],
            [
              "Quorum Size (Raft)",
              "Majority of N",
            ...
            [
              ...
              "Seconds–minutes",
              "Minutes–hours",
              "New replica copies full dataset"
            ],
            [
              "Consistency Model",
              "Eventual / async",
              "Strong / sync",
              "Sync hurts write latency"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Read: 1–10 ms; Write: 5–20 ms",
              "Leader + 2 replicas healthy",
              "Lag negligible"
            ],
            [
              "2× Read Load",
            ...
            [
              ...
              "Read: 10–50 ms",
              "Replicas saturated",
              "Add more replicas or cache"
            ],
            [
              "2× Write Load",
              "Write: +50–100%",
              "Leader CPU/disk pressure",
              "Vertical scale leader or shard"
            ],
            [
              "5× Write Load",
              "Write: timeout/spike",
              "Leader bottleneck",
              "Must shard or partition writes"
            ],
            [
              "Leader Failure",
              "1–60 s downtime",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "2–10 ms",
              "1–2 ms",
              "Strong must coordinate with replicas"
            ],
            [
              "Read Latency (cross-region)",
              "100–500 ms",
              "1–5 ms",
              "Strong cross-region is expensive"
            ],
            [
              "Write Latency",
              "5–50 ms",
              "1–5 ms",
              "Strong writes wait for quorum/all"
            ],
            [
            ...
            [
              ...
              "1K–10K TPS",
              "10K–1M+ TPS",
              "Eventual avoids coordination overhead"
            ],
            [
              "Replication Lag",
              "0 ms (visible)",
              "1 ms–seconds",
              "Eventual lag depends on load/distance"
            ],
            [
              "Conflict Rate",
              "0%",
              "0.1–5%",
              "Eventual may need conflict resolution"
            ],
            [
              "Operational Complexity",
              "High",
              "Medium",
              "Strong needs consensus; eventual needs conflict handling"
            ],
            [
              "Examples",
              "Spanner, etcd, Raft",
            ...
            [
              ...
              "Wrong choice causes bugs or outages"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Low latency",
              "Eventual wins on raw speed"
            ],
            [
              "2× Load",
              "Latency increases linearly",
              "Latency stable",
              "Strong coordination becomes visible"
            ],
            [
              "5× Load",
              "Leader/quorum bottleneck",
              "Scales well",
              "Strong may need sharding"
            ],
            [
              "10× Load",
              "Throughput capped",
              "Still scaling",
              "Eventual handles fan-out better"
            ],
            [
              "Network Partition",
              "Unavailable or degraded",
              "Available, stale reads",
              "Classic CAP trade-off"
            ],
            [
              "Recovery",
              "Reconciliation fast",
              "Reconciliation may lag",
              "Eventual needs anti-entropy"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Strong or careful optimistic",
              "Overselling costs money",
              "Amazon checkout"
            ],
            [
              "Social media feed",
              "Eventual",
              "Speed matters; stale OK",
              "Twitter/X timeline"
            ],
            [
              "Like/comment counts",
            ...
            [
              "Analytics dashboard",
              "Eventual",
              "Aggregate data; freshness flexible",
              "Metrics"
            ],
            [
              "Shopping cart",
    ...
    "latency-vs-throughput": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "< 10 ms",
              "100 ms–seconds",
              "Trading per-op speed for volume"
            ],
            [
              "Throughput",
              "1K–10K ops/s",
            ...
            [
              ...
              "Low",
              "High",
              "High queueing improves throughput at latency cost"
            ],
            [
              "Resource Utilization",
              "40–60%",
              "80–95%",
              "Latency needs headroom; throughput maximizes"
            ],
            [
              "Concurrency",
              "Low–medium",
              "High",
              "More concurrent work improves throughput"
            ],
            [
              "Examples",
              "Trading, gaming",
              "Analytics, ETL, logging",
            ...
            [
              ...
              "Higher",
              "Lower",
              "Throughput amortizes fixed costs"
            ]
          ]
        }
      },
      {
        ...
        table: {
          headers: [
            "Load Factor",
            "Latency-Focused System",
            "Throughput-Focused System",
            "What It Means"
          ],
          rows: [
            [
              "1× (Baseline)",
              "Low latency, low util",
              "Moderate latency, low util",
              "Both have headroom"
            ],
            [
              "2× Load",
              "Latency stable",
              "Latency stable, throughput doubles",
              "Throughput system scales better"
            ],
            [
              "5× Load",
              "Latency spikes if util > 70%",
              "Throughput high, latency rises",
              "Latency system needs scale-out"
            ],
            [
              "10× Load",
              "Latency unacceptable",
              "Throughput peaks, latency long tail",
              "Both need architectural change"
            ],
            [
              "Burst",
              "Rejects or queues",
              "Absorbs in batch queue",
              "Throughput systems handle bursts better"
            ],
            [
              "Over-provisioning",
              "Required for low latency",
              "Less needed",
              "Latency systems cost more at low load"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "User-facing API",
              "Latency",
              "Cache, CDN, connection reuse",
              "Product page load"
            ],
            [
              "Log ingestion",
              "Throughput",
              "Batch, compress, stream",
              "Fluentd → Kafka"
            ],
            [
              "Real-time bidding",
              "Latency",
              "In-memory, kernel bypass",
              "Ad exchange"
            ],
            [
              "Data warehouse ETL",
              "Throughput",
              "Parallel, columnar, batch",
              "Nightly reports"
            ],
            [
              "Payment processing",
              "Latency + consistency",
              "Fast consensus, minimal hops",
              "Checkout"
            ],
            [
              "Video streaming",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–50 ms",
              "1–5 ms",
              "ACID coordination adds overhead"
            ],
            [
              "Throughput",
              "1K–10K TPS",
              "10K–1M+ TPS",
              "BASE avoids locks and coordination"
            ],
            [
            ...
            [
              ...
              "Strong (serializable)",
              "Eventual",
              "ACID prevents anomalies"
            ],
            [
              "Conflict Rate",
              "0%",
              "0.1–5%",
              "BASE systems resolve conflicts later"
            ],
            [
              "Schema Flexibility",
              "Rigid",
              "Flexible",
              "BASE often schema-less"
            ],
            [
              "Operational Complexity",
              "Medium",
              "High",
              "BASE needs conflict resolution"
            ],
            [
              "Scaling Writes",
              "Harder",
              "Easier",
              "BASE scales horizontally"
            ],
            [
              "Examples",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Latency increases",
              "Scales linearly",
              "BASE handles growth better"
            ],
            [
              "5× Load",
              "Lock contention visible",
              "Minimal latency increase",
              "ACID may deadlock or queue"
            ],
            [
              "10× Load",
              "Single-node bottleneck",
              "Add nodes",
              "BASE horizontal scale shines"
            ],
            [
              "Network Partition",
              "May block or fail",
        ...
        table: {
          ...
          rows: [
            [
              "Bank balances",
              "ACID",
              "Must not lose or duplicate money",
              "Ledger"
            ],
            [
              "Shopping cart",
              "ACID per user",
              "User expects own actions reflected",
              "Amazon cart"
            ],
            [
              "Product catalog",
              "BASE / eventual",
              "Frequent reads, tolerant of stale",
              "Product search"
            ],
            [
              "User sessions",
            ...
            [
              ...
              "BASE",
              "Volume huge; exact order not critical",
              "Event stream"
            ],
            [
              "Inventory reservation",
              "ACID or saga",
              "Overselling is costly",
              "E-commerce"
            ],
            [
              "Social graph",
              "BASE",
              "Massive scale; approximate OK",
              "Facebook graph"
            ],
            [
              "Audit log",
              "ACID / append-only",
              "Tamper-evident, ordered",
              "Compliance log"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "< 1 ms (L4)",
              "1–10 ms (L7)",
              "Gateway does more work"
            ],
            [
              "Throughput",
              "1M–10M+ req/s",
              "10K–100K req/s",
              "LBs are simpler and faster"
            ],
            [
              "Protocol Layer",
              "L4 / L7",
              "L7",
              "LBs can be TCP/UDP; gateways HTTP"
            ],
            [
              "SSL Termination",
              "Yes",
            ...
            [
              ...
              "Basic",
              "Advanced",
              "Gateway has per-user/key limits"
            ],
            [
              "Request Transformation",
              "No",
              "Yes",
              "Gateway rewrites paths/headers"
            ],
            [
              "Cost",
              "Low",
              "Higher",
              "Gateway licensing/compute"
            ],
            [
              "Examples",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Linear scale",
              "Slightly more CPU",
              "Gateway auth/transformation cost"
            ],
            [
              "5× Load",
              "Still fast",
              "Latency increases",
              "Gateway may need scaling"
            ],
            [
              "10× Load",
              "LB rarely bottleneck",
              "Gateway can bottleneck",
              "Add gateway instances or cache"
            ],
            [
              "Many Policies",
              "Ignores policies",
              "Per-request evaluation",
              "Gateway cost scales with policy count"
            ],
            [
              "DDoS",
              "Passes to WAF/gateway",
              "Rate limit + block",
              "Gateway is policy enforcement point"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "< 1–2 ms",
              "2–10 ms",
              "Gateway does auth, rate limiting, transforms"
            ],
            [
              "Throughput",
              "100K–1M+ req/s",
              "10K–100K req/s",
              "Reverse proxy is leaner"
            ],
            [
              "Authentication",
              "Optional (via module)",
              "Core feature",
              "Gateway integrates IdP"
            ],
            [
              "Rate Limiting",
              "Basic",
              "Per-key, per-tier",
              "Gateway is policy-rich"
            ],
            [
              "Caching",
              "Yes",
              "Yes",
              "Both cache responses"
            ],
            [
              "Developer Portal",
              "No",
              "Yes",
              "Gateway exposes API docs/keys"
            ],
            [
              "Request Transformation",
              "Limited",
              "Extensive",
              "Gateway rewrites payloads"
            ],
            [
              "Analytics",
              "Access logs",
              "Per-API metrics",
              "Gateway has business insights"
            ],
            [
              "Examples",
              "NGINX, Envoy, HAProxy",
              "Kong, Apigee, AWS API Gateway",
              "Gateway builds on proxy"
            ],
            [
              "Cost",
              "Low",
              "Medium–high",
              "Gateway licensing and compute"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Negligible overhead",
              "Slight overhead",
              "Gateway adds policy cost"
            ],
            [
              "2× Load",
              "Scales linearly",
              "Scales with policy complexity",
              "Gateway may need more CPU"
            ],
            [
              "5× Load",
              "Still minimal overhead",
              "Latency increases",
              "Policy evaluation dominates"
            ],
            [
              "10× Load",
              "Rarely bottleneck",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–20 ms",
              "1–5 ms",
              "P2P writes local; primary needs replication"
            ],
            [
              "Read Latency (local)",
              "1–10 ms",
            ...
            [
              ...
              "0%",
              "0.1–5%",
              "P2P needs conflict resolution"
            ],
            [
              "Consistency",
              "Strong/eventual configurable",
              "Eventual / causal",
              "Primary-replica easier to make strong"
            ],
            [
              "Failover Complexity",
              "Medium",
              "Low",
              "P2P has no leader to fail"
            ],
            [
              "Operational Complexity",
              "Medium",
              "High",
              "P2P harder to reason about"
            ],
            [
              "Examples",
              "PostgreSQL, MySQL, Redis",
              "Cassandra, DynamoDB, IPFS",
              "Different fault models"
            ],
            [
              "Best For",
              "Strong consistency, simpler ops",
              "Global scale, high writes",
              "Choose by workload"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "5× Read Load",
              "Many replicas needed",
              "Scales naturally",
              "P2P read scaling simpler"
            ],
            [
              "2× Write Load",
              "Leader pressure",
              "Distributed across nodes",
              "P2P handles writes better"
            ],
            [
              "5× Write Load",
              "Leader bottleneck",
              "Still scales",
              "Primary-replica needs sharding"
            ],
            [
              "Node Failure",
              "Failover required",
              "No failover; data redistributed",
              "P2P more resilient to individual loss"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "Relational OLTP",
              "Primary-replica",
              "ACID, simple failover",
              "Banking DB"
            ],
            [
              "Global key-value store",
              "Peer-to-peer",
              "High writes, global HA",
              "DynamoDB, Cassandra"
            ],
            [
              "Read-heavy cache",
              "Primary-replica",
              "Simple, fast failover",
              "Redis Sentinel"
            ],
            [
              "Content delivery",
            ...
            [
              ...
              "Primary-replica per region or P2P",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1–100 ms",
              "10–1,000 ms",
              "Client cache avoids network entirely"
            ],
            [
              "Storage Size",
              "GB–TB",
              "MB–GB",
              "Client cache limited by device"
            ],
            [
              "Invalidation Control",
              "Full control",
              "Limited control",
              "Client caches honor headers"
            ],
            [
              "Freshness Guarantee",
              "Configurable",
            ...
            [
              ...
              "30–70% origin load",
              "Bandwidth savings",
              "Both reduce infrastructure cost"
            ],
            [
              "Examples",
              "Redis, Memcached, CDN",
            ...
            [
              "Hit Rate for Static Assets",
              "80–95% (CDN)",
              "50–70% (browser)",
              "CDN offloads repeat users"
            ],
            [
              "Dynamic Content Hit Rate",
              "20–50%",
              "Low",
              "Dynamic data less cacheable"
            ],
            [
              "Invalidation Latency",
              "1 ms–1 min",
              "TTL-based",
              "Server can purge; client waits for TTL"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "No server impact",
              "Client cache scales for free"
            ],
            [
              "5× Load",
              "Server cache may saturate",
              "Still avoids network",
              "Scale server cache replicas"
            ],
            [
              "10× Load",
              "Origin protected if cache hit",
              "No protection of origin",
              "Server cache is origin shield"
            ],
            [
              "Cache Miss Storm",
              "Origin spike",
              "Requests go to server/CDN",
              "Warm caches after deploy"
            ],
            [
              "Invalidation Burst",
              "Propagates quickly",
              "Slow TTL-based refresh",
              "Client cache harder to purge"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "5–50 ms",
              "1–10 ms",
              "gRPC HTTP/2 + binary is faster"
            ],
            [
              "Payload Size",
              "Text, verbose",
              "Binary, compact",
              "Protobuf ~2–5× smaller than JSON"
            ],
            [
              "Throughput",
              "1K–10K req/s",
              "10K–100K req/s",
              "gRPC multiplexing reduces overhead"
            ],
            [
              "Serialization CPU",
              "Higher",
              "Lower",
              "JSON parsing slower than protobuf"
            ],
            [
              "Browser Support",
              "Native",
              "Needs gRPC-Web or proxy",
              "REST easier for web clients"
            ],
            [
              "Code Generation",
              "Optional (OpenAPI)",
            ...
            [
              ...
              "gRPC ideal for streaming"
            ],
            [
              "Load Balancing",
              "HTTP-aware",
              "Needs L7 aware of HTTP/2",
              "Long-lived gRPC connections complicate LB"
            ],
            [
              "Caching",
              "HTTP caching mature",
              "Limited",
              "REST benefits from CDN"
            ],
            [
              "Tooling Maturity",
              "Very high",
              "High",
              "REST broader; gRPC stronger in microservices"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–50 ms",
              "2–10 ms",
              "gRPC faster due to binary + multiplexing"
            ],
            [
              "2× Load",
              "Latency + 20%",
            ...
            [
              ...
              "Multiplexed streams efficient",
              "REST needs connection pooling"
            ],
            [
              "10× Load",
              "JSON parsing bottleneck",
              "Protobuf keeps CPU lower",
              "gRPC wins on CPU"
            ],
            [
              "Many Small Calls",
              ...
              "Efficient",
              "gRPC better for chatty services"
            ],
            [
              "Public Browser API",
              "Easy",
              "Needs gateway",
              "REST wins for external web"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "< 100 ms",
              "Seconds–minutes",
              "Polling interval dominates"
            ],
            [
              "Server Resource Usage",
              "High (many empty requests)",
              "Medium (persistent conn)",
              "Low (push on event)",
            ...
            [
              ...
              "Good with connection mgmt",
              "Excellent",
              "Webhooks scale best for rare events"
            ],
            [
              "Complexity",
              "Low",
              "Medium–high",
              "High",
              "Webhooks need retry, security, endpoint mgmt"
            ],
            [
              "Firewall/NAT Friendly",
              "Yes",
              "Yes (HTTP upgrade)",
              "Needs public endpoint",
              "Webhooks require client server"
            ],
            [
              "Use Case",
              ...
              "Choose by direction and frequency"
            ],
            [
              "Connection Count",
              "Many short",
            ...
            [
              ...
              "Moderate drain",
              "Low drain",
              "Polling frequent drains battery"
            ],
            [
              "Reliability",
              "Depends on interval",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Retry queue grows",
              "WebSocket needs horizontal scaling"
            ],
            [
              "10× Clients",
              "Polling collapses",
              "Need connection sharding",
              "Delivery failures spike",
              "Each pattern needs architecture change"
            ],
            [
              ...
              "Ideal",
              "Many outgoing calls",
              "WebSocket for frequent updates"
            ],
            [
              "Rare Events",
              "Wastes polls",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Mobile push alternative",
              "Polling",
              "Works when push unavailable",
              "Legacy app refresh"
            ],
            [
              "Live sports score",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10–50 ms",
              "50–500 ms",
              "CDN serves from nearest PoP"
            ],
            [
              "Latency (uncached)",
              "50–200 ms",
              "Same as origin",
              "CDN fetches from origin once"
            ],
            [
              "Cache Hit Rate",
              "80–95%",
            ...
            [
              ...
              "Built-in",
              "Manual / WAF",
              "CDNs absorb large attacks"
            ],
            [
              "SSL/TLS Termination",
              "At edge",
              "At origin",
              "CDN reduces origin crypto load"
            ],
            [
              "Dynamic Content",
              "Limited / with edge compute",
              "Full control",
              "CDN edge functions enable dynamic"
            ],
            [
              "Time to First Byte",
              "Fast for cache hits",
              "Depends on origin distance",
              "CDN improves TTFB globally"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Fast cache hits",
              "Normal origin latency",
              "CDN already helps"
            ],
            [
              "2× Load",
              "Hit rate stable",
              "Origin CPU/bandwidth rises",
              "CDN protects origin"
            ],
            [
              "5× Load",
            ...
            [
              ...
              "DDoS mode possible",
              "Origin likely down",
              "CDN is critical for survival"
            ],
            [
              "Cache Miss Storm",
              "Origin spike once",
              "Origin spike every request",
              "CDN shields after first fetch"
            ],
            [
              "Dynamic Burst",
              "May pass through",
              "Origin handles directly",
              "Use edge compute or origin scaling"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "100 ms–2 s",
              "None",
              "Cold starts are the main serverless concern"
            ],
            [
            ...
            [
              ...
              "Milliseconds–seconds",
              "Minutes",
              "Serverless instant; traditional needs provisioning"
            ],
            [
              "Scale-to-Zero",
              "Yes",
              "No",
              "Serverless saves idle cost"
            ],
            [
              "Idle Cost",
              "$0",
              "Full instance cost",
              "Traditional wastes money at low utilization"
            ],
            [
              "Max Execution Time",
              "15 min (Lambda)",
              "Unlimited",
              "Long jobs need traditional or containers"
            ],
            [
              "Memory Limit",
              "128 MB–10 GB",
            ...
            [
              ...
              "Depends on capacity",
              "AWS Lambda default 1,000 concurrent"
            ],
            [
            ...
            [
              ...
              "Serverless cheap at low scale; can exceed at high scale"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Idle capacity",
              "Serverless cheap; traditional over-provisioned"
            ],
            [
              "2× Load",
              "Scales instantly",
            ...
            [
              "5× Load",
              "Concurrency limits may hit",
              "Auto-scaling kicks in",
              "Serverless may need limit increase"
            ],
            [
              "10× Load",
              "Cold start storm",
              "Scale-out takes minutes",
              "Both need pre-warming / faster scaling"
            ],
            [
              "Sustained High Load",
              "Cost can exceed traditional",
              "Efficient at steady high load",
              "Traditional wins on unit cost"
            ],
            [
              "Burst Traffic",
              "Excellent",
              "Slow unless pre-warmed",
              "Serverless ideal for bursts"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Yes",
              "No",
              "Sticky sessions complicate LB"
            ],
            [
              "Memory per Instance",
              "Higher (holds state)",
              "Lower",
              "Stateful stores data in memory/disk"
            ],
            [
              "Data Loss Risk",
              "Higher",
              "Lower",
              "Stateful instance failure loses state"
            ],
            [
              "Horizontal Scaling",
              "Partition by key",
              "Add instances freely",
              "Stateful needs sharding"
            ],
            [
              "Operational Complexity",
              "High",
              "Low",
              "Stateful needs backup, replication, migration"
            ],
            [
              "Latency for Hot State",
              "Very low",
              "Moderate (fetch from store)",
              "In-memory state is fastest"
            ],
            [
              "Cost at Scale",
              "Higher (specialized)",
              "Lower (commodity)",
              "Stateless uses smaller instances"
            ],
            [
              "Examples",
              "Game servers, WebSocket, databases",
              "REST APIs, CDNs, functions",
              "Most web apps prefer stateless"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Stateful faster for hot data"
            ],
            [
              "2× Load",
              "Need to partition state",
              "Add instances",
            ...
            [
              ...
              "Shard carefully",
              "Linear scale",
              "Stateful complexity grows"
            ],
            [
              "10× Load",
              "Rebalancing state",
              "Auto-scale",
              "Stateful needs planned migration"
            ],
            [
              "Instance Failure",
              "State loss or failover",
              "No impact",
              "Stateless resilient"
            ],
            [
              "Rolling Update",
              "Hard (state migration)",
              "Easy",
              "Stateless enables continuous deploy"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Stateless",
              "JWT avoids session state",
              "OAuth2 provider"
            ],
            [
              "Stream processing",
              "Stateful (partitioned)",
              "Windowed state per partition",
              "Flink job"
            ],
            [
              "CDN edge function",
    ...
    "token-bucket-vs-leaky-bucket": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Smooths bursts",
              "Token bucket better for bursty clients"
            ],
            [
              "Average Rate",
              "Controlled by refill rate",
              "Controlled by leak rate",
              "Both control long-term rate"
            ],
            [
              "Implementation Complexity",
              "Low",
              "Low–medium",
              "Both simple in Redis"
            ],
            [
              "Memory per Key",
              "Low (tokens + last refill)",
              "Low (queue or counter)",
              "Redis stores small counters"
            ],
            [
              "Fairness",
              "Can be unfair to new clients",
              "Smoother distribution",
              "Leaky bucket more egalitarian"
            ],
            [
              "Use Case",
              "API rate limiting",
              "Traffic shaping",
              "Token bucket for APIs; leaky for networks"
            ],
            [
              "Refill/Leak Interval",
              "Per second/minute",
              "Continuous / fixed interval",
              "Token often periodic; leaky often continuous"
            ],
            [
              "Bucket Capacity",
              "Determines max burst",
              "Queue size determines buffer",
              "Tune to client needs"
            ],
            [
              "Latency Overhead",
              "< 1 ms",
              "< 1 ms",
              "Redis INCR/EXPIRE or Lua script"
            ],
            [
              "Examples",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2× Sustained",
              "Bucket drains; half rejected",
              "Queue builds; delayed",
              "Both limit rate"
            ],
            [
              "Burst Traffic",
              "Burst passes if tokens available",
              "Burst buffered then smoothed",
              "Token bucket friendlier to bursts"
            ],
            [
              "10× Load",
              "Rapid rejection after burst",
              "Queue overflow → rejection",
              "Both protect backend"
            ],
            [
              "Distributed Sync",
              "Refill clock drift matters",
              "Leak rate per node matters",
              "Use Redis or consensus"
            ],
            [
              "Low-Bandwidth Client",
              "Can save tokens",
              "Steady rate enforced",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Public API per-user limit",
              "Token bucket",
              "Allows reasonable bursts",
              "GitHub API"
            ],
            [
            ...
            [
              "DDoS protection",
              "Token bucket",
              "Drop excess immediately",
              "WAF"
            ],
            [
              "Queue consumer throttling",
              "Leaky bucket",
              "Smooth consumption",
              "Worker pool"
            ],
            [
              "Mobile app API",
              "Token bucket",
              "Tolerates bursty mobile usage",
              "Uber API"
            ],
            [
              "Microservice egress",
              "Leaky bucket",
              "Protect downstream from spikes",
              "Service mesh"
            ],
            [
              "Login endpoint",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Read replicas + cache",
              "Sharding + queue + SSD",
              "Reads scale horizontally; writes harder"
            ],
            [
              "Cache Hit Rate",
              "70–95%",
              "20–50%",
              "Write-heavy data changes too fast to cache"
            ],
            [
              "Database Choice",
              "PostgreSQL + replicas, Redis",
              "Cassandra, DynamoDB, Kafka",
              "Match DB to access pattern"
            ],
            [
              "Index Overhead",
              "Worth it",
            ...
            [
              ...
              "Higher",
              "Lower",
              "Read-heavy can tolerate stale reads"
            ],
            [
              "Latency Sensitivity",
              "Reads must be fast",
            ...
            [
              "Examples",
              "News, e-commerce catalog",
              "IoT, logging, trading",
              "Common patterns"
            ],
            [
              "Cost Driver",
              "Cache and replica size",
              "Storage IOPS and write throughput",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1× (Baseline)",
              "Cache serves most reads",
              "Write throughput comfortable",
              "Both healthy"
            ],
            [
              "2× Read Load",
            ...
            [
              "2× Write Load",
              "No impact",
              "Disk/leader pressure",
              "Writes need scale strategy"
            ],
            [
              "5× Read Load",
              "Many replicas or CDN",
              "Still OK if reads isolated",
              "Cache is key"
            ],
            [
              "5× Write Load",
              "Replication lag grows",
              "Sharding or queue needed",
              "Writes are bottleneck"
            ],
            [
              "10× Mixed Load",
              "Read path scales; watch cache",
              "Partitioning essential",
              "Different scale paths"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "News website",
              "Read-heavy",
              "CDN, cache, read replicas",
              "CNN, NYT"
            ],
            [
              "IoT telemetry",
              "Write-heavy",
              "Kafka, time-series DB, sharding",
              "Sensor platform"
            ],
            [
              "E-commerce product page",
              "Read-heavy",
              "CDN, cache, replica DB",
              "Amazon product page"
            ],
            [
              "Order processing",
              "Write-heavy",
              "Queue, sharded DB, idempotency",
              "Amazon checkout"
            ],
            [
              "Social feed",
              "Read-heavy, write bursts",
            ...
            [
              "Logging platform",
              "Write-heavy",
              "Kafka, Elasticsearch, S3 archive",
              "Splunk, Datadog"
            ],
            [
              "User profile",
