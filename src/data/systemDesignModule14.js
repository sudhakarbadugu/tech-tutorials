// Module 15: Trade-offs (shifted from module14)
          ...
          table: {
            ...
            rows: [
              [
                "Read guarantee",
                "Always latest write",
                "May be stale temporarily"
              ],
              [
                "Latency",
                "Higher (coordination)",
                "Lower (no coordination)"
              ],
              [
                "Availability",
                "Lower under partitions",
                "Higher under partitions"
              ],
              [
                "Use case",
                "Bank balances, inventory",
                "Social feeds, comments, analytics"
              ],
              [
                "Implementation",
                "Paxos, Raft, 2PC, quorums",
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                "RPS, TPS, messages/sec"
              ],
              [
                "Optimization goal",
                "Minimize time to first byte",
                "Maximize total workload"
              ],
              [
                "Typical lever",
                "Caching, CDN, faster hardware",
                "Batching, horizontal scaling, partitioning"
              ],
              [
                "Trade-off",
                "High throughput may add queuing latency",
                "Low latency can reduce batching efficiency"
              ],
              [
                "Example",
                "Search autocomplete",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Atomicity",
                "All operations succeed or roll back",
                "Not guaranteed across documents/nodes"
              ],
              [
                "Consistency",
                "Always consistent after transaction",
                "Eventually consistent"
              ],
              [
                "Isolation",
                "Transactions isolated from each other",
                "Concurrency handled loosely"
              ],
              [
                "Durability",
                "Committed data survives failures",
                "Usually durable, but model does not guarantee"
              ],
              [
                "Availability",
                "Can block during contention",
                "Highly available under partitions"
              ],
              [
                "Scalability",
                "Vertical + limited horizontal",
                "Horizontal scale-out friendly"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Authentication",
                "Usually not",
                "Yes (JWT, OAuth, API keys)"
              ],
              [
                "Rate limiting",
                "Basic",
                "Advanced per user/API/route"
              ],
              [
                "Request transformation",
                "No",
                "Yes (JSON ↔ XML, protocol translation)"
              ],
              [
                "Service aggregation",
                "No",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Scope",
                "Network/TLS/basic routing",
                "Full API lifecycle management"
              ],
              [
                "Authentication",
                "TLS termination, maybe mTLS",
                "JWT, OAuth, API keys, SSO"
              ],
              [
                "Rate limiting",
                "IP-based, basic",
                "Quota, tier, per-client"
              ],
              [
                "Caching",
                "Static/response caching",
                "Endpoint-aware caching"
              ],
              [
                "Transformation",
                "Header rewrite, URL rewrite",
                "Protocol, body, schema transformation"
              ],
              [
                "Analytics/billing",
                "Basic logs",
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                "Scale reads and writes via nodes"
              ],
              [
                "Consistency",
                "Easier to enforce",
                "Requires quorum/conflict resolution"
              ],
              [
                "Failover",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Browser, mobile device, CDN edge"
              ],
              [
                "Reduces DB load",
                "Yes",
                "No (but reduces origin requests)"
              ],
              [
                "Invalidation control",
                "Server controlled",
                "Client controlled or HTTP headers"
              ],
              [
                "Staleness risk",
                "Lower with TTL/purge",
                "Higher if headers are wrong"
              ],
              [
                "Use case",
                "API responses, sessions, DB query results",
                "Static assets, app data, offline support"
              ],
              [
                "Examples",
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Performance",
                "Good",
                "Excellent (smaller payloads, multiplexing)"
              ],
              [
                "Readability",
                "Human-readable",
              ...
              [
                "Streaming",
                "Limited (SSE, long polling)",
                "Native bidirectional"
              ],
              [
                "Best for",
                "Public APIs, web apps",
                "Internal microservices, polyglot systems"
              ]
            ]
          }
        },
          ...
          table: {
            ...
            rows: [
              ...
              [
                ...
                "High (empty requests)",
                "Medium",
                "Medium (connection state)",
                "Low"
              ],
              [
                "Connection",
                "New each time",
                "Held open temporarily",
                "Persistent",
                "New HTTP request per event"
              ],
              [
                "Use case",
                "Status checks",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Latency",
                "Low (edge close to user)",
                "Higher (round trip to origin)"
              ],
              [
                "Origin load",
                "Low (cache absorbs traffic)",
                "High (every request hits origin)"
              ],
              [
                "Cost",
                "Bandwidth savings, cache costs",
                "Compute and bandwidth concentrated"
              ],
              [
                "Content type",
                "Static, cacheable assets",
                "Dynamic, personalized, uncacheable"
              ],
              [
                "Availability",
                "Resilient to origin failures",
                "Depends on origin health"
              ],
              [
                "Examples",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Cold start",
                "Yes (initialization delay)",
                "No (always running)"
              ],
              [
                "Use case",
                "Event processing, APIs, batch jobs",
                "Long-running services, databases, complex apps"
              ],
              [
                "Examples",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Scalability",
                "Harder (sticky sessions or state replication)",
                "Easy (any server can handle any request)"
              ],
              [
                "Failover",
                "Complex (state must transfer)",
                "Simple (restart any server)"
              ],
              [
                "Request size",
                "Smaller",
                "May be larger (token/session data included)"
              ],
              [
                "Use case",
                "WebSockets, real-time games",
                "REST APIs, microservices"
              ],
              [
                "Examples",
                "Chat servers, session-aware load balancers",
                "RESTful services, JWT auth"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Overflow",
                "Requests wait until tokens available",
                "Excess requests are dropped or queued"
              ],
              [
                "Burst handling",
                "Supports short bursts up to bucket size",
                "No bursts; constant rate enforced"
              ],
              [
                "Use case",
              ...
              [
                ...
                "Network routers, traffic shapers"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              [
                "Read/write ratio",
                "High reads, few writes",
                "High writes, few reads"
              ],
              [
                "Database pattern",
                "Primary-replica, read replicas",
                "Sharding, partitioning, append-only logs"
              ],
              [
                "Caching",
                "Critical (CDN, Redis, in-memory)",
                "Less effective; focus on ingestion"
              ],
              [
                "Storage optimization",
                "Indexes, materialized views",
                "LSM trees, columnar, time-series"
              ],
              [
                "Scaling strategy",
                "Add replicas, caches",
                "Add shards, batch writes, partition"
              ],
              [
                "Examples",
                "E-commerce catalog, news site",
                "IoT telemetry, logging, Kafka"
              ]
            ]
          }
        },
