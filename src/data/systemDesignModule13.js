// Module 14: Building Blocks (shifted from module13)
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Use case",
                "Bypass filters, corporate firewalls",
          ...
          table: {
            ...
            rows: [
              [
                ...
                "Slower writes than heap"
              ],
              [
                "Hash",
                "Hash map",
                "Exact match lookups",
                "No range scans or sorting"
              ],
              [
                "Clustered",
                "Data rows in index order",
                "Range scans on primary key",
                "Only one per table; inserts may reorder"
              ],
              [
                "Non-clustered",
                "Pointer to row",
              ...
              [
                "Composite",
                "Multiple columns",
                "Filters using leading columns",
                "Wasted if query does not use leading column"
              ]
            ]
          }
        },
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Scalability",
                "O(n) pairs can be heavy",
                "O(log n) rounds to spread state"
              ],
              [
                "Failure detection",
                "Fast, explicit timeouts",
                "Eventually consistent view"
              ],
              [
                "Use case",
                "Leader-follower, load balancers",
                "Membership lists, cluster state"
              ],
              [
                "Examples",
          ...
          table: {
            ...
            rows: [
              [
                "CRC32",
                "32 bits",
                "Network packets, file integrity",
                "Not secure"
              ],
              [
                "MD5",
                "128 bits",
                "Legacy file checksums",
                "Broken for security"
              ],
              [
                "SHA-256",
                "256 bits",
                "Data integrity, TLS, blockchains",
                "Collision-resistant"
              ],
              [
                "Blake3",
        ...
        },
        {
          ...
          table: {
            ...
            rows: [
              ...
              [
                "Latency",
                "Higher; waits for follower ack",
                "Lower; acks immediately"
              ],
              [
                "Throughput",
                "Lower",
              ...
              [
                "Examples",
                "PostgreSQL sync rep, Raft",
                "MySQL async replication, Redis"
              ]
            ]
          }
        },
