// Deep dives for modules 1, 3, 4 (shifted after REST insertion)
    ...
    "message-queues": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "10K-20K msgs/sec",
              "50K-100K msgs/sec",
              "Clustered with mirrored queues"
            ],
            [
              "Throughput (Kafka)",
              "100K-500K msgs/sec",
              "1M+ msgs/sec per cluster",
              "LinkedIn benchmarks; depends on partition count"
            ],
            [
              "Throughput (AWS SQS)",
              "300 msgs/sec (FIFO)",
              "Unlimited burst (standard)",
              "FIFO capped; standard scales horizontally"
            ],
            [
            ...
            [
              ...
              "Seconds",
              "Minutes to hours",
              "Depends on SLA; monitor with alerts"
            ],
            [
              "Message Size Limit",
              "256 KB (SQS)",
              "1 MB (Kafka, RabbitMQ)",
              "Larger messages use S3/blob offloading"
            ],
            [
              "Queue Depth (healthy)",
              "< 1,000 msgs",
              "< 100,000 msgs",
              "Deeper queues signal consumer lag"
            ],
            [
              "Disk per Million Msgs",
              "~1 GB",
              "~500 MB (Kafka with compression)",
              "Kafka LZ4 compression reduces footprint"
            ],
            [
              "Fan-out Ratio",
              "1:3 producers:consumers",
              "1:10+",
              "Pub-sub scales fan-out better"
            ],
            [
              "Operational Cost",
              "$500/mo (self-hosted)",
              "$5K-20K/mo (managed)",
              "Confluent Cloud, AWS MSK pricing"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "2-5 ms",
              "Smooth operation; consumers keep up",
              "Healthy system with headroom"
            ],
            [
              "2x",
              "5-15 ms",
              "Minor latency increase; queue depth stable",
              "Normal scaling; add partitions if Kafka"
            ],
            [
              "5x",
              "20-100 ms",
              "Queue depth grows; consumer lag appears",
              "Consumers bottlenecked; scale horizontally"
            ],
            [
              "8x",
              "200 ms - 1 s",
              "Significant lag; retries and redeliveries spike",
              "Broker I/O saturated; risk of disk full"
            ],
            [
              "10x",
              "1-10 s+",
              "Message timeouts; dead-letter queue fills",
              "Critical: add consumers or partition now"
            ],
            [
              ">10x (Spike)",
              "Unbounded",
              "Producer backpressure or drops",
              "Circuit breaker needed; queue as shock absorber"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Task distribution with complex routing",
              "RabbitMQ",
              "AMQP exchanges enable flexible routing",
              "Lower throughput than Kafka"
            ],
            [
              "High-throughput event streaming (1M+ msgs/s)",
              "Apache Kafka",
              "Partitioned log scales horizontally",
            ...
            [
              ...
              "FIFO queues limited to 300 msg/s"
            ],
            [
              "Real-time notifications, no persistence needed",
              "Redis Pub/Sub",
              "100K+ msg/s; sub-millisecond latency",
              "Messages lost on restart"
            ],
            [
              "Need exactly-once semantics",
              "Kafka with idempotent producers",
              "Transactional IDs + deduplication",
              "Higher latency; more config"
            ],
            [
              "Multi-cloud or on-premise flexibility",
              "Apache Pulsar",
              "Tiered storage; geo-replication built-in",
              "Smaller community than Kafka"
            ],
            [
              "Simple background jobs in Node.js",
              "Bull/BullMQ (Redis)",
              "Easy setup; job scheduling built-in",
              "Limited to single Redis memory"
            ]
          ]
        }
      }
    ...
    "pub-sub": [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1-3 ms",
              "5-20 ms",
              "Increases with subscriber count"
            ],
            [
              "Fan-out Ratio",
              "1:10 subscribers",
              "1:1000+ (Google Pub/Sub)",
              "Each subscriber gets a copy"
            ],
            [
              "Throughput per Topic (Kafka)",
              "100K-500K msgs/sec",
              "1M+ msgs/sec",
              "Depends on partitions and consumers"
            ],
            [
              "Subscriber Lag (healthy)",
              "< 1 second",
              "< 5 minutes",
              "Alert if > 10 min for critical topics"
            ],
            [
              "Memory per Subscriber",
              "1-10 MB",
              "100 MB+ (with replay buffer)",
              "Retain buffer for slow consumers"
            ],
            [
              "Message Retention",
              "7 days (Kafka default)",
              "Indefinite (with tiered storage)",
              "Google Pub/Sub: 31 days max"
            ],
            [
              "Delivery Guarantee",
              "At-least-once",
              "Exactly-once (with dedup)",
              "Most systems default to at-least-once"
            ],
            [
              "Filter Efficiency",
              "50% match rate",
              "90%+ with good key design",
              "Poor filtering wastes bandwidth"
            ],
            [
              "Cost per Million Messages",
              "$0.05 (SNS)",
              "$0.40 (Google Pub/Sub)",
              "Varies by region and retention"
            ],
            [
              "Max Subscribers per Topic",
              "100 (SNS)",
              "Unlimited (Kafka, Pulsar)",
              "AWS SNS has soft limits"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "1-3 ms publish",
              "All subscribers keep up",
              "Optimal fan-out performance"
            ],
            [
              "2x",
              "3-8 ms publish",
              "Minor lag in slowest subscriber",
              "Normal; isolated with separate consumer groups"
            ],
            [
              "5x",
              "10-50 ms publish",
              "Some subscribers lagging; broker memory grows",
              "Add consumers or shard topics"
            ],
            [
              "8x",
              "50-200 ms",
              "Backpressure on publisher; message drops possible",
              "Apply publisher rate limiting"
            ],
            [
              "10x",
              "200 ms - 2 s",
              "Broker OOM risk; subscribers far behind",
              "Critical: isolate slow subscribers immediately"
            ],
            [
              ">10x (Spike)",
              "Publish rejected",
              "Circuit breaker trips or broker throttles",
              "Use buffering and backoff"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "One-to-many broadcast (e.g., stock ticker)",
              "Pub-Sub (Kafka/Pulsar)",
              "Natural fan-out; each subscriber independent",
              "Broker must handle N copies of each message"
            ],
            [
            ...
            [
              "Occasional events; low volume",
              "Polling with cursor",
              "Simpler than managing subscriptions",
              "Higher latency; wasted polls"
            ],
            [
              "Real-time to browsers/mobile",
              "WebSockets + Pub-Sub backend",
              "Low latency push to clients",
              "Complex connection management"
            ],
            [
              "Ordered event log for replay",
              "Kafka with partition keys",
              "Immutable log; replay from any offset",
              "Higher storage cost"
            ],
            [
              "Multi-tenant SaaS with per-tenant isolation",
              "Pulsar with namespaces",
              "Built-in tenant isolation and quotas",
              "Smaller ecosystem than Kafka"
            ],
            [
              "Strict exactly-once with ordering",
              "Kafka transactions + partition keys",
              "Atomic commit across producer and consumer",
              "Slower; more complex error handling"
            ]
          ]
        }
      }
    ...
    "request-response": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "RPS per Server (Node.js)",
              "1K-5K RPS",
              "10K-20K RPS",
              "With clustering; CPU-bound tasks lower this"
            ],
            [
              "RPS per Server (Java/Spring)",
              "5K-20K RPS",
              "50K-100K RPS",
              "Netty-based async can push higher"
            ],
            [
              "RPS per Server (Go)",
              "10K-50K RPS",
              "100K+ RPS",
              "Goroutines and efficient runtime"
            ],
            [
              "Latency (p50)",
              "5-20 ms",
            ...
            [
              ...
              "10-50 per instance",
              "100-500",
              "Too large wastes memory; too small starves"
            ],
            [
              "HTTP Keep-Alive Duration",
              "5-60 seconds",
              "5 minutes",
              "Balance between reuse and stale connections"
            ],
            [
              "TLS Handshake Overhead",
              "1-2 RTT (~50-100ms)",
              "0-RTT (TLS 1.3 with early data)",
              "Session resumption reduces this"
            ],
            [
            ...
            [
              ...
              "500 ms - 2 s",
              "100-500 ms",
              "Break down across service calls"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "10-50 ms",
              "All threads idle; connections reused",
              "Healthy with low CPU usage"
            ],
            [
              "2x",
              "50-100 ms",
              "Thread pools filling; connection churn starts",
              "Add instances or optimize handlers"
            ],
            [
              "5x",
              "100-500 ms",
              "Thread pool exhaustion; requests queued",
              "Queue depth grows; latency spikes"
            ],
            [
              "8x",
              "500 ms - 2 s",
              "Rejected connections; timeouts begin",
              "Circuit breaker should trip now"
            ],
            [
              "10x",
              "2-10 s",
              "Most requests timeout; cascading failures",
              "Critical: shed load or scale out immediately"
            ],
            [
              ">10x (Spike)",
              "100% error rate",
              "Service unavailable; thread death spiral",
              "Bulkhead and rate limit to survive"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Mobile APIs with poor networks",
              "GraphQL with persisted queries",
              "Reduce payload size; single request",
              "Server complexity increases"
            ],
            [
              "Long-running operations (> 2s)",
              "Async job with polling/webhook",
              "Free up client connection",
              "Client must handle async pattern"
            ],
            [
            ...
            [
              ...
              "REST with OpenAPI",
              "Language agnostic; tooling rich",
              "Higher overhead than gRPC"
            ],
            [
              "High-frequency internal calls",
              "gRPC + protobuf + sidecar (Istio)",
              "Efficient; mTLS built-in",
              "Service mesh adds latency (~1-3ms)"
            ]
          ]
        }
      }
    ...
    webhooks: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1-10 KB",
              "100 KB-1 MB",
              "Stripe caps at 1 MB; use refs for large data"
            ],
            [
              "Endpoints per Account",
              "1-3",
              "10-50 (e.g., Zapier)",
              "Each endpoint gets a full copy"
            ],
            [
              "Retry Attempts",
              "3-5",
            ...
            [
              ...
              "< 1 ms",
              "1-5 ms",
              "HMAC-SHA256 per request"
            ],
            [
              "Delivery Success Rate",
              "95%",
              "99.9% (with retries)",
              "Monitor and alert on < 95%"
            ],
            [
              "Webhook Throughput",
              "100-1K/min",
              "10K-100K/min",
              "Stripe handles millions/day"
            ],
            [
              "Endpoint Timeout",
              "5-10 s",
              "30 s (for heavy processing)",
              "Shorter timeouts reduce queue backlog"
            ],
            [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Healthy webhook system"
            ],
            [
              "2x",
              "500 ms - 1 s",
              "Some endpoints slow; retries start",
              "Normal; monitor retry rate"
            ],
            [
              "5x",
              "1-3 s",
              "Retry queue grows; signature verification CPU spikes",
              "Scale webhook workers horizontally"
            ],
            [
              "8x",
              "3-10 s",
              "Many endpoints timing out; retry storm begins",
              "Implement circuit breaker per endpoint"
            ],
            [
              "10x",
              "10-60 s",
              "Queue depth unbounded; old events dropped",
              "Critical: disable failing endpoints"
            ],
            [
              ">10x (Spike)",
              "Delivery halted",
              "Provider throttles or pauses webhooks",
              "Buffer events; notify customers"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Customer exposes HTTPS endpoint",
              "Webhooks",
              "Push model; lowest latency",
              "Requires consumer availability"
            ],
            [
              "Consumer behind firewall/NAT",
              "Polling with cursor",
            ...
            [
              ...
              "Polling with cursor + idempotency",
              "Consumer controls ordering",
              "More complex client logic"
            ],
            [
              "High-volume, at-least-once",
              "Message queue (SQS/Kafka)",
              "Durable; replayable",
              "Consumer must poll or subscribe"
            ],
            [
              "Third-party integrations (Zapier)",
              "Webhooks + retry + signature",
              "Industry standard for SaaS",
              "Operational burden on consumer"
            ],
            [
              "Audit trail required",
              "Event log (Kafka) + webhook",
              "Immutable history; replayable",
    ...
    streaming: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "1-10 msg/s",
              "100-1000 msg/s",
              "Chat vs stock ticker"
            ],
            [
              "Connection Setup Time",
              "1-3 RTT (~50-150ms)",
              "0-RTT (TLS 1.3)",
              "WebSocket handshake adds overhead"
            ],
            [
              "Reconnection Backoff",
              "1-30 s",
              "Exponential up to 5 min",
              "Prevents thundering herd"
            ],
            [
              "Broker Messages/sec (Redis)",
              "100K+",
              "1M+ (clustered)",
              "Pub/Sub per channel"
            ],
            [
              ...
              "1:1 (direct)",
              "1:1000+ (broadcast)",
              "Chat room vs live sports"
            ],
            [
              "Cost per Million Connections",
              "$1K-5K",
              "$10K-50K",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "10-50 ms msg delivery",
              "Connections stable; heartbeats clean",
              "Optimal streaming performance"
            ],
            [
              "2x",
              "50-100 ms",
              "Minor connection churn; some reconnection",
              "Normal during deployments"
            ],
            [
              "5x",
              "100-500 ms",
              "Heartbeat timeouts increase; broker CPU rises",
              "Add broker shards or connection limits"
            ],
            [
              "8x",
              "500 ms - 2 s",
              "Reconnection storms after brief outage",
              "Add jitter to reconnection backoff"
            ],
            [
              "10x",
              "2-10 s",
              "Broker memory exhaustion; messages dropped",
              "Critical: shed connections or scale brokers"
            ],
            [
              ">10x (Spike)",
              "Mass disconnect",
              "Clients cannot reconnect; service degraded",
              "Use CDN edge for WebSocket termination"
            ]
          ]
        }
      },
      {
        ...
        list: [
          ...
          "<strong>Stage 5: Massive Scale (10M+ users, e.g., Netflix)",
          "Netflix uses SSE for push notifications to 200M+ subscribers. Edge caches terminate SSE connections close to users. Bottleneck: global event ordering not needed; per-region events suffice.",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Browser bidirectional real-time",
              "WebSockets",
              "Full duplex; low latency",
              "Complex reconnection logic"
            ],
            [
              "Browser unidirectional push",
              "SSE (Server-Sent Events)",
              "Simple HTTP; auto-reconnect",
              "No client-to-server push"
            ],
            [
              "Mobile with intermittent connectivity",
              "MQTT over WebSocket/TLS",
              "Lightweight; QoS levels",
              "Smaller ecosystem than HTTP"
            ],
            [
            ...
            [
              "Simple notifications to browser",
              "SSE with EventSource API",
              "Native browser support",
              "Limited to text/event-stream"
            ],
            [
              "Gaming or binary data",
              "WebSockets with binary frames",
              "Efficient binary transfer",
              "More complex protocol handling"
            ],
            [
              "Massive broadcast (1M+ subscribers)",
              "CDN edge SSE or MQTT broker",
              "Offload to edge; reduce origin load",
              "Event ordering not guaranteed globally"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1M+ events/sec",
              "Per cluster; add clusters for more"
            ],
            [
              "Event Latency (end-to-end)",
              "10-100 ms",
              "1-5 ms (in-memory)",
              "Includes serialization and network"
            ],
            [
              "Projection Rebuild Time",
              "Minutes",
              "Hours (TB-scale logs)",
              "Depends on event count and projector speed"
            ],
            [
              "Consistency Window (CQRS)",
              "10-100 ms",
              "1-5 s (global)",
              "Time for read model to catch up"
            ],
            [
              "Schema Versions Supported",
              "5-10",
              "Unlimited (with upcasters)",
            ...
            [
              ...
              "1 GB/day",
              "1 TB/day (Uber)",
              "Compaction and tiered storage help"
            ],
            [
              "Saga Completion Time",
              "100 ms - 1 s",
              "5-30 s (with retries)",
              "Compensating actions add time"
            ],
            [
              "Consumer Group Rebalance",
              "1-3 s",
              "10-30 s (large groups)",
              "Kafka CooperativeStickyAssignor improves this"
            ],
            [
              "Event Size (typical)",
              "1-5 KB",
              "100 KB-1 MB",
              "Avro/Protobuf compress well"
            ],
            [
              "Dead Letter Events per Day",
              "< 0.1%",
              "< 0.01% (tuned systems)",
              "Alert if > 1%"
            ]
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "10-50 ms event processing",
              "All consumers keep up; projections current",
              "Healthy event-driven system"
            ],
            [
              "2x",
              "50-100 ms",
              "Minor lag in non-critical consumers",
              "Normal; scale projectors if needed"
            ],
            [
              "5x",
              "100-500 ms",
              "Critical consumers lagging; consistency window grows",
              "Add projector instances or partition more"
            ],
            [
              "8x",
              "500 ms - 2 s",
              "Event bus throughput saturated; backpressure",
              "Throttle producers or scale brokers"
            ],
            [
              "10x",
              "2-10 s",
              "Projections severely stale; sagas timeout",
              "Critical: disable non-critical consumers"
            ],
            [
              ">10x (Spike)",
              "Event loss or rejection",
              "Broker cannot accept; producers fail",
              "Use buffering and circuit breakers"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Choreography",
              "Fully decoupled; no central controller",
              "Hard to trace; implicit coupling"
            ],
            [
              "Complex multi-step workflows",
              "Orchestration (Saga)",
              "Central visibility; easy to debug",
            ...
            [
              ...
              "Blocking; poor availability"
            ],
            [
              "Audit trail and replayability",
              "Event Sourcing + Kafka",
              "Immutable log; rebuild any view",
              "Complex; storage intensive"
            ],
            [
              "Fast failure recovery",
              "Choreography with compensation",
            ...
            [
              ...
              "Orchestrated Saga + idempotency",
              "Compensating actions for rollback",
              "Slower; requires careful design"
            ]
          ]
        }
      }
    ...
    replication: [
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1-100 ms",
              "1-10 s (under load)",
              "Monitor with heartbeat tables"
            ],
            [
              "Replication Lag (sync)",
              "0 ms",
              "10-50 ms",
            ...
            [
              ...
              "2-5x",
              "10-20x",
              "Depends on replica count and lag tolerance"
            ],
            [
              "Failover Time (manual)",
              "1-5 minutes",
              "N/A",
              "Human-driven; error-prone"
            ],
            [
              "Failover Time (automated)",
              "5-30 s",
              "1-5 s (with proxy)",
              "Tools: Orchestrator, Patroni"
            ],
            [
              "Write Throughput Impact (sync)",
              "-20% to -50%",
              "-80%",
              "Every write waits for replicas"
            ],
            [
              "Replica Count (typical)",
              "1-3",
              "5-10+",
              "Diminishing returns after 5-7"
            ],
            [
        ...
        table: {
          ...
          rows: [
            ...
            [
              "2x",
              "10-50 ms lag",
              "Replicas slightly behind; reads may be stale",
              "Normal for async replication"
            ],
            [
              "5x",
              "100 ms - 1 s lag",
              "Replication thread CPU-saturated; lag grows",
              "Add more replicas or optimize queries"
            ],
            [
              "8x",
              "1-10 s lag",
              "Significant staleness; some reads must go to primary",
              "Consider sync for critical reads"
            ],
            [
              "10x",
              "10-60 s lag",
              "Replicas at risk of falling too far behind",
              "Critical: investigate network or disk I/O"
            ],
            [
              ">10x (Spike)",
              "Replication stops",
              "Replica cannot keep up; may need rebuild",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Read-heavy, lag-tolerant workload",
              "Async replication",
              "Low write overhead; scales reads",
              "Risk of stale data"
            ],
            [
              "Financial transactions, strong consistency",
              "Sync replication (semi-sync)",
              "Guaranteed durability on replica",
              "Higher write latency"
            ],
            [
              "Write volume exceeds single node",
              "Sharding + async replication",
              "Distributes write load",
              "Complex routing and cross-shard queries"
            ],
            [
              "Global read access with local latency",
            ...
            [
              ...
              "Delayed replica (1 hour lag)",
              "Protects against accidental deletion",
              "Replica is not current"
            ],
            [
    ...
    sharding: [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Shards per Cluster (typical)",
              "4-16",
              "100-1000+",
              "Uber: 1000+ shards for Schemaless"
            ],
            [
              "Data per Shard (healthy)",
              "100 GB - 1 TB",
              "1-5 TB",
              "Depends on query patterns and hardware"
            ],
            [
              "Rebalancing Time",
              "Hours",
              "Days (TB-scale)",
              "Throttled to avoid production impact"
            ],
            [
              "Cross-Shard Query Latency",
              "10-100 ms",
              "100 ms - 1 s",
              "Requires scatter-gather"
            ],
            [
              "Shard Key Cardinality (min)",
              "1,000",
              "1M+",
              "Higher cardinality = better distribution"
            ],
            [
              "Hot Shard Traffic Ratio",
              "1x (even)",
              "10x+ (skewed)",
            ...
            [
              ...
              "1K-5K writes/sec",
              "10K-50K writes/sec",
              "MySQL ~5K; ScyllaDB ~50K+"
            ],
            [
              "Rebalancing Impact on Latency",
              "+10-50%",
              "+100% if unthrottled",
              "Always throttle rebalancing"
            ],
            [
              "Operational Complexity",
              "Medium",
              "Very High",
              "Requires dedicated tooling and expertise"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "1-5 ms",
              "Even shard distribution; single-shard queries",
              "Healthy sharded system"
            ],
            [
              "2x",
              "5-10 ms",
              "Some shards warming; minor latency increase",
              "Normal; monitor per-shard QPS"
            ],
            [
              "5x",
              "10-50 ms",
              "Hot shard detected; one node overloaded",
              "Reshard or split hot shard"
            ],
            [
              "8x",
              "50-200 ms",
              "Cross-shard queries becoming frequent",
              "Redesign queries to avoid scatter-gather"
            ],
            [
              "10x",
              "200 ms - 1 s",
              "Rebalancing triggered; temporary slowdown",
              "Plan rebalancing during low traffic"
            ],
            [
              ">10x (Spike)",
              "Hot shard fails",
              "Single shard cannot handle load",
              "Add sub-shards or cache heavily"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "Recent shards are hot"
            ],
            [
              "Multi-tenant SaaS with per-tenant isolation",
              "Directory-based sharding",
              "Map tenant to shard; easy migration",
              "Directory is a single point of lookup"
            ],
            [
              "Need to add/remove shards dynamically",
              "Consistent hashing",
            ...
            [
              ...
              "Local writes and reads",
              "Cross-region queries are expensive"
            ],
            [
              "Small dataset, high query complexity",
              "No sharding; replication instead",
              "Avoid distributed query overhead",
              "Write bottleneck remains"
            ],
            [
              "Need global secondary indexes",
              "Directory sharding + global index",
              "Index spans shards",
    ...
    "consistent-hashing": [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Keys Remapped on Node Add (modulo)",
              "99%",
              "~1/K (K = node count)",
              "Consistent hashing: only K/n keys move"
            ],
            [
              "Keys Remapped on Node Add (consistent)",
              "1/K %",
              "~5-10%",
              "Depends on vnode count and hash quality"
            ],
            [
              "Hash Ring Lookup Time",
              "O(log V)",
              "O(log V)",
              "V = virtual node count; binary search"
            ],
            [
              "Standard Deviation of Load",
              "10-20%",
              "5-10%",
              "With sufficient vnodes"
            ],
            [
              "Replication Factor",
              "2-3",
              "5+",
              "Higher = more availability, more storage"
            ],
            [
              "Memory for Ring State",
              "1-10 MB",
              "100 MB+",
              "Per client; scales with vnode count"
            ],
            [
              "Hash Function Quality",
              "MurmurHash3",
              "xxHash, HighwayHash",
              "Low collision rate; fast computation"
            ],
            [
              "Node Failure Detection Time",
              "1-3 s",
              "< 1 s",
              "Via gossip or centralized health checks"
            ],
            [
              "Rebalance Throttle",
              "10-50 MB/s",
              "100 MB/s+",
              "Limit to avoid impacting live traffic"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Healthy consistent hash ring"
            ],
            [
              "2x",
              "2-5 ms",
              "Minor skew; some nodes slightly hotter",
              "Normal; add vnodes if needed"
            ],
            [
              "5x",
              "5-20 ms",
              "Hot keys detected; single node overloaded",
              "Add caching for hot keys"
            ],
            [
              "8x",
              "20-100 ms",
              "Node capacity differences cause imbalance",
              "Weight nodes by capacity"
            ],
            [
              "10x",
              "100 ms - 1 s",
              "Multiple hot keys; cascading failures",
              "Critical: shard hot keys further"
            ],
            [
              ">10x (Spike)",
              "Node failures",
              "Hot nodes crash; keys remapped",
              "Use replica promotion and backoff"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Frequent node additions/removals",
              "Consistent hashing",
              "Minimal key remapping",
              "More memory for ring state"
            ],
            [
              "Weighted node capacities",
              "Rendezvous hashing",
              "Natural support for weights",
              "Slower O(N) lookup per key"
            ],
            [
              "Simple static cluster",
              "Modulo hashing",
              "Fastest lookup; simplest code",
              "Mass remapping on change"
            ],
            [
            ...
            [
              "Database partitioning (Cassandra)",
              "Vnode consistent hashing",
              "Automatic rebalancing",
              "Higher overhead than static tokens"
            ],
            [
              "Load balancing with session affinity",
              "Consistent hashing on client IP",
              "Same client always hits same server",
              "Uneven if client IPs are skewed"
            ],
            [
              "Minimizing coordination",
              "Jump consistent hash",
              "No ring state needed; pure function",
              "Only works for integer keys"
            ]
          ]
        }
      }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "1-3",
              "10-50",
              "Complex sagas emit many events"
            ],
            [
              "Event Store Growth",
              "1 GB/day",
              "1 TB/day (Uber, Netflix)",
              "Compaction and tiered storage essential"
            ],
            [
              "Snapshot Frequency",
              "Every 100-1000 events",
              "Every 10K+ events",
              "Balance between replay speed and storage"
            ],
            [
              "Replay Speed (no snapshot)",
              "1K-10K events/sec",
              "100K+ events/sec (in-memory)",
              "Depends on event handler complexity"
            ],
            [
              "Replay Speed (with snapshot)",
              "1M+ events/sec effective",
              "Instant",
              "Load snapshot + apply recent events"
            ],
            [
              "Projection Lag",
              "10-100 ms",
              "1-5 s (global)",
              "Time to update read models"
            ],
            [
              "Event Size (JSON)",
              "1-5 KB",
              "100 KB+ (with blobs)",
              "Avro/Protobuf reduce to ~20% of JSON"
            ],
            [
              "Storage Overhead vs State",
              "3-10x",
              "10-100x",
              "Every change stored, not just final state"
            ],
            [
              "Schema Version Lifespan",
              "Months",
              "Years",
              "Old schemas must remain readable"
            ],
            [
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "1-2 ms append",
              "Projections current; snapshots valid",
              "Healthy event-sourced system"
            ],
            [
              "2x",
              "2-5 ms append",
              "Minor projection lag; acceptable",
              "Normal; add projectors if needed"
            ],
            [
              "5x",
              "5-20 ms append",
              "Event store I/O saturates; projections lag",
              "Scale event store horizontally"
            ],
            [
              "8x",
              "20-100 ms",
              "Snapshot creation falls behind; replay time grows",
              "Increase snapshot frequency"
            ],
            [
              "10x",
              "100 ms - 1 s",
              "Projections severely stale; queries return old data",
              "Critical: shed non-critical projections"
            ],
            [
              ">10x (Spike)",
              "Append rejected",
              "Event store cannot accept writes",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Simple CRUD with occasional audit",
              "CRUD + audit log table",
              "Simpler; familiar pattern",
              "Audit is separate; not replayable"
            ],
            [
            ...
            [
              "Financial transactions requiring compliance",
              "Event sourcing",
              "Immutable log satisfies auditors",
              "Projection lag must be acceptable"
            ],
            [
            ...
            [
              "Real-time analytics on mutations",
              "Event sourcing + stream processing",
              "Kafka + Flink for real-time projections",
              "Complex pipeline to maintain"
            ],
            [
              "Mobile app with offline sync",
              "Event sourcing (local)",
              "Local event log syncs on reconnect",
    ...
    cqrs: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Consistency Window",
              "10-100 ms",
              "1-5 s (global replication)",
              "Time before read model reflects write"
            ],
            [
              "Read Model Rebuild Time",
              "Minutes",
              "Hours (TB-scale)",
              "Depends on event history size"
            ],
            [
              "Read:Write Ratio",
              "10:1",
              "100:1+ (e.g., Twitter)",
              "CQRS shines with high read ratios"
            ],
            [
              "Read Model Count",
              "2-5",
              "10-20+ per aggregate",
              "Each query pattern gets a model"
            ],
            [
              "Storage Overhead",
              "2x",
              "5-10x",
              "Multiple read models + event store"
            ],
            [
              "Projection Throughput",
              "1K-10K events/sec",
              "100K+ events/sec (Kafka)",
              "Per projector instance"
            ],
            [
              "Command Bus Throughput",
              "1K-5K commands/sec",
              "50K+ commands/sec",
              "In-memory bus is faster"
            ],
            [
              "Operational Complexity",
              "High",
              "Very High",
              "Dual models require expertise"
            ]
          ]
        }
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "Reads: 1 ms; Writes: 10 ms",
              "Read models current; commands processed",
              "Healthy CQRS system"
            ],
            [
              "2x",
              "Reads: 1-2 ms; Writes: 10-20 ms",
              "Minor projection lag; acceptable",
              "Normal; monitor consistency window"
            ],
            [
              "5x",
              "Reads: 2-5 ms; Writes: 20-50 ms",
              "Projection lag grows; some stale reads",
              "Scale projectors horizontally"
            ],
            [
              "8x",
              "Reads: 5-20 ms; Writes: 50-200 ms",
              "Command bus queuing; read models far behind",
              "Add command handlers and projectors"
            ],
            [
              "10x",
              "Reads: 20-100 ms; Writes: 200 ms - 1 s",
              "Consistency window unacceptable; user complaints",
              "Critical: shed reads or accept staleness"
            ],
            [
              ">10x (Spike)",
              "Command rejected",
              "Command bus cannot accept writes",
              "Use backpressure and queues"
            ]
          ]
        }
      },
      {
        ...
        list: [
          ...
          "<strong>Stage 5: Massive Scale (10M+ users, e.g., Amazon)</strong> — Amazons DynamoDB streams power CQRS. Writes go to DynamoDB; Lambda projectors update Elasticsearch for search. Each service team owns their read model. Bottleneck: Lambda cold starts cause projection lag; use provisioned concurrency.",
      ...
      },
      {
        ...
        list: [
          ...
          "<strong>Message Queue Tier:</strong> The event bus connects writes to read models. Kafkas log compaction ensures the latest state is always available for rebuilding read models. Debezium captures database changes and publishes to Kafka for projector consumption."
        ]
      },
      {
        heading: "Decision Matrix",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Complexity of dual models"
            ],
            [
              "Simple CRUD, balanced load",
              "Single model + caching",
              "Simpler; faster to develop",
              "Queries may slow writes"
            ],
            [
              "Need multiple query patterns",
              "CQRS with multiple projections",
              "Each pattern gets optimal store",
              "Storage overhead increases"
            ],
            [
              "Strong consistency required on reads",
              "Single model or sync replication",
            ...
            [
              ...
              "CQRS naturally",
              "Events feed projections",
              "Same complexity as event sourcing"
            ],
            [
              "Small team, tight deadline",
              "Read replicas",
              "Quick win; simpler than CQRS",
              "All queries same schema"
            ],
            [
              "Search-heavy application",
              "CQRS + Elasticsearch projection",
    ...
    wal: [
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Checkpoint Interval",
              "5-15 minutes",
              "1-5 minutes (high write)",
              "Shorter = less recovery time, more I/O"
            ],
            [
              "Recovery Time (crash)",
              "1-30 s",
              "1-5 min (TB WAL)",
              "Depends on WAL size since last checkpoint"
            ],
            [
              "WAL Segment Size",
              "16 MB (Postgres)",
              "1 GB (custom)",
              "Larger segments reduce file count"
            ],
            [
              "Flush Latency (fsync)",
              "1-5 ms (SSD)",
              "0.1-1 ms (NVMe)",
              "HDD: 10-20 ms; use SSD for WAL"
            ],
            [
              "WAL Buffers",
              "16 MB",
              "256 MB+",
              "Larger buffers reduce fsync frequency"
            ],
            [
              "Replication Lag (WAL shipping)",
              "1-100 ms",
              "1-10 s (network)",
              "Streaming replication vs archive"
            ],
            [
              "PITR Recovery Window",
              "7 days",
              "Years (with archive)",
              "Archive WAL to S3/GCS for long-term"
            ],
            [
              "WAL Archive Storage",
              "1 GB/day",
              "100 GB/day",
              "Compress with pg_basebackup"
            ],
            [
              "Concurrent WAL Writers",
              "1",
              "1 (Postgres)",
              "Single writer prevents contention"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "1-2 ms fsync",
              "WAL flushes smoothly; checkpoints on schedule",
              "Healthy WAL performance"
            ],
            [
              "2x",
              "2-5 ms fsync",
              "Minor checkpoint delay; buffers absorb spike",
              "Normal; monitor checkpoint frequency"
            ],
            [
              "5x",
              "5-20 ms fsync",
              "Checkpoint cannot keep up; WAL grows",
              "Shorten checkpoint interval or add I/O"
            ],
            [
              "8x",
              "20-100 ms",
              "WAL disk saturated; writes queue",
              "Move WAL to dedicated NVMe disk"
            ],
            [
              "10x",
              "100 ms - 1 s",
              "Commits timeout; transactions fail",
              "Critical: fsync latency unacceptable"
            ],
            [
              ">10x (Spike)",
              "Database stalls",
              "WAL disk full; no new writes possible",
              "Archive WAL aggressively; resize disk"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        list: [
          ...
          "<strong>Message Queue Tier:</strong> Kafkas log segments are WAL-like. Each partition is an append-only log. Replication copies log segments to followers. Tune log.segment.bytes (1 GB default) and log.retention.hours for capacity planning."
        ]
      },
      {
        heading: "Decision Matrix",
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Guaranteed on-disk on commit",
              "Higher latency; lower throughput"
            ],
            [
              "High throughput, acceptable risk",
              "Asynchronous commit",
              "No fsync per commit",
              "Last second of data may be lost"
            ],
            [
              "Read replicas with fast failover",
              "Streaming WAL replication",
              "Near-real-time replica sync",
              "Network bandwidth for WAL stream"
            ],
            [
              "Point-in-time recovery",
              "WAL archiving to S3",
              "Recover to any moment",
              "Storage cost for archives"
            ],
            [
              "Minimize recovery time",
              "Frequent checkpoints",
              "Less WAL to replay",
              "Higher I/O during checkpoints"
            ],
            [
              "Multi-region durability",
              "Sync replication to remote region",
              "Survive region loss",
              "Write latency > 100ms"
            ],
            [
              "Distributed consensus",
              "Raft/Paxos log (CockroachDB, etcd)",
              "Replicated WAL across nodes",
              "Consensus overhead on every write"
            ]
          ]
        }
      }
    ...
    "cache-aside": [
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Max Items (Redis per node)",
              "1M-10M",
              "100M+ (with clustering)",
              "Limited by memory"
            ],
            [
              "Throughput (Redis)",
              "100K+ ops/sec",
              "1M+ ops/sec (pipelined)",
            ...
            [
              ...
              "10% (poor TTL)",
              "< 1% (jittered TTL)",
              "Uniform expiry causes thundering herd"
            ],
            [
              "Warm-up Time after Deploy",
              "1-5 minutes",
              "Hours (cold start)",
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "0.5-1 ms (hit)",
              "90%+ hit rate; database idle",
              "Healthy cache-aside system"
            ],
            [
              "2x",
              "1-2 ms (hit)",
              "Hit rate stable; minor latency increase",
              "Normal; cache handles load"
            ],
            [
              "5x",
              "2-5 ms or 50 ms (miss)",
              "Hit rate drops to 70%; some misses",
              "Cache warming needed"
            ],
            [
              "8x",
              "5-20 ms or 100-500 ms (miss)",
              "Stampede risk; multiple threads hit DB",
              "Implement singleflight"
            ],
            [
              "10x",
              "20-100 ms or 500 ms - 2 s",
              "Cache stampede; database overloaded",
              "Critical: add circuit breaker"
            ],
            [
              ">10x (Spike)",
              "Database fails",
              "All cache misses; DB cannot recover",
              "Pre-warm cache; use cache warming scripts"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Read-heavy, data changes infrequently",
              "Cache-aside",
              "Simple; high hit rate",
              "Stale data possible on miss"
            ],
            [
              "Data must be consistent after write",
              "Write-through",
              "Cache always fresh",
              "Higher write latency"
            ],
            [
              "Write-heavy, read latency critical",
              "Write-behind",
            ...
            [
              "Existing database, minimal changes",
              "Cache-aside",
              "Works with any DB",
              "Cache logic in application code"
            ],
            [
              "Need strong consistency always",
              "Write-through + TTL",
              "Cache and DB synchronized",
              "Write path bottleneck"
            ],
            [
              "Analytics counters, sessions",
              "Write-behind + cache-aside reads",
        ...
        table: {
          ...
          rows: [
            ...
            [
              ...
              "95-99%",
              "99.9%+",
              "By design, cache is always warm"
            ],
            [
              "Write Amplification",
              "2x (cache + DB)",
              "3x+ (with replicas)",
              "Every write hits multiple stores"
            ],
            [
              "Database Write Throughput",
              "Same as app writes",
              "Same",
              "No write offloading benefit"
            ],
            [
              "Cache Eviction Impact",
              "High",
              "Very High",
              "Evicted reads miss both cache and DB"
            ],
            [
              "Consistency Window",
              "0 ms",
            ...
            [
              "Failed Cache Write Behavior",
              "Write fails",
              "Write fails",
              "Cache is part of write path"
            ],
            [
              "Operational Complexity",
              "Medium",
            ...
            [
              "Use Case Read:Write Ratio",
              "Any",
              "Any",
              "Works well even with 1:1 ratio"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "10-20 ms write",
              "Database handles writes; cache updated",
              "Healthy write-through system"
            ],
            [
              "2x",
              "20-40 ms write",
              "Minor database load increase",
              "Normal; database has headroom"
            ],
            [
              "5x",
              "40-100 ms write",
              "Database write throughput saturated",
              "Add database write capacity"
            ],
            [
              "8x",
              "100-500 ms",
              "Cache writes queue; clients wait",
              "Database is bottleneck"
            ],
            [
              "10x",
              "500 ms - 2 s",
              "Write timeouts; cache rejections",
              "Critical: scale database or switch pattern"
            ],
            [
              ">10x (Spike)",
              "Write rejected",
              "Database cannot accept writes",
              "Use write-behind or async queue"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            ...
            [
              "Cache layer can fail writes",
              "Write-through with fallback",
              "DB is source of truth",
              "Complex failure handling"
            ],
            [
              "Simplest strong consistency",
              "Write-through",
              "No eventual consistency window",
              "Cache is write bottleneck"
            ],
            [
              "High-frequency counters",
              "Write-behind + atomic increments",
              "Cache aggregates writes",
              "Crash loses unflushed data"
            ],
            [
              "Financial transactions",
              "Write-through + sync replication",
              "Durability on both cache and DB",
              "Highest latency"
            ]
          ]
        }
        ...
        table: {
          ...
          rows: [
            [
              ...
              "0.1-1 ms",
              "0.01-0.1 ms (local)",
              "No database wait; cache only"
            ],
            [
              "Flush Interval",
              "1-5 seconds",
              "100 ms - 1 s",
              "Balance between durability and batching"
            ],
            [
              "Batch Size",
              "10-100 writes",
              "1K-10K writes",
              "Larger batches = fewer DB ops"
            ],
            [
              "Data Loss Window",
              "1-5 seconds",
            ...
            [
              "Write Coalescing Rate",
              "50-90%",
              "95%+",
              "Multiple writes to same key merged"
            ],
            [
              "Flush Worker Count",
              "1-5",
              "10-50+",
              "Scale workers with write volume"
            ],
            [
              "Memory for Dirty Entries",
              "10-100 MB",
              "1-10 GB",
              "Unflushed data held in cache"
            ],
            [
              "Flush Failure Retry",
              "3-5 attempts",
              "10+ with exponential backoff",
            ...
            [
              ...
              "High",
              "Very High",
              "Flush scheduling, recovery logging"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "0.1-1 ms write",
              "Flush workers keep up; dirty entries minimal",
              "Healthy write-behind system"
            ],
            [
              "2x",
              "0.1-1 ms write",
              "Dirty entries grow slowly; flushes catch up",
              "Normal; monitor dirty entry count"
            ],
            [
              "5x",
              "0.1-1 ms write",
              "Flush workers saturated; dirty entries accumulate",
              "Add flush workers or reduce flush interval"
            ],
            [
              "8x",
              "0.1-1 ms write",
              "Dirty entries > memory limit; evictions start",
              "Risk of losing unflushed data"
            ],
            [
              "10x",
              "0.1-1 ms write",
              "Flush queue unbounded; memory pressure critical",
              "Critical: throttle writes or switch to write-through"
            ],
            [
              ">10x (Spike)",
              "Cache rejects writes",
              "No memory for dirty entries",
              "Emergency: force flush or drop non-critical data"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Write-behind",
              "Fast writes; batching reduces DB load",
              "Acceptable data loss on crash"
            ],
            [
              "Session state, temporary data",
              "Write-behind",
              "Low latency; data is transient",
              "Loss on crash is expected"
            ],
            [
              "Financial transactions",
              "Write-through or direct DB",
              "Durability is non-negotiable",
              "Higher latency"
            ],
            [
              "Inventory counts",
              "Write-through + optimistic locking",
              "Prevents oversell",
            ...
            [
              ...
              "Fast UX; approximate count OK",
              "Count may be slightly off"
            ],
            [
              "High-frequency gaming state",
              "Write-behind + snapshot",
              "Sub-millisecond writes",
              "Snapshot on checkpoint"
            ],
            [
              "Need immediate read consistency",
              "Write-through",
              "Cache always reflects latest",
              "Slower writes"
            ]
          ]
        }
    ...
    "eviction-policies": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "LRU Hit Rate (typical)",
              "80-85%",
              "90-95% (Zipfian)",
              "Best for temporal locality"
            ],
            [
              "LFU Hit Rate (typical)",
              "75-80%",
              "85-90%",
              "Best for frequency-based workloads"
            ],
            [
              "FIFO Hit Rate (typical)",
              "60-70%",
              "70-80%",
              "Simple but ignores access patterns"
            ],
            [
              "TTL Hit Rate (typical)",
              "70-80%",
              "80-90%",
              "Depends on TTL tuning"
            ],
            [
              "Random Hit Rate (typical)",
              "40-50%",
              "50-60%",
              "Worst; only for uniform workloads"
            ],
            [
              "W-TinyLFU Hit Rate",
              "85-92%",
              "93-98%",
              "Hybrid; state of the art (Caffeine)"
            ],
            [
              "CLOCK Approximation Overhead",
              "5-10% miss increase",
              "2-5% (tuned)",
              "Versus exact LRU"
            ],
            [
              "Memory per Entry (LRU)",
              "1.2x value size",
              "1.5x (with timestamps)",
              "Linked list pointers"
            ],
            [
              "Memory per Entry (LFU)",
              "1.3x value size",
              "1.6x (with counters)",
              "Counter + timestamp storage"
            ],
            [
              "Policy Switching Cost",
              "1-5 min warm-up",
              "Hours (large caches)",
              "Hit rate drops during adaptation"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "1-2 ms (hit)",
              "Policy efficiently retains hot data",
              "Healthy cache"
            ],
            [
              "2x",
              "1-2 ms (hit)",
              "Hit rate stable; minor eviction increase",
              "Normal; policy handles load"
            ],
            [
              "5x",
              "2-5 ms (miss)",
              "Scanning workload pollutes LRU",
              "Consider scan resistance"
            ],
            [
              "8x",
              "5-20 ms (miss)",
              "LFU retains stale popular data",
              "Add TTL cap to LFU"
            ],
            [
              "10x",
              "20-100 ms (miss)",
              "Mass eviction; hit rate collapses",
              "Cache undersized for workload"
            ],
            [
              ">10x (Spike)",
              "Database overload",
              "Effectively no cache",
              "Scale cache memory or use CDN"
            ]
          ]
        }
      },
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Temporal locality (recent data is hot)",
              "LRU",
              "Simple; effective for recency",
              "Vulnerable to scan attacks"
            ],
            [
              "Some items are consistently popular",
              "LFU",
              "Retains genuinely popular data",
              "Retains stale popular items"
            ],
            [
              "Mixed workloads, changing patterns",
              "W-TinyLFU",
              "Adapts to shifts; scan resistant",
            ...
            [
              "Time-bound data (sessions, tokens)",
              "TTL",
              "Natural expiration semantics",
              "Uniform expiry causes thundering herd"
            ],
            [
              "Cache size strictly bounded",
              "LRU + max size",
              "Predictable memory usage",
              "Tuning max size required"
            ],
            [
              "CDN / edge cache",
              "Custom (frequency + recency + TTL)",
    ...
    "cdn-caching": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "Cache Hit Rate (static)",
              "90-95%",
              "98%+ (well-tuned)",
              "Images, CSS, JS"
            ],
            [
              "Cache Hit Rate (dynamic)",
              "50-70%",
              "80-90% (with edge logic)",
              "HTML, API responses"
            ],
            [
              "Edge Latency (p99)",
              "10-50 ms",
              "1-10 ms (major cities)",
            ...
            [
              ...
              "80-90%",
              "95%+",
              "Traffic never reaches origin"
            ],
            [
              "TTL (static assets)",
              "1-30 days",
              "1 year (versioned filenames)",
              "Immutable assets = infinite TTL"
            ],
            [
              "Purge Propagation Time",
              "1-5 minutes",
              "30 seconds - 2 minutes",
              "Fastly purges in ~150ms"
            ],
            [
              "Edge Storage per PoP",
              "10-100 TB",
              "1 PB+",
              "SSD-based edge caching"
            ],
            [
              "PoP Count (global CDN)",
              "50-200",
              "500+ (Cloudflare)",
              "More PoPs = lower latency"
            ],
            [
              "Cost per GB Served",
              "$0.01-0.05",
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "10-50 ms edge",
              "High hit rate; origin idle",
              "Healthy CDN usage"
            ],
            [
              "2x",
              "10-50 ms edge",
              "Hit rate stable; minor origin increase",
              "Normal; CDN absorbs spike"
            ],
            [
              "5x",
              "50-100 ms or origin",
              "Cache misses spike; origin load rises",
              "Origin shield helps"
            ],
            [
              "8x",
              "100-500 ms (origin)",
              "Origin overloaded; edge serves stale",
              "Enable stale-while-revalidate"
            ],
            [
              "10x",
              "500 ms - 2 s",
              "Origin failing; cascade to edges",
              "Critical: scale origin or cache more"
            ],
            [
              ">10x (Spike)",
              "Origin down",
              "CDN serves stale or errors",
              "Use origin shield + multiple origins"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              ...
              "Long TTL (1 year) + versioned URL",
              "Never expires; cache forever",
              "Must update references on change"
            ],
            [
              "Semi-dynamic content (product catalog)",
              "Short TTL (1-5 min) + surrogate keys",
              "Fresh enough; high hit rate",
              "Brief staleness acceptable"
            ],
            [
              "Personalized content",
              "Edge-side includes or no cache",
              "Dynamic per user",
              "Higher origin load"
            ],
            [
              "API responses (read-heavy)",
              "Cache with vary by auth token",
              "Reduces API server load",
              "Token changes = cache miss"
            ],
            [
            ...
            [
              ...
              "No CDN cache; use WebSocket",
              "CDN cannot cache mutable data",
              "Origin handles all load"
            ]
          ]
        }
      }
    ...
    "multi-tier-cache": [
      {
        ...
        table: {
          ...
          rows: [
            [
              "L1 Hit Rate (in-process)",
              "90-95%",
              "98%+",
              "Fastest; smallest capacity"
            ],
            [
              "L2 Hit Rate (distributed)",
              "70-80%",
              "90%+",
              "Redis/Memcached cluster"
            ],
            [
              "L3 Hit Rate (CDN/disk)",
              "50-70%",
              "80%+",
            ...
            [
              "L1 Capacity per Instance",
              "100 MB - 1 GB",
              "10 GB+ (dedicated)",
              "Limited by application memory"
            ],
            [
              "L2 Capacity per Cluster",
              "10-100 GB",
              "1 TB+",
            ...
            [
              ...
              "1-10 TB",
              "Unlimited (CDN)",
              "Cloud CDN or disk cache"
            ],
            [
              "Promotion Rate (L2→L1)",
              "1-10%",
              "20%+ (hot data)",
              "Moves frequently accessed data up"
            ]
          ]
        }
      },
        ...
        table: {
          ...
          rows: [
            [
              "1x (Baseline)",
              "L1: 0.01 ms",
              "95%+ L1 hits; lower tiers idle",
              "Optimal multi-tier performance"
            ],
            [
              "2x",
              "L1: 0.01 ms; L2: 0.5 ms",
              "L1 hit rate stable; L2 handles overflow",
              "Normal; promotion keeps hot data in L1"
            ],
            [
              "5x",
              "L1: 0.01 ms; L2: 1-2 ms",
              "L1 evictions increase; L2 hit rate drops",
              "Size L1 for working set"
            ],
            [
              "8x",
              "L1: 0.01 ms; L2: 2-5 ms; L3: 50 ms",
              "L2 saturated; L3 fallback grows",
              "Add L2 capacity or nodes"
            ],
            [
              "10x",
              "L1 misses; L2: 5-10 ms; L3: 100 ms",
              "Cascading misses; database load spikes",
              "Critical: pre-warm upper tiers"
            ],
            [
              ">10x (Spike)",
              "Database overloaded",
              "All tiers cold; origin cannot recover",
      ...
      },
      {
        ...
        table: {
          ...
          rows: [
            [
              "Simple app, moderate traffic",
              "Single-tier (Redis)",
              "Simpler operations",
              "Higher latency for hot data"
            ],
            [
              "High read volume, latency critical",
            ...
            [
              ...
              "L1 + L2 + L3 (CDN)",
              "Optimal latency per content type",
              "Operational overhead"
            ],
            [
              "Global user base",
              "Regional L2 + Global L3",
              "Local latency everywhere",
              "Cross-region consistency"
            ],
            [
              "Microservices with shared data",
              "L2 (shared Redis) + L1 (per-service)",
              "Service isolation; shared warm data",
              "Cache fragmentation"
            ],
            [
              "Cost-sensitive, latency tolerant",
              "Single L2 (large)",
              "Fewer components to manage",
              "Higher p99 latency"
            ],
            [
              "Maximum performance (trading, gaming)",
              "L1 only (replicated)",
              "Lowest possible latency",
              "Data inconsistency risk; complex replication"
            ]
          ]
        }
      }
